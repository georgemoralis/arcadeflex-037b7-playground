...
public class berzerk {
 ...
 /* berzerk sound */
    ...
    public static ShStartPtr berzerk_sh_start = new ShStartPtr() {
    ...
    public static WriteHandlerPtr berzerk_sound_control_b_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            logerror("B Data value %d and offset %d at %d\n", data, offset, lastfreq);
        }
    };

    public static ShUpdatePtr berzerk_sh_update = new ShUpdatePtr() {
        public void handler() {

...
import static gr.codebb.arcadeflex.WIP.v037b7.sound.adpcm.ADPCM_playing;
...
public class trackfld {
     ...
     */
    public static ReadHandlerPtr trackfld_sh_timer_r = new ReadHandlerPtr() {
    ...
    public static ReadHandlerPtr trackfld_speech_r = new ReadHandlerPtr() {
        public int handler(int offset) {
    ...
    public static WriteHandlerPtr trackfld_sound_w = new WriteHandlerPtr() {
 ...
 /* A8 VLM5030 ST pin */
    ...
    public static ReadHandlerPtr hyperspt_sh_timer_r = new ReadHandlerPtr() {
        public int handler(int offset) {
            int clock = cpu_gettotalcycles() / TIMER_RATE;
    ...
    public static WriteHandlerPtr hyperspt_sound_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            int changes = offset ^ last_addr;
 ...
 /* A4 VLM5030 ST pin */
    ...
    static int last;
    public static WriteHandlerPtr konami_sh_irqtrigger_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
    ...
    public static WriteHandlerPtr konami_SN76496_latch_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            SN76496_latch = data;
        }
    };

    public static WriteHandlerPtr konami_SN76496_0_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {

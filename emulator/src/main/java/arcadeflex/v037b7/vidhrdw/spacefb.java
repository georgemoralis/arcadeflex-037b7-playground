...
public class spacefb {
     ...
     **************************************************************************
     */
    public static VhConvertColorPromPtr spacefb_vh_convert_color_prom = new VhConvertColorPromPtr() {
    ...
    public static WriteHandlerPtr spacefb_video_control_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            flip_screen_w.handler(offset, video_control & 0x01);
     ...
     **************************************************************************
     */
    public static VhUpdatePtr spacefb_vh_screenrefresh = new VhUpdatePtr() {

...
public class galivan {
    ...
    static /*unsigned*/ char[] scrolly = new char[2];
    ...
    static struct_tilemap bg_tilemap, tx_tilemap;
 ...
 /* 8-15 (like for tiles). */
    ...
    public static GetTileInfoPtr get_bg_tile_info = new GetTileInfoPtr() {
        public void handler(int tile_index) {
            ...
            int attr = BGROM.read(tile_index + 0x4000);
            int code = BGROM.read(tile_index) | ((attr & 0x03) << 8);
    ...
    public static GetTileInfoPtr get_tx_tile_info = new GetTileInfoPtr() {
        public void handler(int tile_index) {
            ...
            /* not sure */
            tile_info.u32_priority = (attr & 8) != 0 ? 0 : 1;
            /* wrong */
        }
    };

    public static GetTileInfoPtr ninjemak_get_bg_tile_info = new GetTileInfoPtr() {
        public void handler(int tile_index) {
            UBytePtr BGROM = memory_region(REGION_GFX4);
            int attr = BGROM.read(tile_index + 0x4000);
            int code = BGROM.read(tile_index) | ((attr & 0x03) << 8);
    ...
    public static GetTileInfoPtr ninjemak_get_tx_tile_info = new GetTileInfoPtr() {
        public void handler(int tile_index) {
            int attr = colorram.read(tile_index);
    ...
    public static VhStartPtr galivan_vh_start = new VhStartPtr() {
        public int handler() {
            ...
            if (bg_tilemap == null || tx_tilemap == null) {
                return 1;
            }
    ...
    public static WriteHandlerPtr galivan_gfxbank_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            ...
            tilemap_set_flip(tx_tilemap, flipscreen != 0 ? TILEMAP_FLIPX | TILEMAP_FLIPY : 0);

...
public class bosco {
    ...
    public static final int VIDEO_RAM_SIZE = 0x400;

    public static UBytePtr bosco_videoram2 = new UBytePtr();
    public static UBytePtr bosco_colorram2 = new UBytePtr();
    public static UBytePtr bosco_radarx = new UBytePtr();
    public static UBytePtr bosco_radary = new UBytePtr();
    public static UBytePtr bosco_radarattr = new UBytePtr();
    ...
    public static VhConvertColorPromPtr bosco_vh_convert_color_prom = new VhConvertColorPromPtr() {
        public void handler(char[] palette, char[] colortable, UBytePtr color_prom) {
            ...
            for (i = 0; i < 64 * 4; i++) {
                ...
                if (colortable[i + 64 * 4] == 0x10) {
                    colortable[i + 64 * 4] = 0;/* preserve transparency */
                }
            }
 ...
 /* they use colors 0-3, I think */
            for (i = 0; i < 4; i++) {
                colortable[Machine.drv.gfxdecodeinfo[2].color_codes_start + i] = (char) (i);
            }
 ...
 /* this comes from the Galaxian hardware, Bosconian is probably different */
    ...
    public static WriteHandlerPtr bosco_videoram2_w = new WriteHandlerPtr() {
    ...
    public static WriteHandlerPtr bosco_colorram2_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
    ...
    public static WriteHandlerPtr bosco_flipscreen_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
    ...
    public static WriteHandlerPtr bosco_scrollx_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            bosco_scrollx = (char) (data & 0xFF);
        }
    };

    public static WriteHandlerPtr bosco_scrolly_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            bosco_scrolly = (char) (data & 0xFF);
        }
    };

    public static WriteHandlerPtr bosco_starcontrol_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            bosco_starcontrol = (char) (data & 0xFF);
        }
    };

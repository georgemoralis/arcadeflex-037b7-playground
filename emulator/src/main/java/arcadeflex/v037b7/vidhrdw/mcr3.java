/*
 * ported to v0.37b7  - TODO backdrop support for dotron
 * 
 */
        ...
        for (offs = videoram_size[0] - 2; offs >= 0; offs -= 2) {
            if (dirtybuffer[offs] != 0) {
                ...
                if (mcr_cocktail_flip == 0) {
                    ...
                    drawgfx(bitmap, Machine.gfx[0], code, color, NOT(attr & 0x04), NOT(attr & 0x08),
    ...
    public static void mcr3_update_sprites(osd_bitmap bitmap, int color_mask, int code_xor, int dx, int dy) {
        ...
        for (offs = 0; offs < spriteram_size[0]; offs += 4) {
            ...
            if (mcr_cocktail_flip == 0) {
                ...
                drawgfx(bitmap, Machine.gfx[1], code, color, NOT(flipx), NOT(flipy), 480 - sx, 452 - sy,
                        Machine.visible_area, TRANSPARENCY_PEN, 0);
            }

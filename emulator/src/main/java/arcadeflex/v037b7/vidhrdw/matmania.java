...
public class matmania {
     ...
     * sprites. I don't know for sure how the PROMs are connected to the RGB
    ...
    public static WriteHandlerPtr matmania_paletteram_w = new WriteHandlerPtr() {
    ...
    public static WriteHandlerPtr matmania_videoram3_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
    ...
    public static WriteHandlerPtr matmania_colorram3_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {

...
public class appoooh {
    ...
    public static final int CHR1_OFST = 0x00;
    /* palette page of char set #1 */

    public static final int CHR2_OFST = 0x10;
    /* palette page of char set #2 */
 ...
 /* order when priority == 1 */
    ...
    public static void appoooh_draw_sprites(osd_bitmap dest_bmp,
        ...
        for (offs = spriteram_size[0] - 4; offs >= 0; offs -= 4) {
            ...
            int color = sprite.read(offs + 2) & 0x0f;
            /* TODO: bit 4 toggles continuously, what is it? */
 ...
 /* since last time and update it accordingly. */
            ...
            if (priority == 0) /* fg behind sprites */ {
                copyscrollbitmap(bitmap, tmpbitmap, 1, new int[]{scroll}, 0, null, Machine.visible_area, TRANSPARENCY_COLOR, CHR1_OFST);
            }

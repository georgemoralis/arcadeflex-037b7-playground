/*
 * ported to v0.37b7  --TODO overlay support
 * 
 */
...
public class circus {
 ...
 /*TODO*///	static const struct artwork_element circus_ol[]={
...
/*TODO*///	};
    ...
    public static VhStartPtr circus_vh_start = new VhStartPtr() {
        public int handler() {
            ...
            /*TODO*///		overlay_create(circus_ol, start_pen, Machine.drv.total_colors-start_pen);
            return 0;
        }
    };
 ...
 /* descriptions are based on Circus schematics      */
    ...
    static void draw_robot_box(osd_bitmap bitmap, int x, int y) {
        ...
        draw_line(bitmap, x, y, ex, y, 0);
        /* Top */
        draw_line(bitmap, x, ey, ex, ey, 0);
        /* Bottom */
        draw_line(bitmap, x, y, x, ey, 0);
        /* Left */
        draw_line(bitmap, ex, y, ex, ey, 0);
        /* Right */

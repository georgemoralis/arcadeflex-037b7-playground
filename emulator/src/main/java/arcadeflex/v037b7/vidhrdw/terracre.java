...
public class terracre {
    ...
    public static VhConvertColorPromPtr terrac_vh_convert_color_prom = new VhConvertColorPromPtr() {
 ...
 /* 8-15 (like for tiles). */
     ...
     * *************************************************************************
     */
    public static VhStopPtr terrac_vh_stop = new VhStopPtr() {
        public void handler() {
            dirtybuffer2 = null;
     ...
     * *************************************************************************
     */
    public static VhStartPtr terrac_vh_start = new VhStartPtr() {
        public int handler() {
     ...
     **************************************************************************
     */
    public static VhUpdatePtr terracre_vh_screenrefresh = new VhUpdatePtr() {
        public void handler(osd_bitmap bitmap, int full_refresh) {
            ...
            if ((terrac_scrolly.READ_WORD() & 0x2000) != 0) /* background disable */ {
                fillbitmap(bitmap, Machine.pens[0], Machine.visible_area);
            } else {
                int scrollx;

                scrollx = -terrac_scrolly.READ_WORD();

...
public class champbas {
     ...
     *
     * Pac Man has a 16 bytes palette PROM and a 128 bytes color lookup table
     * PROM.
     *
 ...
 /* sprites use the same color lookup table as characters */
    ...
    public static WriteHandlerPtr champbas_gfxbank_w = new WriteHandlerPtr() {
     ...
     **************************************************************************
     */
    public static VhUpdatePtr champbas_vh_screenrefresh = new VhUpdatePtr() {

...
public class wc90b {
    ...
    public static VhStartPtr wc90b_vh_start = new VhStartPtr() {
        public int handler() {
    ...
    public static VhStopPtr wc90b_vh_stop = new VhStopPtr() {
        public void handler() {
            dirtybuffer1 = null;
            dirtybuffer2 = null;
            bitmap_free(tmpbitmap1);
    ...
    public static VhUpdatePtr wc90b_vh_screenrefresh = new VhUpdatePtr() {

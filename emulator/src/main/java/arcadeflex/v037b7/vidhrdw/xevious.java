...
public class xevious {
     ...
     * characters map directly to a palette color without using a PROM). The
     * palette PROMs are connected to the RGB output this way:
     *
    ...
    public static VhConvertColorPromPtr xevious_vh_convert_color_prom = new VhConvertColorPromPtr() {
 ...
 /* background tiles */
            for (i = 0; i < TOTAL_COLORS(1); i++) {
                colortable[Machine.drv.gfxdecodeinfo[1].color_codes_start + i] = (char) ((color_prom.read(0) & 0x0f) | ((color_prom.read(TOTAL_COLORS(1)) & 0x0f) << 4));
            ...
            for (i = 0; i < TOTAL_COLORS(2); i++) {
                ...
                if ((c & 0x80) != 0) {
                    ...
                    colortable[Machine.drv.gfxdecodeinfo[2].color_codes_start + i] = (char) (0x80);
                    /* transparent */
                }
            ...
            for (i = 0; i < TOTAL_COLORS(0); i++) {
                if (i % 2 == 0) {
                    colortable[Machine.drv.gfxdecodeinfo[0].color_codes_start + i] = (char) (0x80);
                    /* transparent */
                } else {
    ...
    public static GetTileInfoPtr get_fg_tile_info = new GetTileInfoPtr() {
        public void handler(int tile_index) {
            ...
            SET_TILE_INFO(0, xevious_fg_videoram.read(tile_index),
     ...
     **************************************************************************
     */
    public static VhStartPtr xevious_vh_start = new VhStartPtr() {
        public int handler() {
     ...
     **************************************************************************
     */
    public static WriteHandlerPtr xevious_fg_videoram_w = new WriteHandlerPtr() {
    ...
    public static WriteHandlerPtr xevious_fg_colorram_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
    ...
    public static WriteHandlerPtr xevious_bg_videoram_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
    ...
    public static WriteHandlerPtr xevious_bg_colorram_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
    ...
    public static WriteHandlerPtr xevious_vh_latch_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            int reg;
    ...
    public static VhUpdatePtr xevious_vh_screenrefresh = new VhUpdatePtr() {

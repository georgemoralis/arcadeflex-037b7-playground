...
public class kingobox {
     ...
     * this way:
     *
     * bit 3 -- 180 ohm resistor -- RED/GREEN/BLUE -- 360 ohm resistor --
     * RED/GREEN/BLUE -- 750 ohm resistor -- RED/GREEN/BLUE bit 0 -- 1.5kohm
     * resistor -- RED/GREEN/BLUE
     *
     * The foreground color code directly goes to the RGB output, this way:
     *
     * bit 5 -- 51 ohm resistor -- RED bit 4 -- 51 ohm resistor -- GREEN bit 3
     * -- 51 ohm resistor -- BLUE
     *
     **************************************************************************
     */
    ...
    public static WriteHandlerPtr kingofb_f800_w = new WriteHandlerPtr() {

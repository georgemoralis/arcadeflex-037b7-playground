...
import static arcadeflex.v037b7.mame.commonH.REGION_GFX4;
...
public class tigeroad {
    ...
    public static WriteHandlerPtr tigeroad_videoctrl_w = new WriteHandlerPtr() {
 ...
 /* bits 6-7 are coin counters */
    ...
    public static WriteHandlerPtr tigeroad_scroll_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
    ...
    static void render_background(osd_bitmap bitmap, int priority) {
        int scrollx = tigeroad_scrollram.READ_WORD(0) & 0xfff;
        /* 0..4096 */
        int scrolly = tigeroad_scrollram.READ_WORD(2) & 0xfff;
        /* 0..4096 */
    ...
    static void render_sprites(osd_bitmap bitmap) {
        UBytePtr source = new UBytePtr(buffered_spriteram, spriteram_size[0] - 8);
        UBytePtr finish = new UBytePtr(buffered_spriteram);

        while (source.offset >= finish.offset) {
            int tile_number = source.READ_WORD();
    ...
    public static VhUpdatePtr tigeroad_vh_screenrefresh = new VhUpdatePtr() {
    ...
    public static VhEofCallbackPtr tigeroad_eof_callback = new VhEofCallbackPtr() {
        public void handler() {

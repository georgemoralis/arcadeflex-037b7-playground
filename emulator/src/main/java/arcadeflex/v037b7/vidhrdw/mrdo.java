...
import static gr.codebb.arcadeflex.WIP.v037b7.mame.tilemapH.TILEMAP_FRONT;
import static gr.codebb.arcadeflex.WIP.v037b7.mame.tilemapH.TILEMAP_SPLIT;
...
public class mrdo {
    ...
    public static GetTileInfoPtr get_bg_tile_info = new GetTileInfoPtr() {
        public void handler(int tile_index) {
            /*unsigned*/ char attr = mrdo_bgvideoram.read(tile_index);
            SET_TILE_INFO(1, mrdo_bgvideoram.read(tile_index + 0x400) + ((attr & 0x80) << 1), attr & 0x3f);
            tile_info.u32_flags = TILE_SPLIT((attr & 0x40) >> 6);
        }
    };

    public static GetTileInfoPtr get_fg_tile_info = new GetTileInfoPtr() {
        public void handler(int tile_index) {
            /*unsigned*/ char attr = mrdo_fgvideoram.read(tile_index);
    ...
    public static VhStartPtr mrdo_vh_start = new VhStartPtr() {
        public int handler() {
            ...
            bg_tilemap.u32_transmask[0] = 0x01;/* split type 0 has pen 1 transparent in front half */
            bg_tilemap.u32_transmask[1] = 0x00;/* split type 1 is totally opaque in front half */
            fg_tilemap.u32_transmask[0] = 0x01;/* split type 0 has pen 1 transparent in front half */
            fg_tilemap.u32_transmask[1] = 0x00;/* split type 1 is totally opaque in front half */

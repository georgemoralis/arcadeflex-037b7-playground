...
public class taito_b {
    ...
    static int[]/*UINT32*/ pixel_layer_colors = new int[256];
    /*to keep track of colors used*/
    static int[]/*UINT8*/ pixel_layer_dirty = new int[512];

    static int/*UINT8*/ u8_video_control = 0;
    static int/*UINT8*/ u8_text_video_control = 0;
    ...
    public static ReadHandlerPtr taitob_videoram_r = new ReadHandlerPtr() {
        public int handler(int offset) {
            return videoram.READ_WORD(offset);
        }
    };

    public static WriteHandlerPtr taitob_videoram_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            COMBINE_WORD_MEM(videoram, offset, data);
        }
    };

    public static ReadHandlerPtr taitob_video_control_r = new ReadHandlerPtr() {
        public int handler(int offset) {
            return (u8_video_control << 8);
        }
    };

    public static WriteHandlerPtr taitob_video_control_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            int val = (data >> 8) & 0xff;
	...
	* bit 5 (0x20) seems to be global video enable switch (Hit the Ice resets that bit, clears videoram portions and sets that bit)
             */
            if (((u8_video_control & 1) == 0) && ((val & 1) == 1)) /*kludge ?*/ {
    ...
    public static ReadHandlerPtr taitob_text_video_control_r = new ReadHandlerPtr() {
        public int handler(int offset) {
            return (u8_text_video_control << 8);
        }
    };

    public static WriteHandlerPtr taitob_text_video_control_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            int val = (data >> 8) & 0xff;
            /*
	* hitice:
	...
	* Don't know if bit 3 (0x08) is video text enable/disable ????
            ...
            u8_text_video_control = val & 0xFF;
        }
    };

    public static ReadHandlerPtr taitob_pixelram_r = new ReadHandlerPtr() {
        public int handler(int offset) {
            return taitob_pixelram.READ_WORD(offset);
        }
    };
    public static WriteHandlerPtr taitob_pixelram_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
    ...
    public static void taitob_redraw_pixel_layer_dirty() {
    ...
    public static WriteHandlerPtr masterw_pixelram_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            UShortPtr pens = new UShortPtr(Machine.pens, b_px_color_base);
    ...
    public static ReadHandlerPtr hitice_pixelram_r = new ReadHandlerPtr() {
        public int handler(int offset) {
            return taitob_pixelram.READ_WORD(offset);
        }
    };
    public static WriteHandlerPtr hitice_pixelram_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            UShortPtr pens = new UShortPtr(Machine.pens, b_px_color_base);
            int sx, sy, color;
    ...
    public static VhStopPtr taitob_vh_stop = new VhStopPtr() {
        public void handler() {
    ...
    public static GetTileInfoPtr get_bg_tile_info = new GetTileInfoPtr() {
        public void handler(int tile_index) {
            ...
            int color = b_backgroundram.READ_WORD(2 * tile_index + 0x2000);
            ...
            tile_info.u32_flags = TILE_FLIPYX((color & 0x00c0) >> 6);
        }
    };
    ...
    public static VhStartPtr taitob_vh_start_core = new VhStartPtr() {
        public int handler() {
            pixel_layer = null;
            ...
            tx_tilemap = tilemap_create(get_tx_tile_info, tilemap_scan_rows, TILEMAP_TRANSPARENT, 8, 8, 64, 32 * 4);
            /*there is a simple paging system used in Rambo3 and Hit the Ice*/
 ...
 /* size of pixel ram is 512x512 for tetris, ashura, crimec,
    ...
    public static VhStartPtr taitob_vh_start_color_order0 = new VhStartPtr() {
        public int handler() {
 ...
 /*Note that in both this and color order 1
		...
		* Pure coincidence ????
            ...
            /*foreground*/
            b_sp_color_base = 0x40;
            /*sprites   */
            b_tx_color_base = 0x00;
            /*text      */
            b_px_color_base = 0x400;
            /*pixel (this one refers COLOR, not COLOR CODE)*/

            return taitob_vh_start_core.handler();
        }
    };

    public static VhStartPtr taitob_vh_start_color_order1 = new VhStartPtr() {
        public int handler() {
            ...
            b_px_color_base = 0x800;
            /*(this one refers COLOR, not COLOR CODE)*/

            return taitob_vh_start_core.handler();
        }
    };

    public static VhStartPtr taitob_vh_start_color_order2 = new VhStartPtr() {
        public int handler() {
            b_bg_color_base = 0x30;
            b_fg_color_base = 0x20;
            b_sp_color_base = 0x10;
            b_tx_color_base = 0x00;
            b_px_color_base = 0x100;
            /* my guess */ /*(this one refers COLOR, not COLOR CODE)*/
    ...
    public static WriteHandlerPtr taitob_text_w_tm = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
    ...
    public static WriteHandlerPtr taitob_background_w_tm = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
    ...
    public static WriteHandlerPtr taitob_foreground_w_tm = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
    ...
    static void taitob_mark_sprite_colors() {
        int offs, color;
        int[]/*unsigned*/ palette_map = new int[256];
	...
	* 'priority' parameter
    ...
    public static VhUpdatePtr ashura_vh_screenrefresh_tm = new VhUpdatePtr() {
        public void handler(osd_bitmap bitmap, int full_refresh) {
            ...
            if ((u8_video_control & 0xef) == 0xef) /*masked out bit is screen flip*/ {
    ...
    /*Crime City section*/
    public static VhUpdatePtr crimec_vh_screenrefresh_tm = new VhUpdatePtr() {
        public void handler(osd_bitmap bitmap, int full_refresh) {
    ...
    /*Tetris section*/
    public static VhUpdatePtr tetrist_vh_screenrefresh = new VhUpdatePtr() {
        public void handler(osd_bitmap bitmap, int full_refresh) {
            int scrollx, scrolly;
    ...
    public static VhUpdatePtr hitice_vh_screenrefresh_tm = new VhUpdatePtr() {
        public void handler(osd_bitmap bitmap, int full_refresh) {
            int tx_scrolly;
            ...
            switch (u8_text_video_control) {
                ...
                case 0x0a:
                    ...
                    break;
                default:
                    /*not used by any game so far*/
                    tx_scrolly = 32 * 3 * 8;
                    usrintf_showmessage("Text layer scroll-paging unknown mode: %i", u8_text_video_control);
                    break;
            }
    ...
    public static VhUpdatePtr rambo3_vh_screenrefresh_tm = new VhUpdatePtr() {
        public void handler(osd_bitmap bitmap, int full_refresh) {
            int tx_scrolly;
    ...
    public static VhUpdatePtr puzbobb_vh_screenrefresh_tm = new VhUpdatePtr() {
        public void handler(osd_bitmap bitmap, int full_refresh) {
            /* Update tilemaps */
            tilemap_set_scrollx(bg_tilemap, 0, -taitob_bscroll.READ_WORD(0));
            tilemap_set_scrolly(bg_tilemap, 0, -taitob_bscroll.READ_WORD(2));
    ...
    public static VhUpdatePtr qzshowby_vh_screenrefresh_tm = new VhUpdatePtr() {
        public void handler(osd_bitmap bitmap, int full_refresh) {
            /* Update tilemaps */
            tilemap_set_scrollx(bg_tilemap, 0, -taitob_bscroll.READ_WORD(0));
            tilemap_set_scrolly(bg_tilemap, 0, -taitob_bscroll.READ_WORD(2));
    ...
    public static VhUpdatePtr masterw_vh_screenrefresh_tm = new VhUpdatePtr() {
        public void handler(osd_bitmap bitmap, int full_refresh) {
    ...
    public static VhUpdatePtr silentd_vh_screenrefresh_tm = new VhUpdatePtr() {
        public void handler(osd_bitmap bitmap, int full_refresh) {
            int i;

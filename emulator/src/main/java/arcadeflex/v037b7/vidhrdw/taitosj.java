...
public class taitosj {
    ...
    static osd_bitmap sprite_sprite_collbitmap1;
    static osd_bitmap sprite_sprite_collbitmap2;
    ...
    static rectangle[] spritearea = new rectangle[32];
    /*areas on bitmap (sprite locations)*/
    static int[] spriteon = new int[32];
    /* 1 if sprite is active */
     ...
     *
     * bit 0 -- inverter -- 220 ohm resistor -- RED bit 7 -- inverter -- 470 ohm
     * resistor -- RED -- inverter -- 1 kohm resistor -- RED -- inverter -- 220
     * ohm resistor -- GREEN -- inverter -- 470 ohm resistor -- GREEN --
     * inverter -- 1 kohm resistor -- GREEN -- inverter -- 220 ohm resistor --
     * BLUE -- inverter -- 470 ohm resistor -- BLUE bit 0 -- inverter -- 1 kohm
     * resistor -- BLUE
     *
     **************************************************************************
     */
 ...
 /* always mapped to color 0. This is needed for transparency. */
                if (i % 8 == 0) {
                    colortable[Machine.drv.gfxdecodeinfo[0].color_codes_start + i + 64] = (char) 0;
                } else {
                    colortable[Machine.drv.gfxdecodeinfo[0].color_codes_start + i + 64] = (char) i;
                }
            }
 ...
 /* layers has top priority when this one is transparent */
    ...
    public static WriteHandlerPtr taitosj_paletteram_w = new WriteHandlerPtr() {
    ...
    public static VhStopPtr taitosj_vh_stop = new VhStopPtr() {
        public void handler() {
            ...
            if (sprite_sprite_collbitmap2 != null) {
                bitmap_free(sprite_sprite_collbitmap2);
            }
            if (sprite_sprite_collbitmap1 != null) {
                bitmap_free(sprite_sprite_collbitmap1);
            }
            if (sprite_plane_collbitmap1 != null) {
                bitmap_free(sprite_plane_collbitmap1);
            }

            for (i = 0; i < 3; i++) {
                if (taitosj_tmpbitmap[i] != null) {
                    bitmap_free(taitosj_tmpbitmap[i]);
                }
                if (sprite_plane_collbitmap2[i] != null) {
                    bitmap_free(sprite_plane_collbitmap2[i]);
                }
            }

            if (dirtybuffer3 != null) {
                dirtybuffer3 = null;
            }
    ...
    public static ReadHandlerPtr taitosj_gfxrom_r = new ReadHandlerPtr() {
        public int handler(int offset) {
            ...
            if (taitosj_gfxpointer.read(0) == 0) {
                taitosj_gfxpointer.write(1, taitosj_gfxpointer.read(1) + 1);//taitosj_gfxpointer[1]++;
            }
            if (offs < 0x8000) {
    ...
    public static WriteHandlerPtr taitosj_videoram2_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
    ...
    public static WriteHandlerPtr taitosj_videoram3_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
    ...
    public static WriteHandlerPtr taitosj_colorbank_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
    ...
    public static WriteHandlerPtr taitosj_videoenable_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
    ...
    public static WriteHandlerPtr taitosj_characterram_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
     ...
     **************************************************************************
     */
    public static ReadHandlerPtr taitosj_collision_reg_r = new ReadHandlerPtr() {
        public int handler(int offset) {
            return taitosj_collision_reg[offset];
        }
    };

    public static WriteHandlerPtr taitosj_collision_reg_clear_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {

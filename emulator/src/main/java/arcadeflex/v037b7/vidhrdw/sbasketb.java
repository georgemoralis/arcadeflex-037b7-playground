...
public class sbasketb {
     ...
     * <p>
     * Super Basketball has three 256x4 palette PROMs (one per gun) and two
     * 256x4 lookup table PROMs (one for characters, one for sprites). I don't
     * know for sure how the palette PROMs are connected to the RGB output, but

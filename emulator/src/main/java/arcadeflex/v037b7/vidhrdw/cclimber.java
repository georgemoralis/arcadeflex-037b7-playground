...
public class cclimber {
    ...
    public static final int BIGSPRITE_HEIGHT = 128;
 ...
 /* it uses colors 64-95 */
    ...
    public static VhConvertColorPromPtr swimmer_vh_convert_color_prom = new VhConvertColorPromPtr() {
        public void handler(char[] palette, char[] colortable, UBytePtr color_prom) {
            ...
            palette[p_ptr++] = (char) (0x24);
            palette[p_ptr++] = (char) (0x5d);
            palette[p_ptr++] = (char) (0x4e);
    ...
    public static VhStartPtr cclimber_vh_start = new VhStartPtr() {
        public int handler() {
            ...
            if ((bsbitmap = bitmap_alloc(BIGSPRITE_WIDTH, BIGSPRITE_HEIGHT)) == null) {
                bsdirtybuffer = null;
                generic_vh_stop.handler();
                return 1;
            }
 ...
 /* since last time and update it accordingly. */
            ...
            /* update the "big sprite" */
            {
                ...
                for (offs = cclimber_bsvideoram_size[0] - 1; offs >= 0; offs--) {
                    ...
                    if (bsdirtybuffer[offs] != 0 || newcol != lastcol_1) {
 ...
 /* since last time and update it accordingly. */
            ...
            /* update the "big sprite" */
            {
                ...
                for (offs = cclimber_bsvideoram_size[0] - 1; offs >= 0; offs--) {
                    ...
                    if (bsdirtybuffer[offs] != 0 || newcol != lastcol_2) {
                        bsdirtybuffer[offs] = 0;

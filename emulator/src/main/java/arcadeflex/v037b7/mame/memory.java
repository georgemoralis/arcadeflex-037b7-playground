...
public class memory {
 ...
 /* value:					   */
    ...
    public static final int HT_BANK6 = 6;/* bank memory #6	 */
    public static final int HT_BANK7 = 7;/* bank memory #7	 */
    public static final int HT_BANK8 = 8;/* bank memory #8	 */
    public static final int HT_BANK9 = 9;/* bank memory #9	 */
    public static final int HT_BANK10 = 10;/* bank memory #10	 */
    public static final int HT_BANK11 = 11;/* bank memory #11	 */
    public static final int HT_BANK12 = 12;/* bank memory #12	 */
    public static final int HT_BANK13 = 13;/* bank memory #13	 */
    public static final int HT_BANK14 = 14;/* bank memory #14	 */
    public static final int HT_BANK15 = 15;/* bank memory #15	 */
    public static final int HT_BANK16 = 16;/* bank memory #16	 */
    public static final int HT_NON = 17;/* non mapped memory */
    public static final int HT_NOP = 18;/* NOP memory		 */
    public static final int HT_RAMROM = 19;/* RAM ROM memory	 */
    public static final int HT_ROM = 20;/* ROM memory		 */

    public static final int HT_USER = 21;/* user functions	 */

 /* [MH_HARDMAX]-0xff	  link to sub memory element  (value-MH_HARDMAX)<<MH_SBITS -> element bank */
...
/*TODO*///SETOPBASE(cpu_setOPbase32lew, 32LEW, 0)
    ...
    public static UBytePtr install_mem_read_handler(int cpu, int start, int end, ReadHandlerPtr _handler, int handler) {
        ...
        switch (handler) {
            case MRA_ROM:
            case MRA_RAM: {
                u8_hardware = HT_RAM;/* special case ram read */
                hw_set = 1;
            }
            break;
            case MRA_BANK1:
    ...
    public static void mem_dump() {
        ...
        FILE temp = null; //fopen("memdump.log", "w");

...
public class inptportH {
    ...
    public static class InputPortTiny {
        ...
        public /*UINT16*/ int default_value;/* default value for the bits affected you can also use one of the IP_ACTIVE defines below */
    ...
    public static final int IPT_PORT = 2;/* use IPT_JOYSTICK for panels where the player has one single joystick */
    ...
    public static final int IPT_JOYSTICK_RIGHT = 6;/* use IPT_JOYSTICKLEFT and IPT_JOYSTICKRIGHT for dual joystick panels */
 ...
 /* the following are special codes for user interface handling - not to be used by drivers_old! */
    ...
    public static final int IPT_UI_SHOW_COLORS = 77;
    public static final int IPT_UI_TOGGLE_UI = 78;
    public static final int __ipt_max = 79;

    public static final int IPF_MASK = 0xffffff00;
    public static final int IPF_UNUSED = 0x80000000;
    /* The bit is not used by this game, but is used */
 ...
 /* bits not connected to anything. */
    ...
    public static final int IPT_SPECIAL = IPT_UNUSED;
    /* special meaning handled by custom functions */

    public static final int IPF_CHEAT = 0x40000000;
    /* Indicates that the input bit is a "cheat" key */
 ...
 /* on one axis (e.g. Battle Zone) */
    ...
    public static final int IPF_IMPULSE = 0x00100000;
    /* When this is set, when the key corrisponding to */
 ...
 /* is specified in the "arg" field. */
    public static final int IPF_TOGGLE = 0x00200000;
    /* When this is set, the key acts as a toggle - press */
 /* it once and it goes on, press it again and it goes off. */
 /* useful e.g. for sone Test Mode dip switches. */
    public static final int IPF_REVERSE = 0x00400000;
    /* By default, analog inputs like IPT_TRACKBALL increase */
 /* when going right/up. This flag inverts them. */

    public static final int IPF_CENTER = 0x00800000;
    /* always preload in->default, autocentering the STICK/TRACKBALL */

    public static final int IPF_CUSTOM_UPDATE = 0x01000000;
    /* normally, analog ports are updated when they are accessed. */
 ...
 /* update_analog_port(int port). */
    ...
    public static final int IPF_RESETCPU = 0x02000000;

    /* when the key is pressed, reset the first CPU */
 /* The "arg" field contains 4 bytes fields */
    ...
    public static String IP_NAME_DEFAULT = "-1";/* Wrapper for compatibility */

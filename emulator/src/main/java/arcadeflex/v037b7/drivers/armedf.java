...
public class armedf {
    ...
    /* hack? - needed for Terra Force */
    public static WriteHandlerPtr io_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            switch (offset / 2) {
                case 0x0:
                    armedf_vreg = (char) COMBINE_WORD(armedf_vreg, data);
                    /* bits 0 and 1 of armedf_vreg are coin counters */
                    break;

                case 0x1:
                    armedf_bg_scrollx = (char) COMBINE_WORD(armedf_bg_scrollx, data);
                    break;

                case 0x2:
                    armedf_bg_scrolly = (char) COMBINE_WORD(armedf_bg_scrolly, data);
                    break;

                case 0x3:
                    armedf_fg_scrollx = (char) COMBINE_WORD(armedf_fg_scrollx, data);
                    break;

                case 0x4: {
                    flipflop = 1 - flipflop;
                    if (flipflop == 0) {
                        armedf_fg_scrolly = (char) COMBINE_WORD(armedf_fg_scrolly, data);
                    } else {
                        terraf_scroll_msb = (char) COMBINE_WORD(terraf_scroll_msb, data);
                    }
                }
                break;
    ...
    public static WriteHandlerPtr kodure_io_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            switch (offset / 2) {
                case 0x0:
                    armedf_vreg = (char) COMBINE_WORD(armedf_vreg, data);
 ...
 /* This is a temporary condition specification. */
    ...
    public static ReadHandlerPtr io_r = new ReadHandlerPtr() {
    ...
    public static WriteHandlerPtr kodure_videoreg_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            switch (offset) {
                case 0x16:
                    armedf_fg_scrolly = (char) (data & 0x00ff);
                    break;
                case 0x18:
                    armedf_fg_scrolly |= ((data & 0x00ff) << 8);
                    break;
                case 0x1a:
                    armedf_fg_scrollx = (char) (data & 0x00ff);
                    break;
                case 0x1c:
    ...
    public static ReadHandlerPtr soundlatch_clear_r = new ReadHandlerPtr() {
        public int handler(int offset) {
    ...
    static InputPortPtr input_ports_armedf = new InputPortPtr() {
        public void handler() {
            PORT_START();
            /* IN0 */
    ...
    static InputPortPtr input_ports_terraf = new InputPortPtr() {
        public void handler() {
            PORT_START();
            /* IN0 */
            PORT_BIT(0x01, IP_ACTIVE_LOW, IPT_JOYSTICK_UP | IPF_8WAY);
    ...
    static InputPortPtr input_ports_kodure = new InputPortPtr() {
        public void handler() {
            PORT_START();
            /* IN0 */
            PORT_BIT(0x01, IP_ACTIVE_LOW, IPT_JOYSTICK_UP | IPF_8WAY);
    ...
    static InputPortPtr input_ports_cclimbr2 = new InputPortPtr() {
        public void handler() {
            PORT_START();
            /* IN0 */
    ...
    public static InterruptPtr armedf_interrupt = new InterruptPtr() {
        public int handler() {
            return (1);
        }
    };

    public static InterruptPtr cclimbr2_interrupt = new InterruptPtr() {
        public int handler() {
            return (2);
        }
    };
    ...
    static RomLoadPtr rom_terraf = new RomLoadPtr() {
        public void handler() {
    ...
    static RomLoadPtr rom_terrafu = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(0x80000, REGION_CPU1);/* 64K*8 for 68000 code */
    ...
    static RomLoadPtr rom_kodure = new RomLoadPtr() {
        public void handler() {
    ...
    static RomLoadPtr rom_armedf = new RomLoadPtr() {
        public void handler() {
    ...
    static RomLoadPtr rom_cclimbr2 = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(0x80000, REGION_CPU1);/* 64K*8 for 68000 code */

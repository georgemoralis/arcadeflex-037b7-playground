...
import static arcadeflex.common.util.combineIntArrays;
//cpu imports
...
//vidhrdw imports
import static arcadeflex.v037b7.vidhrdw.snowbros.*;
...
public class snowbros {
 ...
 /* probably VBlank */
    ...
    static GfxLayout tilelayout = new GfxLayout(
            ...
            4,
            new int[]{0, 1, 2, 3},
            combineIntArrays(STEP8(0, 4), STEP8(8 * 32, 4)),
            combineIntArrays(STEP8(0, 32), STEP8(16 * 32, 32)),
            32 * 32
    );
    ...
    static GfxLayout tilelayout_wb = new GfxLayout(
            ...
            4,
            new int[]{0, 1, 2, 3},
            combineIntArrays(combineIntArrays(STEP4(3 * 4, -4), STEP4(7 * 4, -4)), combineIntArrays(STEP4(11 * 4, -4), STEP4(15 * 4, -4))),
            STEP16(0, 64),
            16 * 64
    );
    ...
    static RomLoadPtr rom_wintbob = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(0x40000, REGION_CPU1);/* 6*64k for 68000 code */

...
import static arcadeflex.v037b7.drivers.pipedrm.ym2608_interface;
//generic imports
...
import static arcadeflex.v037b7.mame.inptportH.IPF_2WAY;
...
import static arcadeflex.v037b7.mame.inptportH.IPT_SERVICE1;
...
import static arcadeflex.v037b7.mame.inptportH.IP_ACTIVE_HIGH;
import static arcadeflex.v037b7.mame.inptportH.IP_ACTIVE_LOW;
import static arcadeflex.v037b7.mame.inptportH.IP_JOY_DEFAULT;
import static arcadeflex.v037b7.mame.inptportH.PORT_BIT;
import static arcadeflex.v037b7.mame.inptportH.PORT_BITX;
...
import static arcadeflex.v037b7.mame.inputH.KEYCODE_F1;
...
import static arcadeflex.v037b7.mame.sndintrfH.SOUND_YM2608;
import static arcadeflex.v037b7.sound._2151intfH.YM3012_VOL;
import static arcadeflex.v037b7.sound._2608intf.YM2608_control_port_0_A_w;
import static arcadeflex.v037b7.sound._2608intf.YM2608_control_port_0_B_w;
import static arcadeflex.v037b7.sound._2608intf.YM2608_data_port_0_A_w;
import static arcadeflex.v037b7.sound._2608intf.YM2608_data_port_0_B_w;
import arcadeflex.v037b7.sound._2608intfH.YM2608interface;
import static arcadeflex.v037b7.sound.mixerH.MIXER_PAN_LEFT;
import static arcadeflex.v037b7.sound.mixerH.MIXER_PAN_RIGHT;
//vidhrdw imports
import static arcadeflex.v037b7.vidhrdw.tail2nos.*;
import static arcadeflex.v037b7.vidhrdw.generic.*;
//to be organized
import static gr.codebb.arcadeflex.WIP.v037b7.mame.palette.paletteram_xRRRRRGGGGGBBBBB_word_w;
import static gr.codebb.arcadeflex.WIP.v037b7.vidhrdw.konamiic.K051316_0_r;
import static gr.codebb.arcadeflex.WIP.v037b7.vidhrdw.konamiic.K051316_0_w;
import static gr.codebb.arcadeflex.WIP.v037b7.vidhrdw.konamiic.K051316_ctrl_0_w;
...
public class tail2nos {
    ...
    public static InitMachinePtr tail2nos_init_machine = new InitMachinePtr() {
        public void handler() {
            ...
            cpu_setbank(9, new UBytePtr(memory_region(REGION_CPU2), 0x10000));
        }
    };
    ...
    public static ReadHandlerPtr tail2nos_K051316_0_r = new ReadHandlerPtr() {
        public int handler(int offset) {
            return K051316_0_r.handler(offset >> 1);
        }
    };

    public static WriteHandlerPtr tail2nos_K051316_0_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            if ((data & 0x00ff0000) == 0) {
    ...
    public static WriteHandlerPtr tail2nos_K051316_ctrl_0_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            if ((data & 0x00ff0000) == 0) {
    ...
    public static WriteHandlerPtr sound_bankswitch_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            cpu_setbank(9, new UBytePtr(memory_region(REGION_CPU2), 0x10000 + (data & 0x01) * 0x8000));
        }
    };
    ...
    static InputPortPtr input_ports_tail2nos = new InputPortPtr() {
        public void handler() {
            PORT_START();
    ...
    static RomLoadPtr rom_tail2nos = new RomLoadPtr() {
        public void handler() {
 ...
 /* RAM, not ROM - handled at run time */
    ...
    static RomLoadPtr rom_sformula = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(0x40000, REGION_CPU1);/* 68000 code */

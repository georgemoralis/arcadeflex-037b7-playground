...
//vidhrdw imports
import static arcadeflex.v037b7.vidhrdw.mrjong.*;
...
public class mrjong {
    ...
    public static WriteHandlerPtr io_0x00_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            mrjong_flipscreen_w.handler(0, ((data & 0x04) > 2) ? 1 : 0);
        }
    };

    public static ReadHandlerPtr io_0x03_r = new ReadHandlerPtr() {
    ...
    static InputPortPtr input_ports_mrjong = new InputPortPtr() {
        public void handler() {
            PORT_START();
            /* IN0 */
     ...
     **************************************************************************
     */
    static RomLoadPtr rom_mrjong = new RomLoadPtr() {
        public void handler() {
    ...
    static RomLoadPtr rom_crazyblk = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(0x10000, REGION_CPU1);/* code */

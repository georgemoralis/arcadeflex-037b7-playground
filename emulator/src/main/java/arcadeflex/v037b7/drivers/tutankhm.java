...
public class tutankhm {
    ...
    public static WriteHandlerPtr tutankhm_bankselect_w = new WriteHandlerPtr() {
    ...
    public static WriteHandlerPtr tutankhm_coin_counter_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
    ...
    static MemoryWriteAddress writemem[]
            = {
                ...
                new MemoryWriteAddress(0x8202, 0x8203, tutankhm_coin_counter_w),
                new MemoryWriteAddress(0x8205, 0x8205, MWA_NOP), /* ??? */
                new MemoryWriteAddress(0x8206, 0x8206, flip_screen_x_w),
                new MemoryWriteAddress(0x8207, 0x8207, flip_screen_y_w),
    ...
    static InputPortPtr input_ports_tutankhm = new InputPortPtr() {
        public void handler() {
            PORT_START();
            /* DSW2 */
    ...
    static RomLoadPtr rom_tutankhm = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(0x20000, REGION_CPU1);
            /* 64k for M6809 CPU code + 64k for ROM banks */
    ...
    static RomLoadPtr rom_tutankst = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(0x20000, REGION_CPU1);
            /* 64k for M6809 CPU code + 64k for ROM banks */
            ROM_LOAD("h1.bin", 0x0a000, 0x1000, 0xda18679f);/* program ROMs */

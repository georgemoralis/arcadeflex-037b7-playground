...
import static arcadeflex.v037b7.vidhrdw.seicross.*;
//to be organized
...
public class seicross {
    ...
    public static InitMachinePtr friskyt_init_machine = new InitMachinePtr() {
        public void handler() {
 ...
 /* bit 2 resets the microcontroller */
    ...
    static MemoryWriteAddress mcu_nvram_writemem[]
            = {
                ...
                new MemoryWriteAddress(0x2000, 0x2000, DAC_0_data_w),
    ...
    static InputPortPtr input_ports_friskyt = new InputPortPtr() {
        public void handler() {
            PORT_START();
            /* IN0 */
    ...
    static InputPortPtr input_ports_radrad = new InputPortPtr() {
        public void handler() {
            PORT_START();
            /* IN0 */
            PORT_BIT(0x01, IP_ACTIVE_HIGH, IPT_JOYSTICK_UP | IPF_8WAY);
    ...
    static InputPortPtr input_ports_seicross = new InputPortPtr() {
        public void handler() {
            PORT_START();
            /* IN0 */
            PORT_BIT(0x01, IP_ACTIVE_HIGH, IPT_JOYSTICK_UP | IPF_8WAY);
     ...
     **************************************************************************
     */
    static RomLoadPtr rom_friskyt = new RomLoadPtr() {
        public void handler() {
 ...
 /* filled in later */
    ...
    static RomLoadPtr rom_radrad = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(0x10000, REGION_CPU1);/* 64k for code */
 ...
 /* filled in later */
    ...
    static RomLoadPtr rom_seicross = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(0x10000, REGION_CPU1);/* 64k for code */
 ...
 /* filled in later */
    ...
    static RomLoadPtr rom_sectrzon = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(0x10000, REGION_CPU1);/* 64k for code */
 ...
 /* filled in later */
    ...
    public static InitDriverPtr init_friskyt = new InitDriverPtr() {
        public void handler() {
            int A;
            UBytePtr src;
            UBytePtr dest;

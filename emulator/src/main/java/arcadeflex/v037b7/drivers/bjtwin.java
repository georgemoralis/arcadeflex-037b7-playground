...
public class bjtwin {
    ...
    public static WriteHandlerPtr bjtwin_oki6295_bankswitch_w = new WriteHandlerPtr() {
    ...
    static InputPortPtr input_ports_bjtwin = new InputPortPtr() {
        public void handler() {
            PORT_START();
            /* IN0 */
    ...
    static RomLoadPtr rom_bjtwin = new RomLoadPtr() {
        public void handler() {
    ...
    public static InitDriverPtr init_bjtwin = new InitDriverPtr() {
        public void handler() {

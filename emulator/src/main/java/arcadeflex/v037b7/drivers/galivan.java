...
//vidhrdw imports
import static arcadeflex.v037b7.vidhrdw.galivan.*;
...
public class galivan {
    ...
    public static WriteHandlerPtr galivan_sound_command_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            soundlatch_w.handler(offset, (data << 1) | 1);
        }
    };

    public static ReadHandlerPtr galivan_sound_command_r = new ReadHandlerPtr() {
    ...
    public static ReadHandlerPtr IO_port_c0_r = new ReadHandlerPtr() {
        public int handler(int offset) {
            return (0x58);
            /* To Avoid Reset on Ufo Robot dangar */
        }
    };

    /* the scroll registers are memory mapped in ninjemak, I/O ports in the others */
    public static WriteHandlerPtr ninjemak_videoreg_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            switch (offset) {
                case 0x0b:
    ...
    static IOReadPort readport[]
            = {
                ...
                new IOReadPort(0xc0, 0xc0, IO_port_c0_r), /* dangar needs to return 0x58 */
    ...
    static IOWritePort sound_writeport[]
            = {
                ...
                new IOWritePort(0x02, 0x02, DAC_0_data_w),
                new IOWritePort(0x03, 0x03, DAC_1_data_w),
                new IOWritePort(-1) /* end of table */};
    ...
    static RomLoadPtr rom_dangar = new RomLoadPtr() {
        public void handler() {
            ...
            ROM_REGION(0x20000, REGION_GFX2 | REGIONFLAG_DISPOSE);
            ROM_LOAD("dangar01.14f", 0x00000, 0x8000, 0xd59ed1f1);
            /* tiles */
            ...
            ROM_REGION(0x10000, REGION_GFX3 | REGIONFLAG_DISPOSE);
            ROM_LOAD("dangarxx.f4", 0x00000, 0x8000, 0x55711884);
            /* sprites */
    ...
    static RomLoadPtr rom_ninjemak = new RomLoadPtr() {
        public void handler() {
            ...
            ROM_LOAD("ninjemak.16", 0x00000, 0x8000, 0x8df93fed);
            /* sprites */
            ...
            ROM_LOAD("yncp-2d.bin", 0x0300, 0x0100, BADCRC(0x23bade78));
            /* sprite lookup table */
            ROM_LOAD("yncp-7f.bin", 0x0400, 0x0100, BADCRC(0x262d0809));
            /* sprite palette bank */
            ROM_END();
        }
    };

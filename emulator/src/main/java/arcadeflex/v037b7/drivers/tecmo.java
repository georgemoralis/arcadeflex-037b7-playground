...
public class tecmo {
    ...
    public static WriteHandlerPtr tecmo_adpcm_vol_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            MSM5205_set_volume(0, (data & 0x0f) * 100 / 15);
        }
    };
    static int adpcm_data = -1;
    public static vclk_interruptPtr tecmo_adpcm_int = new vclk_interruptPtr() {
    ...
    static MachineDriver machine_driver_gemini = new MachineDriver(
            ...
            new MachineCPU[]{
                ...
                new MachineCPU(
                        CPU_Z80 | CPU_AUDIO_CPU,
                        4000000, /* 4 MHz */
                        tecmo_sound_readmem, tecmo_sound_writemem, null, null,
                        ignore_interrupt, 0 /* IRQs triggered by YM3526 */
                /* NMIs triggered by main CPU */
                )
            },
     ...
     */
    public static InitDriverPtr init_rygar = new InitDriverPtr() {
        public void handler() {
            tecmo_video_type = 0;
        }
    };
    public static InitDriverPtr init_silkworm = new InitDriverPtr() {
        public void handler() {
            tecmo_video_type = 1;
        }
    };
    public static InitDriverPtr init_gemini = new InitDriverPtr() {
        public void handler() {
            tecmo_video_type = 2;
        }
    };

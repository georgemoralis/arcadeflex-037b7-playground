...
import static arcadeflex.v037b7.vidhrdw.prehisle.*;
//to be organized
...
public class prehisle {
    ...
    public static WriteHandlerPtr prehisle_sound_w = new WriteHandlerPtr() {
     ...
     * ***************************************************************************
     */
    static InputPortPtr input_ports_prehisle = new InputPortPtr() {
        public void handler() {
            PORT_START();
            /* Player 1 controls */
     ...
     * ***************************************************************************
     */
    static RomLoadPtr rom_prehisle = new RomLoadPtr() {
        public void handler() {
    ...
    static RomLoadPtr rom_prehislu = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(0x40000, REGION_CPU1);
    ...
    static RomLoadPtr rom_gensitou = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(0x40000, REGION_CPU1);
     ...
     * ***************************************************************************
     */
    public static ReadHandlerPtr world_cycle_r = new ReadHandlerPtr() {
    ...
    public static InitDriverPtr init_prehisle = new InitDriverPtr() {
        public void handler() {
            install_mem_read_handler(0, 0x70024, 0x70025, world_cycle_r);
        }
    };

    public static ReadHandlerPtr usa_cycle_r = new ReadHandlerPtr() {
        public int handler(int offset) {
            int pc = cpu_get_pc();
            int ret = prehisle_ram.READ_WORD(0x24);
    ...
    public static InitDriverPtr init_prehislu = new InitDriverPtr() {
        public void handler() {
            install_mem_read_handler(0, 0x70024, 0x70025, usa_cycle_r);
        }
    };

    public static ReadHandlerPtr jap_cycle_r = new ReadHandlerPtr() {
        public int handler(int offset) {
            int pc = cpu_get_pc();
            int ret = prehisle_ram.READ_WORD(0x24);
    ...
    public static InitDriverPtr init_gensitou = new InitDriverPtr() {
        public void handler() {

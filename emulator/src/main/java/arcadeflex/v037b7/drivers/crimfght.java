...
import static gr.codebb.arcadeflex.WIP.v037b7.mame.memory.mwh_ram;
...
import static gr.codebb.arcadeflex.WIP.v037b7.mame.memoryH.MWA_BANK1;
...
public class crimfght {
    ...
    public static InitMachinePtr crimfght_init_machine = new InitMachinePtr() {
        public void handler() {
            UBytePtr RAM = memory_region(REGION_CPU1);
 ...
 /* b0: bank for channel B */
     ...
     **************************************************************************
     */
    static InputPortPtr input_ports_crimfght = new InputPortPtr() {
        public void handler() {
            PORT_START();
            /* DSW #1 */
    ...
    static InputPortPtr input_ports_crimfgtj = new InputPortPtr() {
        public void handler() {
            PORT_START();
            /* DSW #1 */
            PORT_DIPNAME(0x0f, 0x0f, DEF_STR("Coinage"));
     ...
     **************************************************************************
     */
    static RomLoadPtr rom_crimfght = new RomLoadPtr() {
        public void handler() {
    ...
    static RomLoadPtr rom_crimfgtj = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(0x28000, REGION_CPU1);/* code + banked roms */
    ...
    static RomLoadPtr rom_crimfgt2 = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(0x28000, REGION_CPU1);/* code + banked roms */
     ...
     **************************************************************************
     */
    public static InitDriverPtr init_crimfght = new InitDriverPtr() {
        public void handler() {

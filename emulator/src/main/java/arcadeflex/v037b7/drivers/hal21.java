...
public class hal21 {
    ...
    public static VhStartPtr aso_vh_start = new VhStartPtr() {
        public int handler() {
            scrollx_base = -16;
    ...
    public static VhStartPtr hal21_vh_start = new VhStartPtr() {
        public int handler() {
            scrollx_base = 240;
            return common_vh_start.handler();
        }
    ...
    public static VhStopPtr aso_vh_stop = new VhStopPtr() {
        public void handler() {
 ...
 /* that's most likely wrong. */
    ...
    public static VhUpdatePtr aso_vh_screenrefresh = new VhUpdatePtr() {
    ...
    static InputPortPtr input_ports_hal21 = new InputPortPtr() {
        public void handler() {
            PORT_START();
     ...
     * ***********************************************************************
     */
    static InputPortPtr input_ports_aso = new InputPortPtr() {
        public void handler() {
            PORT_START();
     ...
     * ***********************************************************************
     */
    static RomLoadPtr rom_hal21 = new RomLoadPtr() {
        public void handler() {
    ...
    static RomLoadPtr rom_hal21j = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(0x10000, REGION_CPU1);/* 64k for CPUA code */
            ROM_LOAD("hal21p1.bin", 0x0000, 0x2000, 0x9d193830);
            ROM_LOAD("hal21p2.bin", 0x2000, 0x2000, 0xc1f00350);
    ...
    static RomLoadPtr rom_aso = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(0x10000, REGION_CPU1);/* 64k for cpuA code */

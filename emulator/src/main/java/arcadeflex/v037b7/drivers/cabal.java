...
//vidhrdw imports
import static arcadeflex.v037b7.vidhrdw.cabal.*;
...
public class cabal {
    ...
    public static InitMachinePtr cabal_init_machine = new InitMachinePtr() {
        public void handler() {
            cabal_sound_command1 = cabal_sound_command2 = 0xff;
        }
    };

    public static ReadHandlerPtr cabal_background_r = new ReadHandlerPtr() {
        public int handler(int offset) {
            return videoram.READ_WORD(offset);
        }
    };

    public static WriteHandlerPtr cabal_background_w = new WriteHandlerPtr() {
    ...
    public static WriteHandlerPtr cabal_play_adpcm = new WriteHandlerPtr() {
        public void handler(int channel, int which) {
            if (which != 0xff) {
    ...
    static int coin = 0;
    public static ReadHandlerPtr cabal_coin_r = new ReadHandlerPtr() {
        public int handler(int offset) {
    ...
    public static ReadHandlerPtr cabal_io_r = new ReadHandlerPtr() {
        public int handler(int offset) {
    ...
    public static WriteHandlerPtr cabal_sndcmd_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            switch (offset) {
                case 0x0:
     ...
     * ******************************************************************
     */
    public static ReadHandlerPtr cabal_snd_r = new ReadHandlerPtr() {
        public int handler(int offset) {
            switch (offset) {
                case 0x08:
    ...
    public static WriteHandlerPtr cabal_snd_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            switch (offset) {
                case 0x00:
                    cabal_play_adpcm.handler(0, data);
                    break;
                case 0x02:
                    cabal_play_adpcm.handler(1, data);
                    break;
            }
        }
    };
 ...
 /*#if 0
     ...
     * ************************************************************************
     */
    static InputPortPtr input_ports_cabal = new InputPortPtr() {
        public void handler() {
            PORT_START();
            /* IN0 */
    ...
    static RomLoadPtr rom_cabal = new RomLoadPtr() {
        public void handler() {
 ...
 /* the bootleg */
    ...
    static RomLoadPtr rom_cabal2 = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(0x50000, REGION_CPU1);/* 64k for cpu code */
 ...
 /* the bootleg */
    ...
    static RomLoadPtr rom_cabalbl = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(0x50000, REGION_CPU1);/* 64k for cpu code */

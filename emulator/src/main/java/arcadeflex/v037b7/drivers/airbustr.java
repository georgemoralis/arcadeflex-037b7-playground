...
//vidhrdw imports
import static arcadeflex.v037b7.vidhrdw.airbustr.*;
...
public class airbustr {
    ...
    public static UBytePtr devram = new UBytePtr();
    public static UBytePtr sharedram = new UBytePtr();
    public static int soundlatch_status, soundlatch2_status;
 ...
 /*	Runs in IM 2	fd-fe	address of int: 0x38
    ...
    public static ReadHandlerPtr devram_r = new ReadHandlerPtr() {
        public int handler(int offset) {
            switch (offset) {
    ...
    public static WriteHandlerPtr devram_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            devram.write(offset, data);
        }
    };
    ...
    public static WriteHandlerPtr bankswitch_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            ...
            if ((data & 7) < 3) {
                RAM = new UBytePtr(RAM, 0x4000 * (data & 7));
            } else {
                RAM = new UBytePtr(RAM, 0x10000 + 0x4000 * ((data & 7) - 3));
            }
    ...
    /* Ports */
    public static WriteHandlerPtr cause_nmi_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
    ...
    static IOWritePort writeport[]
            = {
                ...
                new IOWritePort(0x02, 0x02, cause_nmi_w), // always 0. Cause a nmi to sub cpu
                new IOWritePort(-1)
            };
 ...
 /*	Runs in IM 2	fd-fe	address of int: 0x36e	(same as 0x38)
    ...
    public static WriteHandlerPtr bankswitch2_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
    ...
    public static WriteHandlerPtr airbustr_paletteram_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            int r, g, b;
 ...
 /*
     ...
     */
    public static ReadHandlerPtr soundcommand_status_r = new ReadHandlerPtr() {
        public int handler(int offset) {
    ...
    public static ReadHandlerPtr soundcommand2_r = new ReadHandlerPtr() {
        public int handler(int offset) {
    ...
    public static WriteHandlerPtr port_38_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            u4 = data;
        }
    }; // for debug
	...
	**
    ...
    /* Ports */
    public static ReadHandlerPtr soundcommand_r = new ReadHandlerPtr() {
        public int handler(int offset) {
    ...
    public static WriteHandlerPtr soundcommand2_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
 ...
 /* let's swap even and odd nibbles */
            ...
            RAM.write(0x37f4, 0x00);
            RAM.write(0x37f5, 0x00);	// startup check. We need a reset

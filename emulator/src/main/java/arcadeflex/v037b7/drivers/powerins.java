...
import static arcadeflex.v037b7.vidhrdw.powerins.*;
//to be organized
...
public class powerins {
     ...
     **************************************************************************
     */
    public static ReadHandlerPtr powerins_input_r = new ReadHandlerPtr() {
        public int handler(int offset) {
            switch (offset) {
                ...
                case 0x3e:
                    return OKIM6295_status_0_r.handler(0);	// OKI Status
     ...
     **************************************************************************
     */
    static InputPortPtr input_ports_powerins = new InputPortPtr() {
        public void handler() {
     ...
     * ---------------------------------------------- 27C240 ROM1 4EA1 [ MAIN
     * PROGRAM ] 27C240 ROM2 FE60 [ PROGRAM DATA ] 27C010 ROM3 B9F7 [ CHARACTER
     * ] 27C040 ROM4 2780 [ BACKGROUND ] 27C040 ROM5 98E0 [ PCM DATA ] 23C1600
     * ROM6 D9E9 [ BACKGROUND ] 23C1600 ROM7 8B04 [ MOTION OBJ ] 23C1600 ROM8
     * 54B2 [ MOTION OBJ ] 23C1600 ROM9 C7C8 [ MOTION OBJ ] 23C1600 ROM10 852A [
     * MOTION OBJ ]
     *
     * Notes: This archive is of a bootleg version The main program is
     * encrypted, using PLDs
     *
     * Brief hardware overview -----------------------
     *
     * Main processor - 68000 - TPC1020AFN-084C (CPLD)
     *
     * Sound processor - Main processor - K-665-9249 (M6295)
     *
     **************************************************************************
     */
    static RomLoadPtr rom_powerins = new RomLoadPtr() {
        public void handler() {

...
//vidhrdw imports
import static arcadeflex.v037b7.vidhrdw.magix.*;
//to be organized
...
public class magix {
    ...
    public static InitMachinePtr magix_init_machine = new InitMachinePtr() {
        public void handler() {
            ...
            magix_videoram_0 = new UBytePtr(RAM, 0x0000);	// Ram is banked
            magix_videoram_1 = new UBytePtr(RAM, 0x2000);
            magix_videobank_w.handler(0, 0);
        }
    };
     ...
     * *************************************************************************
     */
    public static WriteHandlerPtr magix_bankswitch_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            ...
            if (bank < 3) {
                RAM = new UBytePtr(RAM, 0x4000 * bank);
            } else {
                RAM = new UBytePtr(RAM, 0x4000 * (bank - 3) + 0x10000);
            }
    ...
    public static WriteHandlerPtr magix_sound_bankswitch_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
    ...
    public static WriteHandlerPtr magix_adpcm_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            /* Swap the nibbles */
     ...
     **************************************************************************
     */
    static InputPortPtr input_ports_magix = new InputPortPtr() {
        public void handler() {
     ...
     */
    static int toggle = 0;
    public static vclk_interruptPtr magix_adpcm_int = new vclk_interruptPtr() {
     ...
     **************************************************************************
     */
    static RomLoadPtr rom_magix = new RomLoadPtr() {
        public void handler() {

            ROM_REGION(0x24000 + 0x4000, REGION_CPU1);
            /* Main Z80 Code */

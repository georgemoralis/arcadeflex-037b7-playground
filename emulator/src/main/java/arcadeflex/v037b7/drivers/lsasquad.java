...
//machine imports
import static arcadeflex.v037b7.machine.lsasquad.*;
//mame improts
...
//vidhrdw imports
import static arcadeflex.v037b7.vidhrdw.lsasquad.*;

public class lsasquad {

    public static WriteHandlerPtr lsasquad_bankswitch_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            UBytePtr ROM = memory_region(REGION_CPU1);

            /* bits 0-2 select ROM bank */
            cpu_setbank(1, new UBytePtr(ROM, 0x10000 + 0x2000 * (data & 7)));

            /* bit 3 is zeroed on startup, maybe reset sound CPU */
 /* bit 4 flips screen */
            flip_screen_w.handler(offset, data & 0x10);
    ...
    static InputPortPtr input_ports_lsasquad = new InputPortPtr() {
        public void handler() {
            PORT_START();
            /* DSWA */
    ...
    public static WriteHandlerPtr unk = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
        }
    };
 ...
 /* support that so we use 2 YM2203 */
     ...
     **************************************************************************
     */
    static RomLoadPtr rom_lsasquad = new RomLoadPtr() {
        public void handler() {
    ...
    static RomLoadPtr rom_storming = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(0x20000, REGION_CPU1);
    ...
    public static InitDriverPtr init_lsasquad = new InitDriverPtr() {
        public void handler() {
            lsasquad_invertcoin = 0x00;
        }
    };
    public static InitDriverPtr init_storming = new InitDriverPtr() {
        public void handler() {

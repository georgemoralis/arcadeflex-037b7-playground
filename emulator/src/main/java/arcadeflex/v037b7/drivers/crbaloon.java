...
//platform imports
//sound imports
import static arcadeflex.v037b7.sound.sn76477.*;
import static arcadeflex.v037b7.sound.sn76477H.*;
//vidhrdw imports
import static arcadeflex.v037b7.vidhrdw.crbaloon.*;
...
public class crbaloon {
    ...
    public static InitMachinePtr crbaloon_machine_init = new InitMachinePtr() {
        public void handler() {
            /* MIXER A = 0, MIXER C = 1 */
    ...
    public static WriteHandlerPtr crbaloon_06_w = new WriteHandlerPtr() {
    ...
    public static WriteHandlerPtr crbaloon_08_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            val08 = data;

            crbaloon_flipscreen_w.handler(offset, data & 1);
        }
    };

    public static WriteHandlerPtr crbaloon_0a_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            val0a = data;
        }
    };

    public static ReadHandlerPtr crbaloon_IN2_r = new ReadHandlerPtr() {
    ...
    public static ReadHandlerPtr crbaloon_IN3_r = new ReadHandlerPtr() {
        public int handler(int offset) {
            if ((val08 & 0x02) != 0) /* enable coin & start input? Wild guess!!! */ {
    ...
    public static ReadHandlerPtr crbaloon_IN_r = new ReadHandlerPtr() {
        public int handler(int offset) {
            switch (offset & 0x03) {
                case 0:
                ...
                case 2:
                    return crbaloon_IN2_r.handler(offset);

                case 3:
                    return crbaloon_IN3_r.handler(offset);
            }
    ...
    static SN76477interface sn76477_interface = new SN76477interface(
            1, /* 1 chip */
            new int[]{100}, /* mixing level   pin description		 */
            new double[]{RES_K(47)}, /*	4  noise_res		 */
            new double[]{RES_K(330)}, /*	5  filter_res		 */
            new double[]{CAP_P(470)}, /*	6  filter_cap		 */
            new double[]{RES_K(220)}, /*	7  decay_res		 */
            new double[]{CAP_U(1.0)}, /*	8  attack_decay_cap  */
            new double[]{RES_K(4.7)}, /* 10  attack_res		 */
            new double[]{RES_M(1)}, /* 11  amplitude_res	 */
            new double[]{RES_K(200)}, /* 12  feedback_res 	 */
            new double[]{5.0}, /* 16  vco_voltage		 */
            new double[]{CAP_P(470)}, /* 17  vco_cap			 */
            new double[]{RES_K(330)}, /* 18  vco_res			 */
            new double[]{5.0}, /* 19  pitch_voltage	 */
            new double[]{RES_K(20)}, /* 20  slf_res			 */
            new double[]{CAP_P(420)}, /* 21  slf_cap			 */
            new double[]{CAP_U(1.0)}, /* 23  oneshot_cap		 */
            new double[]{RES_K(47)} /* 24  oneshot_res		 */
    );

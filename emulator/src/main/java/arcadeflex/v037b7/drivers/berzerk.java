...
//machine imports
import static arcadeflex.v037b7.machine.berzerk.*;
//mame imports
...
//platform imports
//sndhrdw imports
import static arcadeflex.v037b7.sndhrdw.berzerk.*;
//sound imports
import static arcadeflex.v037b7.sound.samplesH.*;
//vidhrdw imports
import static arcadeflex.v037b7.vidhrdw.berzerk.*;
...
public class berzerk {
    ...
    public static nvramPtr berzerk_nvram_handler = new nvramPtr() {
    ...
    static IOReadPort readport[] = {
        new IOReadPort(0x44, 0x44, berzerk_voiceboard_r), /* Sound stuff */
    ...
    static Samplesinterface berzerk_samples_interface = new Samplesinterface(8, /* 8 channels */ 25, /* volume */ berzerk_sample_names);

    static CustomSound_interface custom_interface = new CustomSound_interface(berzerk_sh_start, null, berzerk_sh_update);

    static MachineDriver machine_driver_berzerk = new MachineDriver(
    ...
    static MachineDriver machine_driver_frenzy = new MachineDriver(
            /* basic machine hardware */
            new MachineCPU[]{
                new MachineCPU(
                        CPU_Z80,
     ...
     **************************************************************************
     */
    static RomLoadPtr rom_berzerk = new RomLoadPtr() {
        public void handler() {
    ...
    static RomLoadPtr rom_berzerk1 = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(0x10000, REGION_CPU1);
    ...
    static RomLoadPtr rom_frenzy = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(0x10000, REGION_CPU1);

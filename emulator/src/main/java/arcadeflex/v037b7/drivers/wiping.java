...
//sndhrdw imports
import static arcadeflex.v037b7.sndhrdw.wiping.*;
//vidhrdw imports
import static arcadeflex.v037b7.vidhrdw.wiping.*;
import static arcadeflex.v037b7.vidhrdw.generic.*;

public class wiping {

    static UBytePtr sharedram1 = new UBytePtr();
    static UBytePtr sharedram2 = new UBytePtr();

    public static ReadHandlerPtr shared1_r = new ReadHandlerPtr() {
        public int handler(int offset) {
            return sharedram1.read(offset);
        }
    };

    public static ReadHandlerPtr shared2_r = new ReadHandlerPtr() {
        public int handler(int offset) {
            return sharedram2.read(offset);
        }
    };

    public static WriteHandlerPtr shared1_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            sharedram1.write(offset, data);
        }
    };

    public static WriteHandlerPtr shared2_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            sharedram2.write(offset, data);
        }
    };

    /* input ports are rotated 90 degrees */
    public static ReadHandlerPtr ports_r = new ReadHandlerPtr() {
        public int handler(int offset) {
            int i, res;
    ...
    public static WriteHandlerPtr subcpu_reset_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            if ((data & 1) != 0) {
    ...
    static InputPortPtr input_ports_rugrats = new InputPortPtr() {
        public void handler() {
            PORT_START();
            /* 0 */
            PORT_BIT(0x01, IP_ACTIVE_HIGH, IPT_JOYSTICK_UP | IPF_4WAY);

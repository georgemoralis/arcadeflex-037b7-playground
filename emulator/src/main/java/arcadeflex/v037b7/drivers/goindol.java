...
//vidhrdw imports
import static arcadeflex.v037b7.vidhrdw.goindol.*;
...
public class goindol {
    ...
    static InputPortPtr input_ports_goindol = new InputPortPtr() {
        public void handler() {
    ...
    static InputPortPtr input_ports_homo = new InputPortPtr() {
        public void handler() {
     ...
     **************************************************************************
     */
    static RomLoadPtr rom_goindol = new RomLoadPtr() {
        public void handler() {
    ...
    static RomLoadPtr rom_homo = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(0x20000, REGION_CPU1);
            /* 2*64k for code */
    ...
    public static InitDriverPtr init_goindol = new InitDriverPtr() {
        public void handler() {
    ...
    public static InitDriverPtr init_homo = new InitDriverPtr() {
        public void handler() {
            UBytePtr rom = memory_region(REGION_CPU1);

...
//vidhrdw imports
import static arcadeflex.v037b7.vidhrdw.terracre.*;
...
public class terracre {
    ...
    public static WriteHandlerPtr terracre_misc_w = new WriteHandlerPtr() {
    ...
    public static ReadHandlerPtr terracre_ports_r = new ReadHandlerPtr() {
    ...
    static InputPortPtr input_ports_terracre = new InputPortPtr() {
        public void handler() {
            PORT_START();
            /* Player 1 controls */
    ...
    static RomLoadPtr rom_terracre = new RomLoadPtr() {
        public void handler() {
     ...
     * *******************************************************
     */
    static RomLoadPtr rom_terracrb = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(0x20000, REGION_CPU1);/* 128K for 68000 code */
            ROM_LOAD_ODD("1a_4b.rom", 0x00000, 0x4000, 0x76f17479);
            ROM_LOAD_EVEN("1a_4d.rom", 0x00000, 0x4000, 0x8119f06e);
     ...
     * *******************************************************
     */
    static RomLoadPtr rom_terracra = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(0x20000, REGION_CPU1);/* 128K for 68000 code */
            ROM_LOAD_ODD("1a_4b.rom", 0x00000, 0x4000, 0x76f17479);
            ROM_LOAD_EVEN("1a_4d.rom", 0x00000, 0x4000, 0x8119f06e);

...
//machine imports
import static arcadeflex.v037b7.machine.mexico86.*;
//mame improts
...
//vidhrdw imports
import static arcadeflex.v037b7.vidhrdw.mexico86.*;
...
public class mexico86 {
	...
	bit 0 = ? (unused?)
     */
    public static WriteHandlerPtr mexico86_f008_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
    ...
    static MemoryWriteAddress writemem[]
            = {
                ...
                new MemoryWriteAddress(0xf800, 0xffff, MWA_RAM), /* communication ram */
    ...
    static InputPortPtr input_ports_mexico86 = new InputPortPtr() {
        public void handler() {
            PORT_START();
            /* IN0 */
 ...
 /* and the other as slave, probably to play four players */
    ...
    static InputPortPtr input_ports_kikikai = new InputPortPtr() {
        public void handler() {
            PORT_START();
            /* IN0 */
            PORT_BIT(0x01, IP_ACTIVE_LOW, IPT_COIN1);
     ...
     **************************************************************************
     */
    static RomLoadPtr rom_kikikai = new RomLoadPtr() {
        public void handler() {
    ...
    static RomLoadPtr rom_kicknrun = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(0x28000, REGION_CPU1);
            /* 196k for code */
            ...
            ROM_REGION(0x0800, REGION_CPU3);/* 2k for the microcontroller */
            ROM_LOAD("knrmcu.bin", 0x0000, 0x0800, BADCRC(0x8e821fa0));
            /* manually crafted from the Mexico '86 one */
    ...
    static RomLoadPtr rom_mexico86 = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(0x28000, REGION_CPU1);
            /* 196k for code */

...
//vidhrdw imports
import static arcadeflex.v037b7.vidhrdw.battlane.*;
//to be organized
...
public class battlane {
    ...
    public static WriteHandlerPtr battlane_shared_ram_w = new WriteHandlerPtr() {
    ...
    public static ReadHandlerPtr battlane_shared_ram_r = new ReadHandlerPtr() {
    ...
    public static WriteHandlerPtr battlane_cpu_command_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
 ...
 /*
    ...
    public static InterruptPtr battlane_cpu1_interrupt = new InterruptPtr() {
        public int handler() {
    ...
    public static InterruptPtr battlane_cpu2_interrupt = new InterruptPtr() {
        public int handler() {
    ...
    static InputPortPtr input_ports_battlane = new InputPortPtr() {
        public void handler() {
            PORT_START();
            /* IN0 */
     ...
     * *************************************************************************
     */
    static RomLoadPtr rom_battlane = new RomLoadPtr() {
        public void handler() {
 ...
 /* first half of da00-5 will be copied at 0x4000-0x7fff */
    ...
    static RomLoadPtr rom_battlan2 = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(0x10000, REGION_CPU1);
            /* 64k for main CPU */
 /* first half of da00-3 will be copied at 0x4000-0x7fff */
    ...
    static RomLoadPtr rom_battlan3 = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(0x10000, REGION_CPU1);
            /* 64k for main CPU */
 /* first half of bl_04.rom will be copied at 0x4000-0x7fff */
    ...
    public static InitDriverPtr init_battlane = new InitDriverPtr() {
        public void handler() {
            UBytePtr src;
            UBytePtr dest;
            int A;

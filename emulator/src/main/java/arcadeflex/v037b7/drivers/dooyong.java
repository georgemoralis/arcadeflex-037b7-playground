...
public class dooyong {
    ...
    public static WriteHandlerPtr lastday_bankswitch_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            ...
            if ((data & 0xf8) != 0) {
                usrintf_showmessage("bankswitch %02x", data);
            }
        }
    };
    ...
    static InputPortPtr input_ports_lastday = new InputPortPtr() {
        public void handler() {
            PORT_START();
    ...
    static InputPortPtr input_ports_pollux = new InputPortPtr() {
        public void handler() {
            PORT_START();
            PORT_SERVICE(0x01, IP_ACTIVE_LOW);
            PORT_DIPNAME(0x04, 0x04, DEF_STR("Demo_Sounds"));
    ...
    static InputPortPtr input_ports_bluehawk = new InputPortPtr() {
        public void handler() {
            PORT_START();
            PORT_SERVICE(0x01, IP_ACTIVE_LOW);
            PORT_DIPNAME(0x04, 0x04, DEF_STR("Demo_Sounds"));
    ...
    static InputPortPtr input_ports_primella = new InputPortPtr() {
        public void handler() {
            PORT_START();
            PORT_SERVICE(0x01, IP_ACTIVE_LOW);
            PORT_DIPNAME(0x04, 0x04, DEF_STR("Demo_Sounds"));
    ...
    static InputPortPtr input_ports_rshark = new InputPortPtr() {
        public void handler() {
            PORT_START();
    ...
    public static ReadHandlerPtr unk_r = new ReadHandlerPtr() {
    ...
    public static InterruptPtr rshark_interrupt = new InterruptPtr() {
        public int handler() {
            if (cpu_getiloops() == 0) {
                return 5;
            } else {
    ...
    static RomLoadPtr rom_lastday = new RomLoadPtr() {
        public void handler() {
    ...
    static RomLoadPtr rom_lastdaya = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(0x30000, REGION_CPU1);/* 64k for code + 128k for banks */
            ROM_LOAD("lday3.bin", 0x00000, 0x10000, 0xa06dfb1e);
            ROM_RELOAD(0x10000, 0x10000);
    ...
    static RomLoadPtr rom_pollux = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(0x30000, REGION_CPU1);/* 64k for code + 128k for banks */
    ...
    static RomLoadPtr rom_bluehawk = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(0x30000, REGION_CPU1);/* 64k for code + 128k for banks */
    ...
    static RomLoadPtr rom_primella = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(0x30000, REGION_CPU1);/* 64k for code + 128k for banks */
    ...
    static RomLoadPtr rom_rshark = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(0x40000, REGION_CPU1);/* 64k for code + 128k for banks */
            ROM_LOAD_EVEN("rspl00.bin", 0x00000, 0x20000, 0x40356b9d);
            ROM_LOAD_ODD("rspu00.bin", 0x00000, 0x20000, 0x6635c668);
    ...
    public static InitDriverPtr init_pollux = new InitDriverPtr() {
        public void handler() {

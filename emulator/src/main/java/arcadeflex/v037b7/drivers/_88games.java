...
import static gr.codebb.arcadeflex.WIP.v037b7.mame.commonH.REGION_SOUND2;
...
import static gr.codebb.arcadeflex.WIP.v037b7.mame.commonH.ROM_LOAD_GFX_EVEN;
import static gr.codebb.arcadeflex.WIP.v037b7.mame.commonH.ROM_LOAD_GFX_ODD;
...
import static gr.codebb.arcadeflex.WIP.v037b7.mame.inptportH.IPF_CHEAT;
...
import static gr.codebb.arcadeflex.WIP.v037b7.mame.inptportH.IPT_BUTTON4;
...
import static gr.codebb.arcadeflex.WIP.v037b7.mame.inptportH.IP_JOY_DEFAULT;
import static gr.codebb.arcadeflex.WIP.v037b7.mame.inptportH.IP_KEY_DEFAULT;
...
import static gr.codebb.arcadeflex.WIP.v037b7.sound.upd7759H.UPD7759_STANDALONE_MODE;
import static gr.codebb.arcadeflex.WIP.v037b7.sound.upd7759H.UPD7759_STANDARD_CLOCK;
import gr.codebb.arcadeflex.WIP.v037b7.sound.upd7759H.UPD7759_interface;
import gr.codebb.arcadeflex.WIP.v037b7.sound.upd7759H.irqcallbackPtr;
...
import static gr.codebb.arcadeflex.WIP.v037b7.vidhrdw.konamiic.K051316_rom_0_r;
...
public class _88games {
 ...
 /* bit 7 controls layer priority */
    ...
    public static InitMachinePtr k88games_init_machine = new InitMachinePtr() {
        public void handler() {
    ...
    public static InterruptPtr k88games_interrupt = new InterruptPtr() {
        public int handler() {
 ...
 /* also 5fce == 2 read roms, == 3 read ram */
     ...
     **************************************************************************
     */
    static InputPortPtr input_ports_88games = new InputPortPtr() {
        public void handler() {
            PORT_START();
     ...
     **************************************************************************
     */
    static RomLoadPtr rom_88games = new RomLoadPtr() {
        public void handler() {
    ...
    static RomLoadPtr rom_konami88 = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(0x21000, REGION_CPU1);/* code + banked roms + space for banked ram */
    ...
    static RomLoadPtr rom_hypsptsp = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(0x21000, REGION_CPU1);/* code + banked roms + space for banked ram */
    ...
    public static InitDriverPtr init_88games = new InitDriverPtr() {
        public void handler() {

...
//vidhrdw imports
import static arcadeflex.v037b7.vidhrdw.thief.*;

public class thief {

    static /*UINT8*/ int u8_thief_input_select;

    public static InterruptPtr thief_interrupt = new InterruptPtr() {
        public int handler() {
	...
	**	tracks.
     */
    public static final int kTalkTrack = 0;
    public static final int kCrashTrack = 1;
     ...
     * ********************************************************
     */
    public static WriteHandlerPtr thief_input_select_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            u8_thief_input_select = data & 0xFF;
        }
    };

    public static WriteHandlerPtr tape_control_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            switch (data) {
                case 0x02:
                    /* coin meter on */
    ...
    public static ReadHandlerPtr thief_io_r = new ReadHandlerPtr() {
        public int handler(int offset) {
            switch (u8_thief_input_select) {
                case 0x01:
     ...
     * *******************************************************
     */
    static InputPortPtr input_ports_sharkatt = new InputPortPtr() {
        public void handler() {
            PORT_START();
            /* IN0 */
    ...
    static InputPortPtr input_ports_thief = new InputPortPtr() {
        public void handler() {
            PORT_START();
    ...
    static InputPortPtr input_ports_natodef = new InputPortPtr() {
        public void handler() {
            PORT_START();
            PORT_DIPNAME(0x03, 0x00, DEF_STR("Coinage"));
            PORT_DIPSETTING(0x01, DEF_STR("2C_1C"));
     ...
     * *******************************************************
     */
    static RomLoadPtr rom_sharkatt = new RomLoadPtr() {
        public void handler() {
    ...
    static RomLoadPtr rom_thief = new RomLoadPtr() {
        public void handler() {
    ...
    static RomLoadPtr rom_natodef = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(0x10000, REGION_CPU1);/* Z80 code */

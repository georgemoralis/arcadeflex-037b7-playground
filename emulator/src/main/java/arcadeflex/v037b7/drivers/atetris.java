...
//vidhrdw imports
import static arcadeflex.v037b7.vidhrdw.atetris.*;
import static arcadeflex.v037b7.vidhrdw.generic.*;
//to be organized
import static gr.codebb.arcadeflex.WIP.v037b7.mame.palette.paletteram_RRRGGGBB_w;
...
public class atetris {
    ...
    static InputPortPtr input_ports_atetris = new InputPortPtr() {
        public void handler() {
    ...
    static InputPortPtr input_ports_atetcktl = new InputPortPtr() {
        public void handler() {
            // These ports are read via the Pokeys
            PORT_START();
            /* IN0 */
     ...
     **************************************************************************
     */
    static RomLoadPtr rom_atetris = new RomLoadPtr() {
        public void handler() {
    ...
    static RomLoadPtr rom_atetrisa = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(0x14000, REGION_CPU1);
            /* 80k for code */
    ...
    static RomLoadPtr rom_atetrisb = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(0x14000, REGION_CPU1);
            /* 80k for code */
 ...
 /* however doesn't seem to be required to run the game in this driver. */
    ...
    static RomLoadPtr rom_atetcktl = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(0x14000, REGION_CPU1);
            /* 80k for code */
    ...
    static RomLoadPtr rom_atetckt2 = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(0x14000, REGION_CPU1);
            /* 80k for code */
    ...
    public static InitDriverPtr init_atetris = new InitDriverPtr() {
        public void handler() {

...
import static arcadeflex.v037b7.vidhrdw.bssoccer.*;
//to be organized
...
public class bssoccer {
     ...
     * Z80 #1
     *
     * Plays the music (YM2151) and controls the 2 Z80s in charge of playing the
     * PCM samples
     *
     *
     **************************************************************************
     ...
     */
    /* Bank Switching */
    public static WriteHandlerPtr bssoccer_pcm_1_bankswitch_w = new WriteHandlerPtr() {
    ...
    public static WriteHandlerPtr bssoccer_pcm_2_bankswitch_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
    ...
    public static WriteHandlerPtr bssoccer_DAC_1_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            DAC_data_w.handler(0 + (offset & 1), (data & 0xf) * 0x11);
        }
    };

    public static WriteHandlerPtr bssoccer_DAC_2_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
     ...
     **************************************************************************
     */
    static InputPortPtr input_ports_bssoccer = new InputPortPtr() {
        public void handler() {
    ...
    public static InterruptPtr bssoccer_interrupt = new InterruptPtr() {
        public int handler() {
     ...
     * [ Back Street Soccer ]
     *
     * 68000-10 32MHz 14.318MHz 01 02 12 03 04 Z80B 6264 6264 YM2151 6116 11 13
     * 62256 Z80B Z80B 62256 62256 05 06 SW2 07 08 SW1 09 10 6116-45 6116-45
     * 6116-45 6116-45
     *
     **************************************************************************
     */
    static RomLoadPtr rom_bssoccer = new RomLoadPtr() {
        public void handler() {
            ...
            ROM_REGION(0x080000, REGION_CPU3);
            /* Z80 #2 - PCM */
            ROM_LOAD("13", 0x000000, 0x080000, 0x2b273dca);

            ROM_REGION(0x080000, REGION_CPU4);
            /* Z80 #3 - PCM */
    ...
    public static InitDriverPtr init_bssoccer = new InitDriverPtr() {
        public void handler() {
            UBytePtr RAM = memory_region(REGION_GFX1);
            int i, len = memory_region_length(REGION_GFX1);

            for (i = 0; i < len; i++) {
                RAM.xor(i,0xff); // invert all the bits of sprites
            }
        }
    };

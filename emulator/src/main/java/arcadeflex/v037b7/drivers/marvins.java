...
//vidhrdw imports
import static arcadeflex.v037b7.vidhrdw.marvins.*;
...
public class marvins {
    ...
    static MemoryReadAddress readmem_CPUA[]
            = {
                ...
                new MemoryReadAddress(0x8700, 0x8700, CPUB_int_trigger_r),
    ...
    static MemoryWriteAddress writemem_CPUA[]
            = {
                ...
                new MemoryWriteAddress(0x8700, 0x8700, CPUA_int_enable_w),
    ...
    static MemoryReadAddress marvins_readmem_CPUB[]
            = {
                new MemoryReadAddress(0x0000, 0x7fff, MRA_ROM),
                new MemoryReadAddress(0x8700, 0x8700, CPUA_int_trigger_r),
    ...
    static MemoryWriteAddress marvins_writemem_CPUB[]
            = {
                new MemoryWriteAddress(0x0000, 0x7fff, MWA_ROM),
                new MemoryWriteAddress(0x8700, 0x8700, CPUB_int_enable_w),
    ...
    static MemoryWriteAddress madcrash_writemem_CPUB[]
            = {
                new MemoryWriteAddress(0x0000, 0x7fff, MWA_ROM),
                new MemoryWriteAddress(0x8700, 0x8700, CPUB_int_enable_w), /* Vangaurd II */
                new MemoryWriteAddress(0x8000, 0x9fff, MWA_ROM), /* extra ROM for Mad Crasher */
                new MemoryWriteAddress(0xa000, 0xa000, CPUB_int_enable_w), /* Mad Crasher */

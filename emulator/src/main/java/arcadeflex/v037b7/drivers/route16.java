...
//vidhrdw imports
import static arcadeflex.v037b7.vidhrdw.route16.*;
...
public class route16 {
    ...
    static MemoryReadAddress cpu1_readmem[]
            = {
                ...
                new MemoryReadAddress(0x4000, 0x43ff, route16_sharedram_r),
                new MemoryReadAddress(0x4800, 0x4800, input_port_0_r),
                new MemoryReadAddress(0x5000, 0x5000, input_port_1_r),
                new MemoryReadAddress(0x5800, 0x5800, input_port_2_r),
                new MemoryReadAddress(0x8000, 0xbfff, route16_videoram1_r),
                new MemoryReadAddress(-1) /* end of table */};

    static MemoryWriteAddress cpu1_writemem[]
            = {
                new MemoryWriteAddress(0x0000, 0x2fff, MWA_ROM),
                new MemoryWriteAddress(0x4000, 0x43ff, route16_sharedram_w, route16_sharedram),
                new MemoryWriteAddress(0x4800, 0x4800, route16_out0_w),
                new MemoryWriteAddress(0x5000, 0x5000, route16_out1_w),
                new MemoryWriteAddress(0x8000, 0xbfff, route16_videoram1_w, route16_videoram1, route16_videoram_size),
                new MemoryWriteAddress(0xc000, 0xc000, MWA_RAM), // Stratvox has an off by one error
                // when clearing the screen
                new MemoryWriteAddress(-1) /* end of table */};

    static IOWritePort cpu1_writeport[]
            = {
                new IOWritePort(0x6800, 0x6800, AY8910_write_port_0_w),
                new IOWritePort(0x6900, 0x6900, AY8910_control_port_0_w),
    ...
    static MemoryReadAddress cpu2_readmem[]
            = {
                ...
                new MemoryReadAddress(0x4000, 0x43ff, route16_sharedram_r),
                new MemoryReadAddress(0x8000, 0xbfff, route16_videoram2_r),
                new MemoryReadAddress(-1) /* end of table */};

    static MemoryWriteAddress cpu2_writemem[]
            = {
                new MemoryWriteAddress(0x0000, 0x1fff, MWA_ROM),
                new MemoryWriteAddress(0x2800, 0x2800, DAC_0_data_w), // Not used by Route 16
                new MemoryWriteAddress(0x4000, 0x43ff, route16_sharedram_w),
                new MemoryWriteAddress(0x8000, 0xbfff, route16_videoram2_w, route16_videoram2),
                new MemoryWriteAddress(0xc000, 0xc1ff, MWA_NOP), // Route 16 sometimes writes outside of
                new MemoryWriteAddress(-1) /* end of table */ // the video ram. (Probably a bug)
            };

    static InputPortPtr input_ports_route16 = new InputPortPtr() {
        public void handler() {
            PORT_START();
            /* DSW 1 */
    ...
    static InputPortPtr input_ports_stratvox = new InputPortPtr() {
        public void handler() {
            PORT_START();
            /* IN0 */
            PORT_DIPNAME(0x01, 0x00, DEF_STR("Lives"));
     ...
     **************************************************************************
     */
    static RomLoadPtr rom_route16 = new RomLoadPtr() {
        public void handler() {
    ...
    static RomLoadPtr rom_route16b = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(0x10000, REGION_CPU1); // 64k for the first CPU
    ...
    static RomLoadPtr rom_stratvox = new RomLoadPtr() {
        public void handler() {
    ...
    static RomLoadPtr rom_stratvxb = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(0x10000, REGION_CPU1);
            /* 64k for code */
            ROM_LOAD("ls01.bin", 0x0000, 0x0800, 0xbf4d582e);
    ...
    static RomLoadPtr rom_speakres = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(0x10000, REGION_CPU1);
            /* 64k for code */
    ...
    public static GameDriver driver_stratvox = new GameDriver("1980", "stratvox", "route16.java", rom_stratvox, null, machine_driver_stratvox, input_ports_stratvox, init_stratvox, ROT270, "Taito", "Stratovox");
    public static GameDriver driver_stratvxb = new GameDriver("1980", "stratvxb", "route16.java", rom_stratvxb, driver_stratvox, machine_driver_stratvox, input_ports_stratvox, init_stratvox, ROT270, "bootleg", "Stratovox (bootleg)");
    public static GameDriver driver_speakres = new GameDriver("????", "speakres", "route16.java", rom_speakres, driver_stratvox, machine_driver_stratvox, input_ports_stratvox, init_stratvox, ROT270, "<unknown>", "Speak & Rescue");
}

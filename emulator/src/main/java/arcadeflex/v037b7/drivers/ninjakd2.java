...
//vidhrdw imports
import static arcadeflex.v037b7.vidhrdw.ninjakd2.*;
//to be organized
...
public class ninjakd2 {
    ...
    public static ShStartPtr ninjakd2_init_samples = new ShStartPtr() {
    ...
    public static InterruptPtr ninjakd2_interrupt = new InterruptPtr() {
        public int handler() {
            return 0x00d7;
            /* RST 10h */
        }
    ...
    static InputPortPtr input_ports_ninjakd2 = new InputPortPtr() {
        public void handler() {
            PORT_START();
    ...
    static RomLoadPtr rom_ninjakd2 = new RomLoadPtr() {
        public void handler() {
    ...
    static RomLoadPtr rom_ninjak2a = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(0x30000, REGION_CPU1);
    ...
    static RomLoadPtr rom_ninjak2b = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(0x30000, REGION_CPU1);
    ...
    static RomLoadPtr rom_rdaction = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(0x30000, REGION_CPU1);
    ...
    public static InitDriverPtr init_ninjak2a = new InitDriverPtr() {
        public void handler() {

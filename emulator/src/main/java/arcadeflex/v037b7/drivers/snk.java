...
import static arcadeflex.v037b7.sound.y8950intf.*;
//vidhrdw 
import static arcadeflex.v037b7.vidhrdw.snk.*;
//to be organized
import static gr.codebb.arcadeflex.old.arcadeflex.osdepend.logerror;

public class snk {

    static int SNK_NMI_ENABLE = 1;
    static int SNK_NMI_PENDING = 2;
    ...
    static int SNK_MAX_INPUT_PORTS = 12;
    ...
    static int snk_io[];/* input port configuration */
    ...
    public static WriteHandlerPtr snk_soundlatch_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
    ...
    public static ReadHandlerPtr snk_soundlatch_clear_r = new ReadHandlerPtr() {
        public int handler(int offset) {
            /* TNK3 */
    ...
    static MemoryReadAddress YM3526_readmem_sound[] = {
        ...
        new MemoryReadAddress(0xc000, 0xc000, snk_soundlatch_clear_r),
    ...
    public static WriteHandlerPtr cpuA_io_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            switch (offset) {
                ...
                case 0x500:
                    /* tdfever */
                    snk_soundlatch_w.handler(0, data);
                    break;
    ...
    static RomLoadPtr rom_bermudat = new RomLoadPtr() {
        public void handler() {
            ...
            ROM_REGION(0x10000, REGION_CPU3);/* 64k for sound code */
            ROM_LOAD("bt_p3.rom", 0x00000, 0x10000, 0x53a82e50);
            /* YM3526 */
    ...
    static RomLoadPtr rom_bermudaj = new RomLoadPtr() {
        public void handler() {
            ...
            ROM_REGION(0x10000, REGION_CPU3);/* 64k for sound code */
            ROM_LOAD("btj_p03.bin", 0x00000, 0x10000, 0xfea8a096);
            /* YM3526 */

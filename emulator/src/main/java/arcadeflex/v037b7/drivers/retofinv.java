...
//vidhrdw imports
import static arcadeflex.v037b7.vidhrdw.retofinv.*;
...
public class retofinv {
    ...
    public static ReadHandlerPtr retofinv_shared_ram_r = new ReadHandlerPtr() {
        public int handler(int offset) {
            UBytePtr RAM = memory_region(REGION_CPU1);
            return RAM.read(0x8800 + offset);
        }
    };

    public static WriteHandlerPtr retofinv_shared_ram_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            UBytePtr RAM = memory_region(REGION_CPU1);
            RAM.write(0x8800 + offset, data);
        }
    };

    public static WriteHandlerPtr retofinv_protection_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            UBytePtr RAM = memory_region(REGION_CPU1);

            if ((cpu0_me800_last & 0x80) != 0) {
                cpu0_me000 = (char) (data & 0xFF);
                cpu0_me800_last = 0;
                return;
            } else if (data < 0x10) {
                switch (data) {
                    case 0x01:
                        cpu0_me000 = (char) ((((cpu0_me000 >> 3) & 3) + 1) & 0xFF);
                        break;
                    case 0x02:
                        cpu0_me000 = (char) (cpu0_me000 & 3);
                        break;
                    default:
                ...
                switch (data) {
                    case 0x30:
                        ...
                        break;
                    case 0x40:
                        cpu0_me000 = RAM.read(0x9800);
                        break;
                    case 0x41:
                        cpu0_me000 = RAM.read(0x9801);
                        break;
                    case 0x42:
                        cpu0_me000 = RAM.read(0x9802);
                        break;
                    default:
                        cpu0_me000 = 0x3b;
                        break;
            ...
            cpu0_me800_last = (char) (data & 0xFF);
        }
    };

    public static ReadHandlerPtr retofinv_protection_r = new ReadHandlerPtr() {
        public int handler(int offset) {
            return cpu0_me000;
        }
    };

    public static WriteHandlerPtr reset_cpu2_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            if (data != 0) {
    ...
    public static WriteHandlerPtr reset_cpu1_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            if (data != 0) {
    ...
    public static WriteHandlerPtr cpu1_halt_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            cpu_set_halt_line(1, data != 0 ? CLEAR_LINE : ASSERT_LINE);
        }
    };

    public static ReadHandlerPtr protection_2_r = new ReadHandlerPtr() {
        public int handler(int offset) {
            return 0;
        }
    };

    public static ReadHandlerPtr protection_3_r = new ReadHandlerPtr() {
        public int handler(int offset) {
            return 0x30;
        }
    };

    public static WriteHandlerPtr cpu2_m6000_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            cpu2_m6000 = (char) (data & 0xFF);
        }
    };

    public static ReadHandlerPtr cpu0_mf800_r = new ReadHandlerPtr() {
        public int handler(int offset) {
            return cpu2_m6000;
        }
    };
    ...
    static InputPortPtr input_ports_retofinv = new InputPortPtr() {
        public void handler() {
            ...
            PORT_START();
            /* DSW3 modified by Shingo Suzuki 1999/11/03 */

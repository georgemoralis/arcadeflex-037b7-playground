...
//common imports
//generic imports
import static arcadeflex.WIP.v037b7.drivers.mcr68.zwackery_port_2_r;
import static arcadeflex.v037b7.generic.funcPtr.*;
import static arcadeflex.v037b7.machine._6821pia.*;
import static arcadeflex.v037b7.machine._6821piaH.*;
//machine imports
import static arcadeflex.v037b7.machine.z80fmly.*;
...
//vidhrdw imports
import static arcadeflex.v037b7.vidhrdw.mcr3.*;
//to be organized
...
/*TODO*///	
    ...
    public static WriteHandlerPtr mcr_scroll_value_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            switch (offset) {
                case 0:
	...
	public static IrqfuncPtr zwackery_pia_irq = new IrqfuncPtr() {
        @Override
            public void handler(int state) {

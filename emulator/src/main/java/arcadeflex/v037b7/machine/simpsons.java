...
public class simpsons {
    ...
    public static ReadHandlerPtr simpsons_eeprom_r = new ReadHandlerPtr() {
    ...
    public static WriteHandlerPtr simpsons_eeprom_w = new WriteHandlerPtr() {
     ...
     **************************************************************************
     */
    public static WriteHandlerPtr simpsons_coin_counter_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
 ...
 /* bit 5 = enable sprite ROM reading */
    ...
    public static ReadHandlerPtr simpsons_sound_interrupt_r = new ReadHandlerPtr() {
        public int handler(int offset) {
    ...
    static int res = 0x80;
    public static ReadHandlerPtr simpsons_sound_r = new ReadHandlerPtr() {
        public int handler(int offset) {
     ...
     **************************************************************************
     */
    public static ReadHandlerPtr simpsons_speedup1_r = new ReadHandlerPtr() {
    ...
    public static ReadHandlerPtr simpsons_speedup2_r = new ReadHandlerPtr() {
        public int handler(int offs) {
     ...
     **************************************************************************
     */
    public static konami_cpu_setlines_callbackPtr simpsons_banking = new konami_cpu_setlines_callbackPtr() {
        public void handler(int lines) {
            ...
            switch (lines & 0xf0) {
                ...
                case 0x30:
                    /* simp_012.rom ( lines goes from 0x00 to 0x0c ) */

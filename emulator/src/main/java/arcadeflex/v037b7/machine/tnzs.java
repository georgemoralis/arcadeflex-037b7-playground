...
public class tnzs {
 ...
 /*TODO*///			if (errorlog != null) fprintf (errorlog, "PC %04x (re %04x): write %02x to mcu %04x\n", cpu_get_pc(), cpu_geturnpc(), data, 0xc000 + offset);
    ...
    public static InitDriverPtr init_extrmatn = new InitDriverPtr() {
        public void handler() {
 ...
 /* copy it there otherwise the CPU bank switching support will not catch it. */
    ...
    public static InitDriverPtr init_arkanoi2 = new InitDriverPtr() {
        public void handler() {
            UBytePtr RAM = memory_region(REGION_CPU1);
 ...
 /* copy it there otherwise the CPU bank switching support will not catch it. */
    ...
    public static InitDriverPtr init_drtoppel = new InitDriverPtr() {
        public void handler() {
            UBytePtr RAM = memory_region(REGION_CPU1);
 ...
 /* copy it there otherwise the CPU bank switching support will not catch it. */
    ...
    public static InitDriverPtr init_chukatai = new InitDriverPtr() {
        public void handler() {
            UBytePtr RAM = memory_region(REGION_CPU1);
 ...
 /* copy it there otherwise the CPU bank switching support will not catch it. */
    ...
    public static InitDriverPtr init_tnzs = new InitDriverPtr() {
        public void handler() {
            UBytePtr RAM = memory_region(REGION_CPU1);
            mcu_type = MCU_TNZS;
 ...
 /* copy it there otherwise the CPU bank switching support will not catch it. */
    ...
    public static InitDriverPtr init_insectx = new InitDriverPtr() {
        public void handler() {
            mcu_type = MCU_NONE;
    ...
    public static InitDriverPtr init_kageki = new InitDriverPtr() {
        public void handler() {
    ...
    public static InterruptPtr tnzs_interrupt = new InterruptPtr() {
        public int handler() {
            int coin;
    ...
    public static InitMachinePtr tnzs_init_machine = new InitMachinePtr() {
        public void handler() {

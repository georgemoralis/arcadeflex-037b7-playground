...
//sndhrdw imports
import static arcadeflex.v037b7.sndhrdw.bosco.*;
//sound imports
import static arcadeflex.v037b7.sound.samples.*;
//vidhrdw imports
import static arcadeflex.v037b7.vidhrdw.bosco.*;
//to be organized
...
public class bosco {
    ...
    public static WriteHandlerPtr bosco_customio_data_1_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
    ...
    public static ReadHandlerPtr bosco_customio_data_1_r = new ReadHandlerPtr() {
        public int handler(int offset) {
            switch (customio_command_1) {
                case 0x71:
                    if (offset == 0) {
    ...
    public static ReadHandlerPtr bosco_customio_1_r = new ReadHandlerPtr() {
        public int handler(int offset) {
            return customio_command_1;
        }
    };

    public static timer_callback bosco_nmi_generate_1 = new timer_callback() {
        public void handler(int trigger) {
            cpu_cause_interrupt(0, Z80_NMI_INT);
        }
    };

    public static WriteHandlerPtr bosco_customio_1_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            if (data != 0x10) {
    ...
    public static WriteHandlerPtr bosco_customio_data_2_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
    ...
    public static ReadHandlerPtr bosco_customio_data_2_r = new ReadHandlerPtr() {
        public int handler(int offset) {
            switch (customio_command_2) {
                case 0x91:
                    if (offset == 2) {
    ...
    public static ReadHandlerPtr bosco_customio_2_r = new ReadHandlerPtr() {
        public int handler(int offset) {
            return customio_command_2;
        }
    };

    public static timer_callback bosco_nmi_generate_2 = new timer_callback() {
        public void handler(int trigger) {
            cpu_cause_interrupt(1, Z80_NMI_INT);
        }
    };

    public static WriteHandlerPtr bosco_customio_2_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            if (data != 0x10) {

...
public class mappy {
    ...
    public static WriteHandlerPtr mappy_customio_1_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
    ...
    public static WriteHandlerPtr mappy_customio_2_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
    ...
    public static ReadHandlerPtr mappy_customio_1_r = new ReadHandlerPtr() {
        public int handler(int offset) {
            ...
            if (mode == 1 || mode == 3) {
                switch (offset) {
					...
					/* bit 0 is a trigger for the coin slot */
                        if ((val & 1) != 0 && ((val ^ lastval_1) & 1) != 0) ++credits;
    ...
    public static ReadHandlerPtr mappy_customio_2_r = new ReadHandlerPtr() {
        public int handler(int offset) {
    ...
    public static ReadHandlerPtr digdug2_customio_1_r = new ReadHandlerPtr() {
        public int handler(int offset) {
            int crednum[] = {1, 1, 2, 2};
            int credden[] = {1, 2, 1, 3};
            int val, temp, mode = mappy_customio_1.read(8);
			...
			/* mode 3 is the standard, and returns actual important values */
                if (mode == 1 || mode == 3) {
                    switch (offset) {
						...
						/* bit 0 is a trigger for the coin slot */
                            if ((val & 1) != 0 && ((val ^ lastval_3) & 1) != 0) ++credits;
    ...
    public static ReadHandlerPtr digdug2_customio_2_r = new ReadHandlerPtr() {
        public int handler(int offset) {
            int mode = mappy_customio_2.read(8);
    ...
    public static ReadHandlerPtr motos_customio_1_r = new ReadHandlerPtr() {
        public int handler(int offset) {
		...
		/* mode 1 is the standard, and returns actual important values */
            if (mode == 1) {
                switch (offset) {
					...
					/* bit 0 is a trigger for the coin slot */
                        if ((val & 1) != 0 && ((val ^ lastval_5) & 1) != 0) ++credits;
    ...
    public static ReadHandlerPtr motos_customio_2_r = new ReadHandlerPtr() {
        public int handler(int offset) {
            int mode = mappy_customio_2.read(8);
    ...
    public static ReadHandlerPtr todruaga_customio_1_r = new ReadHandlerPtr() {
        public int handler(int offset) {
            int crednum[] = {1, 1, 2, 2};
            int credden[] = {1, 2, 1, 3};
            int val, temp, mode = mappy_customio_1.read(8);
			...
			/* mode 3 is the standard, and returns actual important values */
                if (mode == 1 || mode == 3) {
                    switch (offset) {
						...
						/* bit 0 is a trigger for the coin slot */
                            if ((val & 1) != 0 && ((val ^ lastval_6) & 1) != 0) ++credits;
    ...
    public static ReadHandlerPtr todruaga_customio_2_r = new ReadHandlerPtr() {
        public int handler(int offset) {
            int mode = mappy_customio_2.read(8);

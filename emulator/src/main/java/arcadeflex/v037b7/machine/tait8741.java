...
//machine imports
import static arcadeflex.v037b7.machine.tait8741H.*;
//mame imports
...
public class tait8741 {
    ...
    public static class I8741 {
        ...
        /* to host data      */
 /*unsigned*/ char fromData;
        /* from host data    */
 /*unsigned*/ char fromCmd;
        /* from host command */
 /*unsigned*/ char status;
        /* b0 = rd ready,b1 = wd full,b2 = cmd ?? */
 /*unsigned*/ char mode;
        /*unsigned*/ char phase;
            ...
            switch (st.phase) {
                ...
                case CMD_IDLE:
                    ...
                    switch (data) {
                        ...
                        case 0x03:
                        /* read receive buffer 2 */

                        case 0x04:
                        /* read receive buffer 3 */

                        case 0x05:
                        /* read receive buffer 4 */

                        case 0x06:
                        /* read receive buffer 5 */

                        case 0x07:
                            /* read receive buffer 6 */

                            //if(errorlog && data == 2 && num==0 && st.rxd[data-1]&0x80) fprintf(errorlog,"Coin Get\n");
                            taito8741_hostdata_w(st, st.rxd[data - 1]);
                            break;
                        case 0x08:
                            /* latch received serial data */
                            ...
                            break;
                        case 0x0a:
                            /* 8741-0 : set serial comminucation mode 'MASTER' */

                            //st.mode = TAITO8741_MASTER;
                            break;
                        case 0x0b:
                            /* 8741-1 : set serial comminucation mode 'SLAVE'  */

                            //st.mode = TAITO8741_SLAVE;
                            break;
                        case 0x1f:
                        /* 8741-2,3 : ?? set parallelport mode ?? */
                        ...
                        case 0x62:
                            ...
                            break;
                        case 0x4a:
                            /* ?? syncronus with other cpu and return 00H */
                            ...
                            break;
                        case 0x80:
                            /* 8741-3 : return check code */

                            taito8741_hostdata_w(st, 0x66);
                            break;
                        case 0x81:
                            /* 8741-2 : return check code */

                            taito8741_hostdata_w(st, 0x48);
                            break;
                        case 0xf0:
                            /* GSWORD 8741-1 : initialize ?? */

                            break;
                        case 0x82:
                            /* GSWORD 8741-2 unknown */

...
public class superpac {
    ...
    public static ReadHandlerPtr superpac_customio_1_r = new ReadHandlerPtr() {
        public int handler(int offset) {
            int val, temp;
    ...
    public static ReadHandlerPtr superpac_customio_2_r = new ReadHandlerPtr() {
        public int handler(int offset) {
            int val;
    ...
    public static WriteHandlerPtr superpac_interrupt_enable_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            interrupt_enable_w.handler(0, offset);
        }
    };

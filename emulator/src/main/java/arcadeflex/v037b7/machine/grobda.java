...
public class grobda {
    ...
    public static UBytePtr grobda_customio_1 = new UBytePtr();
    public static UBytePtr grobda_customio_2 = new UBytePtr();
    static int int_enable_1, int_enable_2;
    static int credits, coincounter1, coincounter2;

    public static InitMachinePtr grobda_init_machine = new InitMachinePtr() {
        public void handler() {
    ...
    /* memory handlers */
    public static ReadHandlerPtr grobda_snd_sharedram_r = new ReadHandlerPtr() {
        public int handler(int offset) {
            return grobda_snd_sharedram.read(offset);
        }
    };

    public static WriteHandlerPtr grobda_snd_sharedram_w = new WriteHandlerPtr() {
    ...
    public static WriteHandlerPtr grobda_interrupt_ctrl_1_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            int_enable_1 = offset;
        }
    };

    public static WriteHandlerPtr grobda_interrupt_ctrl_2_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            int_enable_2 = offset;
        }
    };

    public static InterruptPtr grobda_interrupt_1 = new InterruptPtr() {
        public int handler() {
            if (int_enable_1 != 0) {
    ...
    public static InterruptPtr grobda_interrupt_2 = new InterruptPtr() {
        public int handler() {
            if (int_enable_2 != 0) {
                return interrupt.handler();
            } else {
    ...
    public static WriteHandlerPtr grobda_cpu2_enable_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
     ...
     * **********************************************************************************
     */
    public static WriteHandlerPtr grobda_customio_1_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            grobda_customio_1.write(offset, data);
        }
    };

    public static WriteHandlerPtr grobda_customio_2_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
    ...
    public static ReadHandlerPtr grobda_customio_1_r = new ReadHandlerPtr() {
        public int handler(int offset) {
    ...
    public static ReadHandlerPtr grobda_customio_2_r = new ReadHandlerPtr() {
        public int handler(int offset) {
            int val, mode;
            ...
            if (mode == 8) /* IO tests chip 2 */ {
                ...
                switch (offset) {
                    case 0:
                        val = (readinputport(1) & 0x03);
                        /* lives */
                        val |= (readinputport(0) & 0x18) >> 1;
                        /* rank */
                        break;
                    case 1:
                        val = (readinputport(2) >> 6) & 0x01;
                        /* attrack mode sound_old */
                        val |= (readinputport(1) >> 1) & 0x02;
                        /* select mode */
                        val |= (readinputport(1) & 0xc0) >> 4;
                        /* bonus life */
                        break;
                    case 2:
                        val = (readinputport(0) & 0x07) << 1;
                        /* coinage A */
                        break;
                    case 4:
                        val = (readinputport(0) & 0xe0) >> 5;
                        /* coinage B */
                        break;
                    case 6:
                        val = readinputport(1) & 0x08;
                        /* test mode */
                        val |= (readinputport(4) & 0x20) >> 5;
                        /* 1P button 2 */
                        val |= (readinputport(4) & 0x80) >> 6;
                        /* 1P button 2 (cocktail mode) */

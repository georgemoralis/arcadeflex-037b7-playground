...
import static arcadeflex.v037b7.vidhrdw.galaga.*;
//to be organized
...
public class galaga {
    ...
    public static WriteHandlerPtr galaga_sharedram_w = new WriteHandlerPtr() {
    ...
    public static WriteHandlerPtr galaga_interrupt_enable_1_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            interrupt_enable_1 = (char) ((data & 1) & 0xFF);
        }
    };
    ...
    public static WriteHandlerPtr galaga_interrupt_enable_2_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            interrupt_enable_2 = (char) ((data & 1) & 0xFF);
        }
    };

...
public class digdug {
    ...
    public static UBytePtr digdug_sharedram = new UBytePtr();
    static char interrupt_enable_1, interrupt_enable_2, interrupt_enable_3;
    ...
    public static ReadHandlerPtr digdug_customio_data_r = new ReadHandlerPtr() {
        public int handler(int offset) {
            switch (customio_command) {
                case 0x71:
                    if (offset == 0) {
 ...
 /*         4          */
    ...
    public static WriteHandlerPtr digdug_interrupt_enable_3_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            interrupt_enable_3 = (char) ((data & 1) == 0 ? 1 : 0);
        }
    };

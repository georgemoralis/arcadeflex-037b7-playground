...
public class phozon {
    ...
    public static UBytePtr phozon_customio_1 = new UBytePtr();
    ...
    /* memory handlers */
    public static ReadHandlerPtr phozon_spriteram_r = new ReadHandlerPtr() {
        public int handler(int offset) {
            return phozon_spriteram.read(offset);
        }
    };

    public static WriteHandlerPtr phozon_spriteram_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            phozon_spriteram.write(offset, data);
        }
    };

    public static ReadHandlerPtr phozon_snd_sharedram_r = new ReadHandlerPtr() {
        public int handler(int offset) {
            return phozon_snd_sharedram.read(offset);
        }
    };

    public static WriteHandlerPtr phozon_snd_sharedram_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
    ...
    public static WriteHandlerPtr phozon_cpu2_enable_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            cpu_set_halt_line(1, offset != 0 ? CLEAR_LINE : ASSERT_LINE);
        }
    };

    public static WriteHandlerPtr phozon_cpu3_enable_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            cpu_set_halt_line(2, offset != 0 ? CLEAR_LINE : ASSERT_LINE);
        }
    };

    public static WriteHandlerPtr phozon_cpu3_reset_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {

...
public class k053260 extends snd_interface {
    ...
    static void InitDeltaTable() {
        ...
        double max = (double) K053260_chip.intf.clock;
        /* hz */
...
//#endif
    ...
    public static WriteHandlerPtr K053260_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            ...
            if (r < 0x28) {
                ...
                switch ((r - 8) & 0x07) {
                    ...
                    case 7:
                        /* volume is 7 bits. Convert to 8 bits now. */
 ...
 /* bit 2 = unknown */
    ...
    public static ReadHandlerPtr K053260_r = new ReadHandlerPtr() {

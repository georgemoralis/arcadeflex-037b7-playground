...
public class MSM5205 extends snd_interface {
 ...
 /* step size index shift table */
    ...
    public static class MSM5205Voice {
        ...
        Object timer;/* VCLK callback timer          */
    ...
    public static timer_callback MSM5205_vclk_callback = new timer_callback() {
 ...
 *    Handle an change of the selector
     */
    static int prescaler_table[] = {96, 48, 64, 0};
    public static WriteHandlerPtr MSM5205_playmode_w = new WriteHandlerPtr() {
    ...
    public static void MSM5205_set_volume(int num, int volume) {
        mixer_set_volume(msm5205[num].stream, volume);
    }
}

...
public class MSM5205H {
 ...
 /* default master clock is 384KHz */
    public static int MSM5205_S96_3B = 0;/* prsicaler 1/96(4KHz) , data 3bit */
    public static int MSM5205_S48_3B = 1;/* prsicaler 1/48(8KHz) , data 3bit */
    public static int MSM5205_S64_3B = 2;/* prsicaler 1/64(6KHz) , data 3bit */
    public static int MSM5205_SEX_3B = 3;/* VCLK slave mode      , data 3bit */
    public static int MSM5205_S96_4B = 4;/* prsicaler 1/96(4KHz) , data 4bit */
    public static int MSM5205_S48_4B = 5;/* prsicaler 1/48(8KHz) , data 4bit */
    public static int MSM5205_S64_4B = 6;/* prsicaler 1/64(6KHz) , data 4bit */
    public static int MSM5205_SEX_4B = 7;/* VCLK slave mode      , data 4bit */

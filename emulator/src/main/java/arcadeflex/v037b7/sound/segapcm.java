...
/*TODO*///		SEGAPCMShutdown();
	...
	static int SEGAPCMInit( MachineSound msound, int banksize, int mode, UBytePtr inpcm, int volume )
	{
		...
		buffer_len = (int) (rate / Machine.drv.frames_per_second);
...
/*TODO*///	#endif
	...
	/************************************************/
	public static WriteHandlerPtr SegaPCM_w = new WriteHandlerPtr() {
            @Override
	...
	/************************************************/
	public static ReadHandlerPtr SegaPCM_r = new ReadHandlerPtr() {
            @Override

...
public class dec0
{
	...
	static int TEXTRAM_SIZE	= 0x2000;	/* Size of text layer */
	static int TILERAM_SIZE	= 0x800;	/* Size of background and foreground */
	
	/* Video */
	public static UBytePtr dec0_pf1_data=new UBytePtr(), dec0_pf2_data=new UBytePtr(), dec0_pf3_data=new UBytePtr();
	static UBytePtr dec0_pf1_dirty=new UBytePtr(), dec0_pf3_dirty=new UBytePtr(), dec0_pf2_dirty=new UBytePtr();
	...
	public static UBytePtr dec0_pf1_rowscroll=new UBytePtr(), dec0_pf2_rowscroll=new UBytePtr(), dec0_pf3_rowscroll=new UBytePtr();
	public static UBytePtr dec0_pf1_colscroll=new UBytePtr(), dec0_pf2_colscroll=new UBytePtr(), dec0_pf3_colscroll=new UBytePtr();
	static UBytePtr dec0_pf1_control_0=new UBytePtr(8);
	static UBytePtr dec0_pf1_control_1=new UBytePtr(8);
	static UBytePtr dec0_pf2_control_0=new UBytePtr(8);
	static UBytePtr dec0_pf2_control_1=new UBytePtr(8);
	static UBytePtr dec0_pf3_control_0=new UBytePtr(8);
	static UBytePtr dec0_pf3_control_1=new UBytePtr(8);
	public static UBytePtr dec0_spriteram=new UBytePtr();
	
	static int dec0_pri;
	
	/******************************************************************************/
	
	public static WriteHandlerPtr dec0_update_sprites_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
	...
	public static WriteHandlerPtr dec0_paletteram_rg_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		COMBINE_WORD_MEM(paletteram,offset,data);
		update_24bitcol(offset);
	} };
	
	public static WriteHandlerPtr dec0_paletteram_b_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
	...
	static void dec0_update_palette(int pf23priority)
	{
		...
		palette_used_colors.write(pal_base, PALETTE_COLOR_TRANSPARENT); /* Always set this, for priorities to work */
		for (color = 0;color < 16;color++) colmask[color] = 0;
	...
	static void dec0_pf1_update()
	{
		...
		int[] offsetx=new int[4],offsety=new int[4];
		...
		for (quarter = 0;quarter < 4;quarter++)
		{
			...
			for (offs = 0x800 * quarter; offs < 0x800 * quarter + 0x800;offs += 2)
			{
				...
				if (dec0_pf1_dirty.read(offs) != 0)
				{
					dec0_pf1_dirty.write(offs, 0);
	...
	static void dec0_pf1_draw(osd_bitmap bitmap)
	{
		...
		else if ((dec0_pf1_control_0.READ_WORD(0)&0x4) != 0)
		{
	...
	static void dec0_pf2_draw(osd_bitmap bitmap, int trans)
	{
		...
		if ((dec0_pf2_control_0.READ_WORD(0)&0x8) != 0)
		{
			int[] rscrollx = new int[1024];
	...
	static void dec0_pf3_draw(osd_bitmap bitmap, int trans)
	{
		int offs,lines,height,scrolly,scrollx;
	...
	public static VhUpdatePtr hbarrel_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
	...
	public static VhUpdatePtr baddudes_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
	...
	public static VhUpdatePtr robocop_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
		dec0_update_palette(dec0_pri & 0x01);
		dec0_pf1_update();
	...
	public static VhUpdatePtr birdtry_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
		dec0_update_palette(dec0_pri & 0x01);
	...
	public static VhUpdatePtr hippodrm_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
		dec0_update_palette(dec0_pri & 0x01);
		dec0_pf1_update();
	...
	public static VhUpdatePtr slyspy_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
	...
	public static VhUpdatePtr midres_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
		dec0_update_palette(dec0_pri & 0x01);
		dec0_pf1_update();
	...
	public static WriteHandlerPtr dec0_pf1_control_0_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		COMBINE_WORD_MEM(dec0_pf1_control_0,offset,data);
	} };
	
	public static WriteHandlerPtr dec0_pf1_control_1_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		COMBINE_WORD_MEM(dec0_pf1_control_1,offset,data);
	} };
	
	public static WriteHandlerPtr dec0_pf1_rowscroll_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		COMBINE_WORD_MEM(dec0_pf1_rowscroll,offset,data);
	} };
	
	public static WriteHandlerPtr dec0_pf1_colscroll_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		COMBINE_WORD_MEM(dec0_pf1_colscroll,offset,data);
	} };
	
	public static WriteHandlerPtr dec0_pf1_data_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		...
		if (oldword != newword)
		{
			...
			dec0_pf1_dirty.write(offset, 1);
		}
	} };
	
	public static ReadHandlerPtr dec0_pf1_data_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
		return dec0_pf1_data.READ_WORD(offset);
	} };
	
	public static WriteHandlerPtr dec0_pf2_control_0_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		COMBINE_WORD_MEM(dec0_pf2_control_0,offset,data);
	} };
	
	public static WriteHandlerPtr dec0_pf2_control_1_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		COMBINE_WORD_MEM(dec0_pf2_control_1,offset,data);
	} };
	
	public static WriteHandlerPtr dec0_pf2_rowscroll_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		COMBINE_WORD_MEM(dec0_pf2_rowscroll,offset,data);
	} };
	
	public static WriteHandlerPtr dec0_pf2_colscroll_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		COMBINE_WORD_MEM(dec0_pf2_colscroll,offset,data);
	} };
	
	public static WriteHandlerPtr dec0_pf2_data_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		...
		if (oldword != newword)
		{
			...
			dec0_pf2_dirty.write(offset, 1);
		}
	} };
	
	public static ReadHandlerPtr dec0_pf2_data_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
		return dec0_pf2_data.READ_WORD(offset);
	} };
	
	public static WriteHandlerPtr dec0_pf3_control_0_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		COMBINE_WORD_MEM(dec0_pf3_control_0,offset,data);
	} };
	
	public static WriteHandlerPtr dec0_pf3_control_1_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		COMBINE_WORD_MEM(dec0_pf3_control_1,offset,data);
	} };
	
	public static WriteHandlerPtr dec0_pf3_rowscroll_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		COMBINE_WORD_MEM(dec0_pf3_rowscroll,offset,data);
	} };
	
	public static WriteHandlerPtr dec0_pf3_colscroll_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		COMBINE_WORD_MEM(dec0_pf3_colscroll,offset,data);
	} };
	
	public static ReadHandlerPtr dec0_pf3_colscroll_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
		return dec0_pf3_colscroll.READ_WORD(offset);
	} };
	
	public static WriteHandlerPtr dec0_pf3_data_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		...
		if (oldword != newword)
		{
			...
			dec0_pf3_dirty.write(offset, 1);
		}
	} };
	
	public static ReadHandlerPtr dec0_pf3_data_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
		return dec0_pf3_data.READ_WORD(offset);
	} };
	
	public static WriteHandlerPtr dec0_priority_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
	...
	public static WriteHandlerPtr dec0_pf3_control_8bit_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		...
		if (offset<0x10) dec0_pf3_control_0_w.handler(offset,myword);
		else dec0_pf3_control_1_w.handler(offset-0x10,myword);
	} };
	...
	public static WriteHandlerPtr dec0_pf3_data_8bit_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		if ((offset & 1) != 0) { /* MSB has changed */
			...
			dec0_pf3_dirty.write(offset&0x7fe, 1);
		}
	...
	{
		/* Allocate bitmaps */
		if ((dec0_pf1_bitmap = bitmap_alloc(512,512)) == null) {
			dec0_vh_stop.handler();
			return 1;
		}
		dec0_pf1_current_shape = 1;
	
		if ((dec0_pf2_bitmap = bitmap_alloc(512,512)) == null) {
			dec0_vh_stop.handler();
			return 1;
		}
		dec0_pf2_current_shape = 1;
	
		if ((dec0_pf3_bitmap = bitmap_alloc(512,512)) == null) {
			dec0_vh_stop.handler();
			return 1;
		}
		dec0_pf3_current_shape = 1;
	
		if ((dec0_tf2_bitmap = bitmap_alloc(512,512)) == null) {
			dec0_vh_stop.handler();
			return 1;
		}
	
		if ((dec0_tf3_bitmap = bitmap_alloc(512,512)) == null) {
			dec0_vh_stop.handler();
			return 1;
		}
	
		dec0_pf1_dirty = new UBytePtr(TEXTRAM_SIZE);
		dec0_pf3_dirty = new UBytePtr(TILERAM_SIZE);
		dec0_pf2_dirty = new UBytePtr(TILERAM_SIZE);

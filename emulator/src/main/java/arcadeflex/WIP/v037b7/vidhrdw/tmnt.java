...
public class tmnt
{
	...
	***************************************************************************/
	...
	{
		tile_info.u32_flags = (color[0] & 0x04)!=0 ? TILE_FLIPX : 0;
		if (layer == 0)
		{
	...
	***************************************************************************/
	...
	static K051960_callbackProcPtr mia_sprite_callback = new K051960_callbackProcPtr() {
            @Override
	...
	static K051960_callbackProcPtr tmnt_sprite_callback = new K051960_callbackProcPtr() {
            @Override
            public void handler(int[] code, int[] color, int[] priority, int[] shadow) {
	...
	public static K051960_callbackProcPtr punkshot_sprite_callback = new K051960_callbackProcPtr() { public void handler(int[] code,int[] color,int[] priority_mask, int[] shadow) 
	{
	...
	public static K051960_callbackProcPtr thndrx2_sprite_callback = new K051960_callbackProcPtr() { public void handler(int[] code,int[] color,int[] priority_mask, int[] shadow) 
	{
		int pri = 0x20 | ((color[0] & 0x60) >> 2);
		if (pri <= layerpri[2])
                    priority_mask[0] = 0;
	...
	***************************************************************************/
	...
	static K053245_callbackProcPtr lgtnfght_sprite_callback = new K053245_callbackProcPtr() {
            @Override
	...
	static K053245_callbackProcPtr detatwin_sprite_callback = new K053245_callbackProcPtr() {
            @Override
            public void handler(int[] code, int[] color, int[] priority_mask) {
/*TODO*///	#if 0

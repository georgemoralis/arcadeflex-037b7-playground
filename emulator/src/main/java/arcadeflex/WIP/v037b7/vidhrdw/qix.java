...
public class qix {
     ...
     * bit 7 -- Red -- Red -- Green -- Green -- Blue -- Blue -- Intensity bit 0
     * -- Intensity
     **************************************************************************
     */
    public static WriteHandlerPtr update_pen = new WriteHandlerPtr() {
        public void handler(int pen, int val) {
 ...
 /* in the same screen are barely visible, as the manual requires. */
    ...
    public static WriteHandlerPtr qix_videoram_w = new WriteHandlerPtr() {
    ...
    public static WriteHandlerPtr qix_addresslatch_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            int x, y;
     ...
     */
    public static WriteHandlerPtr qix_paletteram_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
    ...
    public static WriteHandlerPtr qix_palettebank_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {

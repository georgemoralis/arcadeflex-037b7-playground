...
public class rampart
{
	...
	public static WriteHandlerPtr rampart_playfieldram_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
	...
	public static void rampart_scanline_update(int scanline)
	{
		/* update the MOs from the SLIP table */
		atarigen_mo_update_slip_512(new UBytePtr(atarigen_spriteram), 0, scanline, new UBytePtr(atarigen_spriteram, 0x3f40));
	}

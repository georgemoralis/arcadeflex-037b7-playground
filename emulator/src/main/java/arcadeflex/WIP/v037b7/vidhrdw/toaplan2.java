...
import static arcadeflex.WIP.v037b7.drivers.toaplan2.toaplan2_sub_cpu;
...
public class toaplan2
{
	...
	public static final int TOAPLAN2_TEXT_VRAM_SIZE	= 0x4000;	/* Text Layer RAM size (in bytes) */
	...
	static UBytePtr[] spriteram_now = new UBytePtr[2];	 /* Sprites to draw this frame */
	static UBytePtr[] spriteram_next = new UBytePtr[2]; /* Sprites to draw next frame */
	static UBytePtr[] spriteram_new = new UBytePtr[2];	 /* Sprites to add to next frame */
...
/*TODO*///	static int display_bg[2]  = { 1, 1 };
/*TODO*///	static int display_fg[2]  = { 1, 1 };
/*TODO*///	static int display_top[2] = { 1, 1 };
/*TODO*///	static int displog = 0;
/*TODO*///	#endif
	...
	static struct_tilemap[] top_tilemap=new struct_tilemap[2], fg_tilemap=new struct_tilemap[2], bg_tilemap=new struct_tilemap[2];
	
	/* Added by Yochizo 2000/08/19 */
	public static UBytePtr textvideoram = new UBytePtr();			 /* Video ram for extra-text-layer */
	static struct_tilemap text_tilemap;	 /* Tilemap for extra-text-layer */
	...
	***************************************************************************/
	...
	public static GetTileInfoPtr get_top0_tile_info = new GetTileInfoPtr() { public void handler(int tile_index) 
	{
		...
		attrib = source.read(2*tile_index);
		tile_number = source.read(2*tile_index+1);
		color = attrib & 0x7f;
		SET_TILE_INFO(0,tile_number,color);
		tile_info.u32_priority = (attrib & 0x0f00) >> 8;
	} };
	...
	{
		int color, tile_number, attrib;
		UShortPtr source = new UShortPtr(textvideoram);
	
		attrib = source.read(tile_index);
	...
	***************************************************************************/
	...
	/* Added by Yochizo 2000/08/19 */
	public static VhStartPtr raizing_0_vh_start = new VhStartPtr() { public int handler() 
	{
		if (toaplan2_vh_start(0) != 0)
			return 1;
		...
		if (text_tilemap==null)
			return 1;
		text_tilemap.transparent_pen = 0;
		return 0;
	} };
	public static VhStartPtr raizing_1_vh_start = new VhStartPtr() { public int handler() 
	{
		int error_level = 0;
		error_level |= toaplan2_vh_start(0);
		error_level |= toaplan2_vh_start(1);
	...
	***************************************************************************/
	...
	/* Added by Yochizo 2000/08/19 */
	public static ReadHandlerPtr raizing_textram_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
		return textvideoram.READ_WORD(offset);
	} };
	public static WriteHandlerPtr raizing_textram_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		int oldword;
		offset &= TOAPLAN2_TEXT_VRAM_SIZE - 1;
		oldword = textvideoram.READ_WORD(offset);
		if (oldword != data){
			textvideoram.WRITE_WORD(offset, data);
	...
	static void toaplan2_videoram_w(int offset, int data, int controller)
	{
		int oldword = 0;
		int videoram_offset;
		int dirty_cell;
	...
	static void toaplan2_scroll_reg_select_w(int offset, int data, int controller)
	{
...
/*TODO*///	#ifdef MAME_DEBUG
/*TODO*///	
/*TODO*///		if (spriteram_now[1] && spriteram_next[1] && spriteram_new[1]
/*TODO*///			&& top_tilemap[1] && fg_tilemap[1] && bg_tilemap[1])
/*TODO*///		{
/*TODO*///			vid_controllers = 2;
/*TODO*///		}
/*TODO*///	
/*TODO*///		if ( keyboard_pressed(KEYCODE_L) )
/*TODO*///		{
/*TODO*///			while (keyboard_pressed(KEYCODE_L)) ;
/*TODO*///			display_sp[0] += 1;
/*TODO*///			display_sp[0] &= 1;
/*TODO*///		}
/*TODO*///		if ( keyboard_pressed(KEYCODE_K) )
/*TODO*///		{
/*TODO*///			while (keyboard_pressed(KEYCODE_K)) ;
/*TODO*///			display_top[0] += 1;
/*TODO*///			display_top[0] &= 1;
/*TODO*///			tilemap_set_enable(top_tilemap[0], display_top[0]);
/*TODO*///		}
/*TODO*///		if ( keyboard_pressed(KEYCODE_J) )
/*TODO*///		{
/*TODO*///			while (keyboard_pressed(KEYCODE_J)) ;
/*TODO*///			display_fg[0] += 1;
/*TODO*///			display_fg[0] &= 1;
/*TODO*///			tilemap_set_enable(fg_tilemap[0], display_fg[0]);
/*TODO*///		}
/*TODO*///		if ( keyboard_pressed(KEYCODE_H) )
/*TODO*///		{
/*TODO*///			while (keyboard_pressed(KEYCODE_H)) ;
/*TODO*///			display_bg[0] += 1;
/*TODO*///			display_bg[0] &= 1;
/*TODO*///			tilemap_set_enable(bg_tilemap[0], display_bg[0]);
/*TODO*///		}
/*TODO*///		if (vid_controllers == 2)
/*TODO*///		{
/*TODO*///			if ( keyboard_pressed(KEYCODE_O) )
/*TODO*///			{
/*TODO*///				while (keyboard_pressed(KEYCODE_O)) ;
/*TODO*///				display_sp[1] += 1;
/*TODO*///				display_sp[1] &= 1;
/*TODO*///			}
/*TODO*///			if ( keyboard_pressed(KEYCODE_I) )
/*TODO*///			{
/*TODO*///				while (keyboard_pressed(KEYCODE_I)) ;
/*TODO*///				display_top[1] += 1;
/*TODO*///				display_top[1] &= 1;
/*TODO*///				tilemap_set_enable(top_tilemap[1], display_top[1]);
/*TODO*///			}
/*TODO*///			if ( keyboard_pressed(KEYCODE_U) )
/*TODO*///			{
/*TODO*///				while (keyboard_pressed(KEYCODE_U)) ;
/*TODO*///				display_fg[1] += 1;
/*TODO*///				display_fg[1] &= 1;
/*TODO*///				tilemap_set_enable(fg_tilemap[1], display_fg[1]);
/*TODO*///			}
/*TODO*///			if ( keyboard_pressed(KEYCODE_Y) )
/*TODO*///			{
/*TODO*///				while (keyboard_pressed(KEYCODE_Y)) ;
/*TODO*///				display_bg[1] += 1;
/*TODO*///				display_bg[1] &= 1;
/*TODO*///				tilemap_set_enable(bg_tilemap[1], display_bg[1]);
/*TODO*///			}
/*TODO*///		}
/*TODO*///	#endif
	}
...
/*TODO*///	#ifdef MAME_DEBUG
/*TODO*///	void toaplan2_log_vram(void)
/*TODO*///	{
/*TODO*///		int sprite_voffs, tile_voffs, vid_controllers = 1;
/*TODO*///	
/*TODO*///		if (spriteram_now[1] && spriteram_next[1] && spriteram_new[1]
/*TODO*///			&& top_tilemap[1] && fg_tilemap[1] && bg_tilemap[1])
/*TODO*///		{
...
/*TODO*///		{
/*TODO*///			UINT16 *source_now0  = (UINT16 *)(spriteram_now[0]);
/*TODO*///			UINT16 *source_next0 = (UINT16 *)(spriteram_next[0]);
/*TODO*///			UINT16 *source_new0  = (UINT16 *)(spriteram_new[0]);
/*TODO*///			UINT16 *source_now1  = (UINT16 *)(spriteram_now[0]);
/*TODO*///			UINT16 *source_next1 = (UINT16 *)(spriteram_next[0]);
/*TODO*///			UINT16 *source_new1  = (UINT16 *)(spriteram_new[0]);
/*TODO*///	
/*TODO*///			int schar[3],sattr[3],sxpos[3],sypos[3];
/*TODO*///	
/*TODO*///			if (vid_controllers == 2)
/*TODO*///			{
/*TODO*///				source_now1  = (UINT16 *)(spriteram_now[1]);
/*TODO*///				source_next1 = (UINT16 *)(spriteram_next[1]);
/*TODO*///				source_new1  = (UINT16 *)(spriteram_new[1]);
/*TODO*///			}
/*TODO*///	
/*TODO*///			while (keyboard_pressed(KEYCODE_M)) ;
/*TODO*///			logerror("Scrolls   BG-X  BG-Y   FG-X  FG-Y   TOP-X  TOP-Y   Sprite-X  Sprite-Y\n");
/*TODO*///			logerror("---0-.   %04x  %04x   %04x  %04x    %04x  %04x       %04x    %04x\n", bg_scrollx[0],bg_scrolly[0],fg_scrollx[0],fg_scrolly[0],top_scrollx[0],top_scrolly[0],sprite_scrollx[0], sprite_scrolly[0]);
/*TODO*///			if (vid_controllers == 2)
/*TODO*///			{
/*TODO*///				logerror("---1-.   %04x  %04x   %04x  %04x    %04x  %04x       %04x    %04x\n", bg_scrollx[1],bg_scrolly[1],fg_scrollx[1],fg_scrolly[1],top_scrollx[1],top_scrolly[1],sprite_scrollx[1], sprite_scrolly[1]);
/*TODO*///			}
/*TODO*///			for ( sprite_voffs = 0; sprite_voffs < (TOAPLAN2_SPRITERAM_SIZE/2); sprite_voffs+=4 )
/*TODO*///			{
/*TODO*///				sattr[0] = source_now0[sprite_voffs];
/*TODO*///				schar[0] = source_now0[sprite_voffs + 1];
/*TODO*///				sxpos[0] = source_now0[sprite_voffs + 2];
/*TODO*///				sypos[0] = source_now0[sprite_voffs + 3];
/*TODO*///				sattr[1] = source_next0[sprite_voffs];
/*TODO*///				schar[1] = source_next0[sprite_voffs + 1];
/*TODO*///				sxpos[1] = source_next0[sprite_voffs + 2];
/*TODO*///				sypos[1] = source_next0[sprite_voffs + 3];
/*TODO*///				sattr[2] = source_new0[sprite_voffs];
/*TODO*///				schar[2] = source_new0[sprite_voffs + 1];
/*TODO*///				sxpos[2] = source_new0[sprite_voffs + 2];
/*TODO*///				sypos[2] = source_new0[sprite_voffs + 3];
/*TODO*///				logerror("SPoffs     Sprt Attr Xpos Ypos     Sprt Attr Xpos Ypos     Sprt Attr Xpos Ypos\n");
/*TODO*///				logerror("0:%03x now:%04x %04x %04x %04x nxt:%04x %04x %04x %04x new:%04x %04x %04x %04x\n",sprite_voffs,
/*TODO*///							 						schar[0], sattr[0],sxpos[0], sypos[0],
/*TODO*///							 						schar[1], sattr[1],sxpos[1], sypos[1],
/*TODO*///							 						schar[2], sattr[2],sxpos[2], sypos[2]);
/*TODO*///				if (vid_controllers == 2)
/*TODO*///				{
/*TODO*///					sattr[0] = source_now1[sprite_voffs];
/*TODO*///					schar[0] = source_now1[sprite_voffs + 1];
/*TODO*///					sxpos[0] = source_now1[sprite_voffs + 2];
/*TODO*///					sypos[0] = source_now1[sprite_voffs + 3];
/*TODO*///					sattr[1] = source_next1[sprite_voffs];
/*TODO*///					schar[1] = source_next1[sprite_voffs + 1];
/*TODO*///					sxpos[1] = source_next1[sprite_voffs + 2];
/*TODO*///					sypos[1] = source_next1[sprite_voffs + 3];
/*TODO*///					sattr[2] = source_new1[sprite_voffs];
/*TODO*///					schar[2] = source_new1[sprite_voffs + 1];
/*TODO*///					sxpos[2] = source_new1[sprite_voffs + 2];
/*TODO*///					sypos[2] = source_new1[sprite_voffs + 3];
/*TODO*///					logerror("1:%03x now:%04x %04x %04x %04x nxt:%04x %04x %04x %04x new:%04x %04x %04x %04x\n",sprite_voffs,
/*TODO*///								 					schar[0], sattr[0],sxpos[0], sypos[0],
/*TODO*///								 					schar[1], sattr[1],sxpos[1], sypos[1],
/*TODO*///								 					schar[2], sattr[2],sxpos[2], sypos[2]);
/*TODO*///				}
/*TODO*///			}
/*TODO*///		}
/*TODO*///		if ( keyboard_pressed(KEYCODE_N) )
/*TODO*///		{
/*TODO*///			int tchar[2], tattr[2];
/*TODO*///			while (keyboard_pressed(KEYCODE_N)) ;
/*TODO*///			logerror("Scrolls   BG-X  BG-Y   FG-X  FG-Y   TOP-X  TOP-Y   Sprite-X  Sprite-Y\n");
/*TODO*///			logerror("---0-.   %04x  %04x   %04x  %04x    %04x  %04x       %04x    %04x\n", bg_scrollx[0],bg_scrolly[0],fg_scrollx[0],fg_scrolly[0],top_scrollx[0],top_scrolly[0],sprite_scrollx[0], sprite_scrolly[0]);
/*TODO*///			if (vid_controllers == 2)
/*TODO*///			{
/*TODO*///				logerror("---1-.   %04x  %04x   %04x  %04x    %04x  %04x       %04x    %04x\n", bg_scrollx[1],bg_scrolly[1],fg_scrollx[1],fg_scrolly[1],top_scrollx[1],top_scrolly[1],sprite_scrollx[1], sprite_scrolly[1]);
/*TODO*///			}
/*TODO*///			for ( tile_voffs = 0; tile_voffs < TOAPLAN2_TOP_VRAM_SIZE; tile_voffs+=4 )
/*TODO*///			{
/*TODO*///				tchar[0] = READ_WORD (&topvideoram[0][tile_voffs + 2]);
/*TODO*///				tattr[0] = READ_WORD (&topvideoram[0][tile_voffs]);
/*TODO*///				if (vid_controllers == 2)
/*TODO*///				{
/*TODO*///					tchar[1] = READ_WORD (&topvideoram[1][tile_voffs + 2]);
/*TODO*///					tattr[1] = READ_WORD (&topvideoram[1][tile_voffs]);
/*TODO*///					logerror("TXoffs:%04x   Tile0:%04x  Attr0:%04x    Tile1:%04x  Attr1:%04x\n", tile_voffs/2, tchar[0], tattr[0], tchar[1], tattr[1]);
/*TODO*///				}
/*TODO*///				else
/*TODO*///				{
/*TODO*///					logerror("TXoffs:%04x   Tile0:%04x  Attr0:%04x\n", tile_voffs/2, tchar[0], tattr[0]);
/*TODO*///				}
/*TODO*///			}
/*TODO*///		}
/*TODO*///		if ( keyboard_pressed(KEYCODE_B) )
/*TODO*///		{
/*TODO*///			int tchar[2], tattr[2];
/*TODO*///			while (keyboard_pressed(KEYCODE_B)) ;
/*TODO*///			logerror("Scrolls   BG-X  BG-Y   FG-X  FG-Y   TOP-X  TOP-Y   Sprite-X  Sprite-Y\n");
/*TODO*///			logerror("---0-.   %04x  %04x   %04x  %04x    %04x  %04x       %04x    %04x\n", bg_scrollx[0],bg_scrolly[0],fg_scrollx[0],fg_scrolly[0],top_scrollx[0],top_scrolly[0],sprite_scrollx[0], sprite_scrolly[0]);
/*TODO*///			if (vid_controllers == 2)
/*TODO*///			{
/*TODO*///				logerror("---1-.   %04x  %04x   %04x  %04x    %04x  %04x       %04x    %04x\n", bg_scrollx[1],bg_scrolly[1],fg_scrollx[1],fg_scrolly[1],top_scrollx[1],top_scrolly[1],sprite_scrollx[1], sprite_scrolly[1]);
/*TODO*///			}
/*TODO*///			for ( tile_voffs = 0; tile_voffs < TOAPLAN2_FG_VRAM_SIZE; tile_voffs+=4 )
/*TODO*///			{
/*TODO*///				tchar[0] = READ_WORD (&fgvideoram[0][tile_voffs + 2]);
/*TODO*///				tattr[0] = READ_WORD (&fgvideoram[0][tile_voffs]);
/*TODO*///			if (vid_controllers == 2)
/*TODO*///				{
/*TODO*///					tchar[1] = READ_WORD (&fgvideoram[1][tile_voffs + 2]);
/*TODO*///					tattr[1] = READ_WORD (&fgvideoram[1][tile_voffs]);
/*TODO*///					logerror("FGoffs:%04x   Tile0:%04x  Attr0:%04x    Tile1:%04x  Attr1:%04x\n", tile_voffs/2, tchar[0], tattr[0], tchar[1], tattr[1]);
/*TODO*///				}
/*TODO*///				else
/*TODO*///				{
/*TODO*///					logerror("FGoffs:%04x   Tile0:%04x  Attr0:%04x\n", tile_voffs/2, tchar[0], tattr[0]);
/*TODO*///				}
/*TODO*///			}
/*TODO*///		}
...
/*TODO*///		{
/*TODO*///			int tchar[2], tattr[2];
/*TODO*///			while (keyboard_pressed(KEYCODE_V)) ;
/*TODO*///			logerror("Scrolls   BG-X  BG-Y   FG-X  FG-Y   TOP-X  TOP-Y   Sprite-X  Sprite-Y\n");
/*TODO*///			logerror("---0-.   %04x  %04x   %04x  %04x    %04x  %04x       %04x    %04x\n", bg_scrollx[0],bg_scrolly[0],fg_scrollx[0],fg_scrolly[0],top_scrollx[0],top_scrolly[0],sprite_scrollx[0], sprite_scrolly[0]);
/*TODO*///			if (vid_controllers == 2)
/*TODO*///			{
/*TODO*///				logerror("---1-.   %04x  %04x   %04x  %04x    %04x  %04x       %04x    %04x\n", bg_scrollx[1],bg_scrolly[1],fg_scrollx[1],fg_scrolly[1],top_scrollx[1],top_scrolly[1],sprite_scrollx[1], sprite_scrolly[1]);
/*TODO*///			}
/*TODO*///			for ( tile_voffs = 0; tile_voffs < TOAPLAN2_BG_VRAM_SIZE; tile_voffs+=4 )
/*TODO*///			{
/*TODO*///				tchar[0] = READ_WORD (&bgvideoram[0][tile_voffs + 2]);
/*TODO*///				tattr[0] = READ_WORD (&bgvideoram[0][tile_voffs]);
/*TODO*///				if (vid_controllers == 2)
/*TODO*///				{
/*TODO*///					tchar[1] = READ_WORD (&bgvideoram[1][tile_voffs + 2]);
/*TODO*///					tattr[1] = READ_WORD (&bgvideoram[1][tile_voffs]);
/*TODO*///					logerror("BGoffs:%04x   Tile0:%04x  Attr0:%04x    Tile1:%04x  Attr1:%04x\n", tile_voffs/2, tchar[0], tattr[0], tchar[1], tattr[1]);
/*TODO*///				}
/*TODO*///				else
/*TODO*///				{
/*TODO*///					logerror("BGoffs:%04x   Tile0:%04x  Attr0:%04x\n", tile_voffs/2, tchar[0], tattr[0]);
/*TODO*///				}
/*TODO*///			}
/*TODO*///		}
/*TODO*///	
...
/*TODO*///		{
/*TODO*///			while (keyboard_pressed(KEYCODE_C)) ;
/*TODO*///			logerror("Mark here\n");
/*TODO*///		}
/*TODO*///		if ( keyboard_pressed(KEYCODE_G) )
/*TODO*///		{
/*TODO*///			while (keyboard_pressed(KEYCODE_G)) ;
/*TODO*///			displog += 1;
/*TODO*///			displog &= 1;
/*TODO*///		}
/*TODO*///		if (displog != 0)
...
/*TODO*///	#endif
	...
	public static WriteHandlerPtr pipibibi_scroll_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
	...
	public static ReadHandlerPtr pipibibi_videoram_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
		int controller = 0;		/* only 1 video controller */
	...
	public static WriteHandlerPtr pipibibi_videoram_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		int controller = 0;		/* only 1 video controller */
	...
	public static ReadHandlerPtr pipibibi_spriteram_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
		int controller = 0;		/* only 1 video controller */
	...
	public static WriteHandlerPtr pipibibi_spriteram_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		int controller = 0;		/* only 1 video controller */
	...
	***************************************************************************/
	...
	static void draw_sprites( osd_bitmap bitmap, int controller, int priority_to_display )
	{
		...
		for (offs = 0; offs < (TOAPLAN2_SPRITERAM_SIZE/2); offs += 4)
		{
			...
			{
				sprite = ((attrib & 3) << 16) | source.read(offs + 1) ;	/* 18 bit */
				color = (attrib >> 2) & 0x3f;
...
/*TODO*///	#endif
	...
	/* Added by Yochizo 2000/08/19 */
	public static VhUpdatePtr raizing_0_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
		toaplan2_0_vh_screenrefresh.handler(bitmap, full_refresh);
		tilemap_draw(bitmap,text_tilemap,0);
	} };
	public static VhUpdatePtr raizing_1_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
		toaplan2_1_vh_screenrefresh.handler(bitmap, full_refresh);
		tilemap_draw(bitmap,text_tilemap,0);
	} };
	
	
	public static VhEofCallbackPtr toaplan2_0_eof_callback = new VhEofCallbackPtr() { public void handler() 
	{
	...
	public static VhEofCallbackPtr toaplan2_1_eof_callback = new VhEofCallbackPtr() { public void handler() 
	{
		/** Shift sprite RAM buffers  ***  Used to fix sprite lag **/
		memcpy(spriteram_now[0],spriteram_next[0],TOAPLAN2_SPRITERAM_SIZE);
		memcpy(spriteram_next[0],spriteram_new[0],TOAPLAN2_SPRITERAM_SIZE);

...
public class battlera
{
	...
	public static UBytePtr HuC6270_vram=new UBytePtr(), tile_dirty=new UBytePtr(), sprite_dirty=new UBytePtr(), vram_dirty=new UBytePtr();
	...
	public static VhUpdatePtr battlera_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
		/* Nothing */
	} };
	
	static void partial_refresh(osd_bitmap bitmap,int current_line)
	{
	...
	static void battlera_vh_raster_partial_refresh(osd_bitmap bitmap,int start_line,int end_line)
	{
		rectangle clip = new rectangle();

...
/*TODO*///	#endif
	...
	static atarigen_pf_callback pf_color_callback = new atarigen_pf_callback() {
            ...
            public void handler(rectangle clip, rectangle tiles, atarigen_pf_state state, java.lang.Object param) {
                ...
                //System.out.println("Estoy en pf_color_callback");
                //System.out.println(tiles.min_x);
                //System.out.println(tiles.max_x);
                //System.out.println(tiles.min_y);
		...
		for (x = tiles.min_x; x != tiles.max_x; x = (x + 1) & 63){
			for (y = tiles.min_y; y != tiles.max_y; y = (y + 1) & 63)
			{
                ...
                param = colormap;
                //System.out.println("FIN pf_color_callback");
            }
        };
...
/*TODO*///	#endif
	...
	static atarigen_mo_callback mo_color_callback = new atarigen_mo_callback() {
		...
		for (i = 0; i < tiles; i++)
			temp |= usage[code++];
		colormap[color] = (colormap[color] | temp);
            }
        };

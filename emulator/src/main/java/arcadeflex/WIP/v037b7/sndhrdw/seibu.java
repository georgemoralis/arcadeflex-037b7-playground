...
public class seibu {
    ...
    public static WriteHandlerPtr seibu_rst10_ack_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            /* Unused for now */
        }
    };

    public static WriteHandlerPtr seibu_rst18_ack_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
     ...
     * ************************************************************************
     */
    public static ReadHandlerPtr sound_cpu_spin_r = new ReadHandlerPtr() {
        public int handler(int offset) {
            UBytePtr RAM;

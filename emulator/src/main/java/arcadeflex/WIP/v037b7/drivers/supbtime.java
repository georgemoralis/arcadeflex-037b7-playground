...
import static arcadeflex.WIP.v037b7.vidhrdw.supbtime.*;
...
{
	static UBytePtr supbtime_ram = new UBytePtr();
	
	/******************************************************************************/
	
	public static ReadHandlerPtr supbtime_controls_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
	 	switch (offset)
		{
	...
	static MemoryReadAddress supbtime_readmem[] =
	{
		...
		new MemoryReadAddress( 0x180000, 0x18000f, supbtime_controls_r ),
	...
	{
		if (cpu_get_pc()==0x7e2 && supbtime_ram.READ_WORD(0)==0) {cpu_spinuntil_int(); return 1;}
	
		return supbtime_ram.READ_WORD(0);
	} };
	...
	public static GameDriver driver_supbtime	   = new GameDriver("1990"	,"supbtime"	,"supbtime.java"	,rom_supbtime,null	,machine_driver_supbtime	,input_ports_supbtime	,init_supbtime	,ROT0	,	"Data East Corporation", "Super Burger Time (World)" );
	public static GameDriver driver_supbtimj	   = new GameDriver("1990"	,"supbtimj"	,"supbtime.java"	,rom_supbtimj,driver_supbtime	,machine_driver_supbtime	,input_ports_supbtime	,init_supbtime	,ROT0	,	"Data East Corporation", "Super Burger Time (Japan)" );
}

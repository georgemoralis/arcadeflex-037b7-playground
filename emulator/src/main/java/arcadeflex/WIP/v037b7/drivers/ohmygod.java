...
import static arcadeflex.WIP.v037b7.vidhrdw.ohmygod.*;
...
public class ohmygod
{
	...
	public static InitMachinePtr ohmygod_init_machine = new InitMachinePtr() { public void handler() 
	{
		...
		sndbank = 0;
		memcpy(new UBytePtr(rom, 0x20000),new UBytePtr(rom, 0x40000 + 0x20000 * sndbank),0x20000);
	} };

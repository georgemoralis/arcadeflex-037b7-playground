...
import static arcadeflex.WIP.v037b7.vidhrdw.magmax.*;
	...
	*/
	...
	public static WriteHandlerPtr magmax_write = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		switch (offset)
		{
			...
			case 0x02: /* SCROLL X */
				COMBINE_WORD_MEM(magmax_scroll_x, 0, data);
				break;
	
			case 0x04: /* SCROLL Y */
				COMBINE_WORD_MEM(magmax_scroll_y, 0, data);
				break;
	...
	static InterruptPtr magmax_interrupt = new InterruptPtr() { public int handler() 
	{

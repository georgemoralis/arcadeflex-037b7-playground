...
import static arcadeflex.WIP.v037b7.vidhrdw.cischeat.*;
...
public class cischeat
{
	...
	static UBytePtr rom_1=new UBytePtr(), rom_2=new UBytePtr(), rom_3=new UBytePtr();
	static UBytePtr sharedram1=new UBytePtr(), sharedram2=new UBytePtr();
	...
	*/
	...
	public static ReadHandlerPtr sharedram1_r  = new ReadHandlerPtr() { public int handler(int offset)			{return sharedram1.READ_WORD(offset);	} };
	public static ReadHandlerPtr sharedram2_r  = new ReadHandlerPtr() { public int handler(int offset)			{return sharedram2.READ_WORD(offset);	} };
	
	public static WriteHandlerPtr sharedram1_w = new WriteHandlerPtr() {public void handler(int offset, int data) {sharedram1.WRITE_WORD(offset,data);	} };
	public static WriteHandlerPtr sharedram2_w = new WriteHandlerPtr() {public void handler(int offset, int data) {sharedram2.WRITE_WORD(offset,data);	} };
	
	public static ReadHandlerPtr rom_1_r  = new ReadHandlerPtr() { public int handler(int offset) {return rom_1.READ_WORD(offset);} };
	public static ReadHandlerPtr rom_2_r  = new ReadHandlerPtr() { public int handler(int offset) {return rom_2.READ_WORD(offset);} };
	public static ReadHandlerPtr rom_3_r  = new ReadHandlerPtr() { public int handler(int offset) {return rom_3.READ_WORD(offset);} };
	...
	**************************************************************************/
	...
	static MemoryReadAddress cischeat_readmem[] =
	{
		new MemoryReadAddress( 0x000000, 0x07ffff, MRA_ROM			),	// ROM
		new MemoryReadAddress( 0x100000, 0x17ffff, rom_1_r			),	// ROM
		new MemoryReadAddress( 0x0f0000, 0x0fffff, MRA_BANK1			),	// RAM
		new MemoryReadAddress( 0x080000, 0x087fff, cischeat_vregs_r	),	// Vregs
		new MemoryReadAddress( 0x088000, 0x088fff, MRA_BANK2			),	// Linking with other units
	...
	/* 	Only the first 0x800 bytes are tested but:
		...
		new MemoryReadAddress( 0x090000, 0x097fff, sharedram2_r		),	// Sharedram with sub CPU#2
		new MemoryReadAddress( 0x098000, 0x09ffff, sharedram1_r		),	// Sharedram with sub CPU#1
	
		new MemoryReadAddress( 0x0a0000, 0x0a7fff, megasys1_scrollram_0_r	),	// Scroll ram 0
		new MemoryReadAddress( 0x0a8000, 0x0affff, megasys1_scrollram_1_r	),	// Scroll ram 1
		new MemoryReadAddress( 0x0b0000, 0x0b7fff, megasys1_scrollram_2_r	),	// Scroll ram 2
	
		new MemoryReadAddress( 0x0b8000, 0x0bffff, cischeat_palette_r	),	// Palettes
	
		new MemoryReadAddress( -1 )
	};
	
	static MemoryWriteAddress cischeat_writemem[] =
	{
		new MemoryWriteAddress( 0x000000, 0x07ffff, MWA_ROM							),	// ROM
		new MemoryWriteAddress( 0x100000, 0x17ffff, MWA_ROM							),	// ROM
		new MemoryWriteAddress( 0x0f0000, 0x0fffff, MWA_BANK1, megasys1_ram			),	// RAM
		new MemoryWriteAddress( 0x080000, 0x087fff, cischeat_vregs_w, megasys1_vregs	),	// Vregs
		new MemoryWriteAddress( 0x088000, 0x088fff, MWA_BANK2							),	// Linking with other units
	
		new MemoryWriteAddress( 0x090000, 0x097fff, sharedram2_w, sharedram2			),	// Sharedram with sub CPU#2
		new MemoryWriteAddress( 0x098000, 0x09ffff, sharedram1_w, sharedram1			),	// Sharedram with sub CPU#1
		...
		new MemoryWriteAddress( 0x0a0000, 0x0a7fff, megasys1_scrollram_0_w, megasys1_scrollram_0	),	// Scroll ram 0
		new MemoryWriteAddress( 0x0a8000, 0x0affff, megasys1_scrollram_1_w, megasys1_scrollram_1	),	// Scroll ram 1
		new MemoryWriteAddress( 0x0b0000, 0x0b7fff, megasys1_scrollram_2_w, megasys1_scrollram_2	),	// Scroll ram 2
	
		new MemoryWriteAddress( 0x0b8000, 0x0bffff, cischeat_palette_w, paletteram	),	// Palettes
	...
	**************************************************************************/
	...
	static MemoryReadAddress f1gpstar_readmem[] =
	{
		new MemoryReadAddress( 0x000000, 0x07ffff, MRA_ROM			),	// ROM
		new MemoryReadAddress( 0x100000, 0x17ffff, rom_1_r			),	// ROM
		new MemoryReadAddress( 0x0f0000, 0x0fffff, MRA_BANK1			),	// RAM
		new MemoryReadAddress( 0x080000, 0x087fff, f1gpstar_vregs_r	),	// Vregs
		new MemoryReadAddress( 0x088000, 0x088fff, MRA_BANK2			),	// Linking with other units
		...
		new MemoryReadAddress( 0x0b8000, 0x0bffff, f1gpstar_palette_r	),	// Palettes
		new MemoryReadAddress( -1 )
	};
	
	static MemoryWriteAddress f1gpstar_writemem[] =
	{
		new MemoryWriteAddress( 0x000000, 0x07ffff, MWA_ROM							),
		new MemoryWriteAddress( 0x100000, 0x17ffff, MWA_ROM							),
		new MemoryWriteAddress( 0x0f0000, 0x0fffff, MWA_BANK1, megasys1_ram			),	// RAM
		new MemoryWriteAddress( 0x080000, 0x087fff, f1gpstar_vregs_w, megasys1_vregs	),	// Vregs
		new MemoryWriteAddress( 0x088000, 0x088fff, MWA_BANK2							),	// Linking with other units
		...
		new MemoryWriteAddress( 0x0b8000, 0x0bffff, f1gpstar_palette_w, paletteram	),	// Palettes
	...
	**************************************************************************/
	...
	static MemoryReadAddress cischeat_readmem2[] =
	{
		new MemoryReadAddress( 0x000000, 0x03ffff, MRA_ROM		),	// ROM
		new MemoryReadAddress( 0x200000, 0x23ffff, rom_2_r		),	// ROM
		new MemoryReadAddress( 0x0c0000, 0x0c3fff, MRA_BANK3		),	// RAM
		new MemoryReadAddress( 0x040000, 0x047fff, sharedram1_r	),	// Shared RAM (with Main CPU)
		new MemoryReadAddress( 0x080000, 0x0807ff, MRA_BANK4		),	// Road RAM
		new MemoryReadAddress( -1 )
	};
	static MemoryWriteAddress cischeat_writemem2[] =
	{
	...
	**************************************************************************/
	...
	static MemoryReadAddress f1gpstar_readmem2[] =
	{
		new MemoryReadAddress( 0x000000, 0x03ffff, MRA_ROM		),	// ROM
		new MemoryReadAddress( 0x180000, 0x183fff, MRA_BANK3		),	// RAM
		new MemoryReadAddress( 0x080000, 0x0807ff, sharedram1_r	),	// Shared RAM (with Main CPU)
		new MemoryReadAddress( 0x100000, 0x1007ff, MRA_BANK4		),	// Road RAM
		new MemoryReadAddress( -1 )
	};
	static MemoryWriteAddress f1gpstar_writemem2[] =
	{
		new MemoryWriteAddress( 0x000000, 0x03ffff, MWA_ROM							),	// ROM
	...
	**************************************************************************/
	...
	static MemoryReadAddress cischeat_readmem3[] =
	{
		new MemoryReadAddress( 0x000000, 0x03ffff, MRA_ROM		),	// ROM
		new MemoryReadAddress( 0x200000, 0x23ffff, rom_3_r		),	// ROM
		new MemoryReadAddress( 0x0c0000, 0x0c3fff, MRA_BANK5		),	// RAM
		new MemoryReadAddress( 0x040000, 0x047fff, sharedram2_r	),	// Shared RAM (with Main CPU)
		new MemoryReadAddress( 0x080000, 0x0807ff, MRA_BANK6		),	// Road RAM
		new MemoryReadAddress( -1 )
	};
	static MemoryWriteAddress cischeat_writemem3[] =
	{
		new MemoryWriteAddress( 0x000000, 0x03ffff, MWA_ROM							),	// ROM
		new MemoryWriteAddress( 0x200000, 0x23ffff, MWA_ROM							),	// ROM
	...
	**************************************************************************/
	...
	static MemoryReadAddress f1gpstar_readmem3[] =
	{
		new MemoryReadAddress( 0x000000, 0x03ffff, MRA_ROM		),	// ROM
		new MemoryReadAddress( 0x180000, 0x183fff, MRA_BANK5		),	// RAM
		new MemoryReadAddress( 0x080000, 0x0807ff, sharedram2_r	),	// Shared RAM (with Main CPU)
		new MemoryReadAddress( 0x100000, 0x1007ff, MRA_BANK6		),	// Road RAM
		new MemoryReadAddress( -1 )
	};
	static MemoryWriteAddress f1gpstar_writemem3[] =
	{
		new MemoryWriteAddress( 0x000000, 0x03ffff, MWA_ROM							),	// ROM
	...
	**************************************************************************/
	...
	public static WriteHandlerPtr cischeat_soundbank_0_w = new WriteHandlerPtr() {public void handler(int offset, int data) 
	{ 
		OKIM6295_set_bank_base(0, ALL_VOICES, 0x40000 * (data & 1) ); 
	} };
        
        public static WriteHandlerPtr cischeat_soundbank_1_w = new WriteHandlerPtr() {public void handler(int offset, int data) 
	{ 
		OKIM6295_set_bank_base(1, ALL_VOICES, 0x40000 * (data & 1) ); 
	} };
	
	
	
	static MemoryReadAddress cischeat_sound_readmem[] =
	{
		new MemoryReadAddress( 0x000000, 0x03ffff, MRA_ROM					),	// ROM
		new MemoryReadAddress( 0x0f0000, 0x0fffff, MRA_BANK7					),	// RAM
		new MemoryReadAddress( 0x060004, 0x060005, soundlatch_r				),	// From Main CPU
	...
	static MemoryWriteAddress cischeat_sound_writemem[] =
	{
		new MemoryWriteAddress( 0x000000, 0x03ffff, MWA_ROM						),	// ROM
		new MemoryWriteAddress( 0x0f0000, 0x0fffff, MWA_BANK7						),	// RAM
		new MemoryWriteAddress( 0x040002, 0x040003, cischeat_soundbank_0_w		),	// Sample Banking
		new MemoryWriteAddress( 0x040004, 0x040005, cischeat_soundbank_1_w		),	// Sample Banking
		new MemoryWriteAddress( 0x060002, 0x060003, ms_soundlatch2_w				),	// To Main CPU
	...
	**************************************************************************/
	...
	static MemoryReadAddress f1gpstar_sound_readmem[] =
	{
		new MemoryReadAddress( 0x000000, 0x03ffff, MRA_ROM					),	// ROM
		new MemoryReadAddress( 0x0e0000, 0x0fffff, MRA_BANK7					),	// RAM				(cischeat: f0000-fffff)
		new MemoryReadAddress( 0x060000, 0x060001, soundlatch_r				),	// From Main CPU	(cischeat: 60004)
		new MemoryReadAddress( 0x080002, 0x080003, YM2151_status_port_0_r	),
		new MemoryReadAddress( 0x0a0000, 0x0a0001, OKIM6295_status_0_r		),
		new MemoryReadAddress( 0x0c0000, 0x0c0001, OKIM6295_status_1_r		),
		new MemoryReadAddress( -1 )
	};
	static MemoryWriteAddress f1gpstar_sound_writemem[] =
	{
		new MemoryWriteAddress( 0x000000, 0x03ffff, MWA_ROM						),	// ROM
		new MemoryWriteAddress( 0x0e0000, 0x0fffff, MWA_BANK7						),	// RAM				(cischeat: f0000-fffff)
		new MemoryWriteAddress( 0x040004, 0x040005, cischeat_soundbank_0_w		),	// Sample Banking	(cischeat: 40002)
		new MemoryWriteAddress( 0x040008, 0x040009, cischeat_soundbank_1_w		),	// Sample Banking	(cischeat: 40004)
		new MemoryWriteAddress( 0x060000, 0x060001, ms_soundlatch2_w				),	// To Main CPU		(cischeat: 60002)
		new MemoryWriteAddress( 0x080000, 0x080001, ms_YM2151_register_port_0_w	),
		new MemoryWriteAddress( 0x080002, 0x080003, ms_YM2151_data_port_0_w		),
		new MemoryWriteAddress( 0x0a0000, 0x0a0003, ms_OKIM6295_data_0_w			),
		new MemoryWriteAddress( 0x0c0000, 0x0c0003, ms_OKIM6295_data_1_w			),
	...
	*/
	...
	//MEGASYS1_LAYOUT_8x8(tiles_8x8_01,  0x010000)
        static GfxLayout tiles_8x8_01 = new GfxLayout
        (
                8,8,
                (0x010000)*8/(8*8*4),
                4,
	...
	//MEGASYS1_LAYOUT_8x8(tiles_8x8_02,  0x020000)
        static GfxLayout tiles_8x8_02 = new GfxLayout
        (
                8,8,
                (0x020000)*8/(8*8*4),
                4,
	...
	//MEGASYS1_LAYOUT_8x8(tiles_8x8_04,  0x040000)
        static GfxLayout tiles_8x8_04 = new GfxLayout
        (
                8,8,
                (0x040000)*8/(8*8*4),
                4,
	...
	//MEGASYS1_LAYOUT_8x8(tiles_8x8_08,  0x080000)
        static GfxLayout tiles_8x8_08 = new GfxLayout
        (
                8,8,
                (0x080000)*8/(8*8*4),
                4,
	...
	//MEGASYS1_LAYOUT_16x16(tiles_16x16_4M,  0x400000)
        static GfxLayout tiles_16x16_4M = new GfxLayout
        (
                16,16,
                (0x400000)*8/(16*16*4),
                4,
	...
	static GfxLayout tiles_16x16_5M = new GfxLayout
        (
                16,16,
                (0x500000)*8/(16*16*4),
                4,
	...
	//ROAD_LAYOUT( road_layout_1M, 0x100000 )
        static GfxLayout road_layout_1M = new GfxLayout
	( 
		64,1, 
		8*(0x100000)/(64*1*4), 
		4, 
	...
	//ROAD_LAYOUT( road_layout_2M, 0x200000 )
        static GfxLayout road_layout_2M = new GfxLayout
	( 
		64,1, 
		8*(0x200000)/(64*1*4), 
		4, 
	...
	**************************************************************************/
	...
	{
		new GfxDecodeInfo( REGION_GFX1, 0, tiles_8x8_04,	32*16*0, 32  ), // [0] Scroll 0
		new GfxDecodeInfo( REGION_GFX2, 0, tiles_8x8_04,	32*16*1, 32  ), // [1] Scroll 1
		new GfxDecodeInfo( REGION_GFX3, 0, tiles_8x8_01,	32*16*2, 32  ), // [2] Scroll 2
		new GfxDecodeInfo( REGION_GFX4, 0, road_layout_1M,	32*16*3, 64  ), // [3] Road 0
		new GfxDecodeInfo( REGION_GFX4, 0, road_layout_1M,	32*16*5, 64  ), // [4] Road 1
		new GfxDecodeInfo( REGION_GFX5, 0, tiles_16x16_4M,	32*16*7, 128 ), // [5] Sprites
		new GfxDecodeInfo( -1 )
	};
	...
	**************************************************************************/
	...
	{
		new GfxDecodeInfo( REGION_GFX1, 0, tiles_8x8_08,	0x0000, 16  ), // [0] Scroll 0
		new GfxDecodeInfo( REGION_GFX2, 0, tiles_8x8_08,	0x0100, 16  ), // [1] Scroll 1
		new GfxDecodeInfo( REGION_GFX3, 0, tiles_8x8_02,	0x0200, 16  ), // [2] Scroll 2
		new GfxDecodeInfo( REGION_GFX4, 0, road_layout_2M,	0x0300, 64  ), // [3] Road 0
		new GfxDecodeInfo( REGION_GFX5, 0, road_layout_1M,	0x0700, 64  ), // [4] Road 1
		new GfxDecodeInfo( REGION_GFX6, 0, tiles_16x16_5M,	0x0b00, 128 ), // [5] Sprites
		new GfxDecodeInfo( -1 )
	};
	...
	/* CPU # 1 */
	public static int CISCHEAT_INTERRUPT_NUM	= 3;
	...
	/* CPU # 2 & 3 */
	static int CISCHEAT_SUB_INTERRUPT_NUM	= 1;
	...
	/* CPU # 4 */
	static int CISCHEAT_SOUND_INTERRUPT_NUM	= 16;
	public static InterruptPtr cischeat_sound_interrupt = new InterruptPtr() { public int handler() 
	{
		return 4;
	} };
	
	static int STD_FM_CLOCK     = 3000000;
	static int STD_OKI_CLOCK    =12000;
	...
	*/
	...
	{
		UBytePtr src = new UBytePtr(memory_region(region));
		UBytePtr end = new UBytePtr(memory_region(region), memory_region_length(region));
	
		while (src.offset < end.offset)
		{
			UBytePtr sprite=new UBytePtr(16*8);
			int i;
	
			for (i = 0; i < 16 ; i++)
			{
				memcpy(new UBytePtr(sprite, i*8+0), new UBytePtr(src, i*4+0),    4);
				memcpy(new UBytePtr(sprite, i*8+4), new UBytePtr(src, i*4+16*4), 4);
			}
	...
	***************************************************************************/
	...
	{
	/* Split ROMs */
		rom_1 = new UBytePtr(memory_region(REGION_USER1), 0x00000);
	
		rom_2 = new UBytePtr(memory_region(REGION_CPU2), 0x40000);
		memcpy(new UBytePtr(memory_region(REGION_USER1), 0x80000), new UBytePtr(rom_2), 0x40000);
		memset(rom_2, 0, 0x40000);
		rom_2 = new UBytePtr(memory_region(REGION_USER1), 0x80000);
	
		rom_3 = new UBytePtr(memory_region(REGION_CPU3), 0x40000);
		memcpy(new UBytePtr(memory_region(REGION_USER1), 0xc0000), new UBytePtr(rom_3), 0x40000);
		memset(rom_3, 0, 0x40000);
		rom_3 = new UBytePtr(memory_region(REGION_USER1), 0xc0000);
	...
	static rectangle CISCHEAT_VISIBLE_AREA = new rectangle(0,255,16,231);
...
//						_visible_area_, _colors_num_ ) 
	...
	static YM2151interface cischeat_ym2151_interface = new YM2151interface
	( 
		1, 
		STD_FM_CLOCK, 
		new int[] { YM3012_VOL(33,MIXER_PAN_LEFT,33,MIXER_PAN_RIGHT) }, 
		new WriteYmHandlerPtr[] { null } 
	); 
	
	static OKIM6295interface cischeat_okim6295_interface = new OKIM6295interface
	( 
		2, 
	...
	static MachineDriver machine_driver_cischeat = new MachineDriver
	( 
		new MachineCPU[] { 
			new MachineCPU( 
				CPU_M68000, 
				10000000, 
				cischeat_readmem,cischeat_writemem,null,null, 
				cischeat_interrupt, CISCHEAT_INTERRUPT_NUM 
			), 
			new MachineCPU( 
				CPU_M68000, 
				10000000, 
				cischeat_readmem2,cischeat_writemem2,null,null, 
				cischeat_sub_interrupt, CISCHEAT_SUB_INTERRUPT_NUM 
			), 
			new MachineCPU( 
				CPU_M68000, 
				10000000, 
				cischeat_readmem3,cischeat_writemem3,null,null, 
				cischeat_sub_interrupt, CISCHEAT_SUB_INTERRUPT_NUM 
			), 
			new MachineCPU( 
				CPU_M68000 | CPU_AUDIO_CPU, 
				7000000, 
				cischeat_sound_readmem,cischeat_sound_writemem,null,null, 
		...
		/* video hardware */ 
		256, 256,CISCHEAT_VISIBLE_AREA, 
	
		cischeat_gfxdecodeinfo, 
		32*16 * 3 + 64*16 * 2 + 128*16, 32*16 * 3 + 64*16 * 2 + 128*16, 
		null, 
		...
		new MachineSound[] { 
			new MachineSound( 
				SOUND_YM2151, 
				cischeat_ym2151_interface 
			),
			new MachineSound(
				SOUND_OKIM6295, 
				cischeat_okim6295_interface 
			) 
		} 
	);	
	...
	***************************************************************************/
	...
	static rectangle F1GPSTAR_VISIBLE_AREA	= new rectangle(0,255,16,239);
...
//						_visible_area_, _colors_num_ ) 
	...
	static YM2151interface f1gpstar_ym2151_interface = new YM2151interface
	( 
		1, 
		STD_FM_CLOCK, 
		new int[] { YM3012_VOL(33,MIXER_PAN_LEFT,33,MIXER_PAN_RIGHT) }, 
	...
	static OKIM6295interface f1gpstar_okim6295_interface = new OKIM6295interface
	( 
		2, 
		new int[] {STD_OKI_CLOCK, STD_OKI_CLOCK},
		new int[] {REGION_SOUND1,REGION_SOUND2}, 
	...
	static MachineDriver machine_driver_f1gpstar = new MachineDriver
	( 
		new MachineCPU[] { 
			new MachineCPU( 
				CPU_M68000, 
				12000000, 
				f1gpstar_readmem,f1gpstar_writemem,null,null, 
				cischeat_interrupt, CISCHEAT_INTERRUPT_NUM 
			), 
			new MachineCPU( 
				CPU_M68000, 
				12000000, 
				f1gpstar_readmem2,f1gpstar_writemem2,null,null, 
				cischeat_sub_interrupt, CISCHEAT_SUB_INTERRUPT_NUM 
			), 
			new MachineCPU( 
				CPU_M68000, 
				12000000, 
				f1gpstar_readmem3,f1gpstar_writemem3,null,null, 
				cischeat_sub_interrupt, CISCHEAT_SUB_INTERRUPT_NUM 
			), 
			new MachineCPU( 
				CPU_M68000 | CPU_AUDIO_CPU, 
				7000000, 
				f1gpstar_sound_readmem,f1gpstar_sound_writemem,null,null, 
				cischeat_sound_interrupt, CISCHEAT_SOUND_INTERRUPT_NUM 
			), 
		}, 
		60,DEFAULT_REAL_60HZ_VBLANK_DURATION, 
		...
		/* video hardware */ 
		256, 256,F1GPSTAR_VISIBLE_AREA, 
	
		f1gpstar_gfxdecodeinfo, 
		16*16 * 3 + 64*16 * 2 + 128*16, 16*16 * 3 + 64*16 * 2 + 128*16, 
		null, 
		...
		new MachineSound[] { 
			new MachineSound( 
				SOUND_YM2151, 
				f1gpstar_ym2151_interface 
			),
			new MachineSound(
				SOUND_OKIM6295, 
				f1gpstar_okim6295_interface 
			) 
		} 
	);
	
	
	public static GameDriver driver_cischeat	   = new GameDriver("1990"	,"cischeat"	,"cischeat.java"	,rom_cischeat,null	,machine_driver_cischeat	,input_ports_cischeat	,init_cischeat	,ROT0_16BIT	,	"Jaleco", "Cisco Heat" );
	public static GameDriver driver_f1gpstar	   = new GameDriver("1991"	,"f1gpstar"	,"cischeat.java"	,rom_f1gpstar,null	,machine_driver_f1gpstar	,input_ports_f1gpstar	,init_f1gpstar	,ROT0_16BIT	,	"Jaleco", "F1 Grand Prix Star" );
}

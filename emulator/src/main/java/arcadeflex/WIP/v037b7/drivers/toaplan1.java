...
import static arcadeflex.WIP.v037b7.machine.toaplan1.*;
import static arcadeflex.WIP.v037b7.vidhrdw.toaplan1.*;
...
public class toaplan1
{
	...
	static MemoryWriteAddress demonwld_writemem[] =
	{
		...
		new MemoryWriteAddress( 0xe0000a, 0xe0000b, demonwld_dsp_ctrl_w ),			/* DSP Comms control */
		new MemoryWriteAddress( -1 )
	};
	...
	{
		new IOReadPort( 0x01, 0x01, demonwld_dsp_r ),
		new IOReadPort( -1 )	/* end of table */
	};
	
	static IOWritePort DSP_writeport[] =
	{
		new IOWritePort( 0x00, 0x03, demonwld_dsp_w ),
		new IOWritePort( -1 )	/* end of table */
	};
	...
	*****************************************************************************/
	...
	static void  TOAPLAN1_PLAYER_INPUT( int player, int button3 ) {
		PORT_START(); 																	
	...
	static void  TOAPLAN1_SYSTEM_INPUTS() {
		PORT_START(); 										
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_outzonep = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x040000, REGION_CPU1 );/* Main 68K code */

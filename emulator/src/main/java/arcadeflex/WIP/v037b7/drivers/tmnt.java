...
import static arcadeflex.WIP.v037b7.vidhrdw.tmnt.*;
...
import gr.codebb.arcadeflex.WIP.v037b7.sound.k007232H;
import static gr.codebb.arcadeflex.WIP.v037b7.sound.k007232H.*;
...
public class tmnt
{
	...
	public static ReadHandlerPtr K052109_word_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
		offset >>= 1;
		return K052109_r.handler(offset + 0x2000) | (K052109_r.handler(offset) << 8);
	} };
	
	public static WriteHandlerPtr K052109_word_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		offset >>= 1;
	...
	public static ReadHandlerPtr K052109_word_noA12_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
	...
	public static WriteHandlerPtr K052109_word_noA12_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		/* some games have the A12 line not connected, so the chip spans */
		/* twice the memory range, with mirroring */
		offset = ((offset & 0x6000) >> 1) | (offset & 0x0fff);
	...
	public static ReadHandlerPtr K053244_halfword_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
		return K053244_r.handler(offset >> 1);
	} };
	
	public static WriteHandlerPtr K053244_halfword_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		if ((data & 0x00ff0000) == 0)
			K053244_w.handler(offset >> 1,data & 0xff);
	} };
	
	public static ReadHandlerPtr K053244_word_noA1_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
	...
	public static WriteHandlerPtr K053244_word_noA1_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		offset &= ~2;	/* handle mirror address */
	...
	public static WriteHandlerPtr K053251_halfword_swap_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		if ((data & 0xff000000) == 0)
			K053251_w.handler(offset >> 1,(data >> 8) & 0xff);
	} };
	
	public static ReadHandlerPtr K054000_halfword_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
		return K054000_r.handler(offset >> 1);
	} };
	
	public static WriteHandlerPtr K054000_halfword_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		if ((data & 0x00ff0000) == 0)
	...
	{
		if (K052109_is_IRQ_enabled() != 0) return m68_level4_irq.handler();
	...
	public static WriteHandlerPtr tmnt_sound_command_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		soundlatch_w.handler(0,data & 0xff);
	} };
	
	public static ReadHandlerPtr punkshot_sound_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
		/* If the sound CPU is running, read the status, otherwise
		   just make it pass the test */
		if (Machine.sample_rate != 0) 	return K053260_r.handler(2 + offset/2);
		else return 0x80;
	} };
	
	public static ReadHandlerPtr detatwin_sound_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
		/* If the sound CPU is running, read the status, otherwise
		   just make it pass the test */
		if (Machine.sample_rate != 0) 	return K053260_r.handler(2 + offset/2);
		else return offset!=0 ? 0xfe : 0x00;
	} };
	
	public static ReadHandlerPtr glfgreat_sound_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
		/* If the sound CPU is running, read the status, otherwise
		   just make it pass the test */
		if (Machine.sample_rate != 0) 	return K053260_r.handler(2 + offset/2) << 8;
		else return 0;
	} };
	
	public static WriteHandlerPtr glfgreat_sound_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		if ((data & 0xff000000) == 0)
			K053260_w.handler(offset >> 1,(data >> 8) & 0xff);
	
		if (offset == 2) cpu_cause_interrupt(1,0xff);
	} };
	
	public static ReadHandlerPtr tmnt2_sound_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
		/* If the sound CPU is running, read the status, otherwise
		   just make it pass the test */
		if (Machine.sample_rate != 0) 	return K053260_r.handler(2 + offset/2);
	...
	public static timer_callback sound_nmi_callback = new timer_callback() { public void handler(int param) 
	{
	...
	public static ReadHandlerPtr punkshot_kludge_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
	...
	public static ReadHandlerPtr ssriders_kludge_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
/*TODO*///	    int data = cpu_readmem24bew_word(0x105a0a);
/*TODO*///	
/*TODO*///	    logerror("%06x: read 1c0800 (D7=%02x 105a0a=%02x)\n",cpu_get_pc(),cpu_get_reg(M68K_D7),data);
/*TODO*///	
/*TODO*///	    if (data == 0x075c) data = 0x0064;
/*TODO*///	
/*TODO*///	    if ( cpu_readmem24bew_word(cpu_get_pc()) == 0x45f9 )
/*TODO*///		{
...
/*TODO*///	    return data;
	...
	***************************************************************************/
	...
	public static ReadHandlerPtr detatwin_coin_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
		int res;
	...
	public static ReadHandlerPtr detatwin_eeprom_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
		int res;
	...
	public static ReadHandlerPtr ssriders_eeprom_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
		int res;
		//static int toggle;
	...
	public static WriteHandlerPtr ssriders_eeprom_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		/* bit 0 is data */
	...
	public static nvramPtr thndrx2_nvram_handler  = new nvramPtr() { public void handler(Object file, int read_or_write) 
	{
		if (read_or_write != 0)
			EEPROM_save(file);
		else
	...
	public static ReadHandlerPtr thndrx2_in0_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
		int res;
	...
	public static ReadHandlerPtr thndrx2_eeprom_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
		int res;
		//static int toggle;
	...
	public static WriteHandlerPtr thndrx2_eeprom_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{		
		if ((data & 0x00ff0000) == 0)
		{
			/* bit 0 is data */
...
/*TODO*///	#if 0
/*TODO*///		new MemoryWriteAddress( 0x0c0000, 0x0c0001, tmnt_priority_w ),
/*TODO*///	#endif
	...
	static MemoryReadAddress punkshot_readmem[] =
	{
		...
		new MemoryReadAddress( 0xfffffc, 0xffffff, punkshot_kludge_r ),
		new MemoryReadAddress( -1 )	/* end of table */
	};
	...
	static MemoryWriteAddress punkshot_writemem[] =
	{
		...
		new MemoryWriteAddress( 0x0a0040, 0x0a0041, K053260_w ),
	...
	static MemoryWriteAddress lgtnfght_writemem[] =
	{
		...
		new MemoryWriteAddress( 0x0a0020, 0x0a0021, K053260_w ),
	...
	public static WriteHandlerPtr ssriders_soundkludge_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		/* I think this is more than just a trigger */
		cpu_cause_interrupt(1,0xff);
	} };
	
	static MemoryReadAddress detatwin_readmem[] =
	{
		new MemoryReadAddress( 0x000000, 0x07ffff, MRA_ROM ),
		new MemoryReadAddress( 0x180000, 0x183fff, K052109_word_r ),
		new MemoryReadAddress( 0x204000, 0x207fff, MRA_BANK1 ),	/* main RAM */
		new MemoryReadAddress( 0x300000, 0x303fff, K053245_scattered_word_r ),
		new MemoryReadAddress( 0x400000, 0x400fff, paletteram_word_r ),
		new MemoryReadAddress( 0x500000, 0x50003f, K054000_halfword_r ),
		new MemoryReadAddress( 0x680000, 0x68001f, K053244_word_noA1_r ),
		new MemoryReadAddress( 0x700000, 0x700001, input_port_0_r ),
		new MemoryReadAddress( 0x700002, 0x700003, input_port_1_r ),
		new MemoryReadAddress( 0x700004, 0x700005, detatwin_coin_r ),
		new MemoryReadAddress( 0x700006, 0x700007, detatwin_eeprom_r ),
		new MemoryReadAddress( 0x780600, 0x780603, detatwin_sound_r ),	/* K053260 */
		new MemoryReadAddress( -1 )	/* end of table */
	};
	
	static MemoryWriteAddress detatwin_writemem[] =
	{
		new MemoryWriteAddress( 0x000000, 0x07ffff, MWA_ROM ),
		new MemoryWriteAddress( 0x180000, 0x183fff, K052109_word_w ),
		new MemoryWriteAddress( 0x204000, 0x207fff, MWA_BANK1 ),	/* main RAM */
		new MemoryWriteAddress( 0x300000, 0x303fff, K053245_scattered_word_w, spriteram ),
		...
		new MemoryWriteAddress( 0x680000, 0x68001f, K053244_word_noA1_w ),
		new MemoryWriteAddress( 0x700200, 0x700201, ssriders_eeprom_w ),
		new MemoryWriteAddress( 0x700400, 0x700401, watchdog_reset_w ),
		new MemoryWriteAddress( 0x700300, 0x700301, detatwin_700300_w ),
		new MemoryWriteAddress( 0x780600, 0x780601, K053260_w ),
		new MemoryWriteAddress( 0x780604, 0x780605, ssriders_soundkludge_w ),
		new MemoryWriteAddress( 0x780700, 0x78071f, K053251_halfword_w ),
		new MemoryWriteAddress( -1 )	/* end of table */
	};
	
	
	public static ReadHandlerPtr ball_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
		return 0x11;
	} };
	
	static MemoryReadAddress glfgreat_readmem[] =
	{
		new MemoryReadAddress( 0x000000, 0x03ffff, MRA_ROM ),
		new MemoryReadAddress( 0x100000, 0x103fff, MRA_BANK1 ),	/* main RAM */
		new MemoryReadAddress( 0x104000, 0x107fff, K053245_scattered_word_r ),
		new MemoryReadAddress( 0x108000, 0x108fff, paletteram_word_r ),
		new MemoryReadAddress( 0x10c000, 0x10cfff, MRA_BANK2 ),	/* 053936? */
		new MemoryReadAddress( 0x114000, 0x11401f, K053244_halfword_r ),
		new MemoryReadAddress( 0x120000, 0x120001, input_port_0_r ),
		new MemoryReadAddress( 0x120002, 0x120003, input_port_1_r ),
		new MemoryReadAddress( 0x120004, 0x120005, input_port_3_r ),
		new MemoryReadAddress( 0x120006, 0x120007, input_port_2_r ),
		new MemoryReadAddress( 0x121000, 0x121001, ball_r ),	/* protection? returning 0, every shot is a "water" */
		new MemoryReadAddress( 0x125000, 0x125003, glfgreat_sound_r ),	/* K053260 */
		new MemoryReadAddress( 0x200000, 0x207fff, K052109_word_noA12_r ),
		new MemoryReadAddress( -1 )	/* end of table */
	};
	
	static MemoryWriteAddress glfgreat_writemem[] =
	{
		new MemoryWriteAddress( 0x000000, 0x03ffff, MWA_ROM ),
		new MemoryWriteAddress( 0x100000, 0x103fff, MWA_BANK1 ),	/* main RAM */
		new MemoryWriteAddress( 0x104000, 0x107fff, K053245_scattered_word_w, spriteram ),
		new MemoryWriteAddress( 0x108000, 0x108fff, paletteram_xBBBBBGGGGGRRRRR_word_w, paletteram ),
		new MemoryWriteAddress( 0x10c000, 0x10cfff, MWA_BANK2 ),	/* 053936? */
		new MemoryWriteAddress( 0x110000, 0x11001f, K053244_word_noA1_w ),	/* duplicate! */
		new MemoryWriteAddress( 0x114000, 0x11401f, K053244_halfword_w ),		/* duplicate! */
		new MemoryWriteAddress( 0x118000, 0x11801f, MWA_NOP ),	/* 053936 control? */
		new MemoryWriteAddress( 0x11c000, 0x11c01f, K053251_halfword_swap_w ),
		new MemoryWriteAddress( 0x122000, 0x122001, glfgreat_122000_w ),
		new MemoryWriteAddress( 0x124000, 0x124001, watchdog_reset_w ),
		new MemoryWriteAddress( 0x125000, 0x125003, glfgreat_sound_w ),	/* K053260 */
		new MemoryWriteAddress( 0x200000, 0x207fff, K052109_word_noA12_w ),
		new MemoryWriteAddress( -1 )	/* end of table */
	};
	
	
	static MemoryReadAddress tmnt2_readmem[] =
	{
		new MemoryReadAddress( 0x000000, 0x07ffff, MRA_ROM ),
	...
	//	new MemoryReadAddress( 0x1c0800, 0x1c0801, ssriders_kludge_r ),	/* protection device */
		new MemoryReadAddress( 0x5a0000, 0x5a001f, K053244_word_noA1_r ),
		new MemoryReadAddress( 0x5c0600, 0x5c0603, tmnt2_sound_r ),	/* K053260 */
		new MemoryReadAddress( 0x600000, 0x603fff, K052109_word_r ),
		new MemoryReadAddress( -1 )	/* end of table */
	};
	
	static UBytePtr tmnt2_1c0800=new UBytePtr(), sunset_104000=new UBytePtr();
	...
	public static WriteHandlerPtr tmnt2_1c0800_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
	    ...
	    if ( offset == 0x0010 && ( ( tmnt2_1c0800.READ_WORD(0x10) & 0xff00 ) == 0x8200 ) )
		{
			int CellSrc;
			int CellVar;
			UBytePtr src;
			...
			CellVar = ( tmnt2_1c0800.READ_WORD( 0x08 ) | ( tmnt2_1c0800.READ_WORD( 0x0A ) << 16 ) );
			dst = ( tmnt2_1c0800.READ_WORD( 0x04 ) | ( tmnt2_1c0800.READ_WORD( 0x06 ) << 16 ) );
			CellSrc = ( tmnt2_1c0800.READ_WORD( 0x00 ) | ( tmnt2_1c0800.READ_WORD( 0x02 ) << 16 ) );
	//        if ( CellDest >= 0x180000 && CellDest < 0x183fe0 ) {
	        CellVar -= 0x104000;
			src = new UBytePtr(memory_region(REGION_CPU1), CellSrc);
                        
                        System.out.println("cpu_writemem24bew_word NOT IMPLEMENTED!!!!");
	
/*TODO*///			cpu_writemem24bew_word(dst+0x00,0x8000 | ((READ_WORD(src+2) & 0xfc00) >> 2));	/* size, flip xy */
/*TODO*///	        cpu_writemem24bew_word(dst+0x04,READ_WORD(src+0));	/* code */
/*TODO*///	        cpu_writemem24bew_word(dst+0x18,(READ_WORD(src+2) & 0x3ff) ^		/* color, mirror, priority */
/*TODO*///					(READ_WORD( &sunset_104000[CellVar + 0x00] ) & 0x0060));
	...
	//					(READ_WORD( &sunset_104000[CellVar + 0x2a] ) & 0x001f));
			...
			x = src.READ_WORD(4);
			if ((sunset_104000.READ_WORD( CellVar + 0x00 ) & 0x4000) != 0)
			{
				/* flip x */
/*TODO*///				cpu_writemem24bew_word(dst+0x00,cpu_readmem24bew_word(dst+0x00) ^ 0x1000);
				x = -x;
			}
			x += sunset_104000.READ_WORD( CellVar + 0x0C );
/*TODO*///			cpu_writemem24bew_word(dst+0x0c,x);
			y = src.READ_WORD(6);
			y += sunset_104000.READ_WORD( CellVar + 0x0E );
			/* don't do second offset for shadows */
			if ((tmnt2_1c0800.READ_WORD(0x10) & 0x00ff) != 0x01)
				y += sunset_104000.READ_WORD( CellVar + 0x10 );
/*TODO*///			cpu_writemem24bew_word(dst+0x08,y);
/*TODO*///	#if 0
/*TODO*///	logerror("copy command %04x sprite %08x data %08x: %04x%04x %04x%04x  modifiers %08x:%04x%04x %04x%04x %04x%04x %04x%04x %04x%04x %04x%04x %04x%04x %04x%04x %04x%04x %04x%04x %04x%04x %04x%04x\n",
...
/*TODO*///	#endif
	...
	static MemoryWriteAddress tmnt2_writemem[] =
	{
		new MemoryWriteAddress( 0x000000, 0x07ffff, MWA_ROM ),
		new MemoryWriteAddress( 0x104000, 0x107fff, MWA_BANK1, sunset_104000 ),	/* main RAM */
		...
		new MemoryWriteAddress( 0x1c0500, 0x1c057f, MWA_BANK3 ),	/* unknown: TMNT2 only (1J) */
		new MemoryWriteAddress( 0x1c0800, 0x1c081f, tmnt2_1c0800_w, tmnt2_1c0800 ),	/* protection device */
		new MemoryWriteAddress( 0x5a0000, 0x5a001f, K053244_word_noA1_w ),
		new MemoryWriteAddress( 0x5c0600, 0x5c0601, K053260_w ),
	...
	static MemoryWriteAddress thndrx2_writemem[] =
	{
		...
		new MemoryWriteAddress( 0x400000, 0x400001, K053260_w ),
		new MemoryWriteAddress( 0x500000, 0x50003f, K054000_halfword_w ),
	...
	static MemoryReadAddress tmnt_s_readmem[] =
	{
		...
		new MemoryReadAddress( 0xb000, 0xb00d, K007232_read_port_0_r ),
		new MemoryReadAddress( 0xc001, 0xc001, YM2151_status_port_0_r ),
		new MemoryReadAddress( 0xf000, 0xf000, UPD7759_0_busy_r ),
		new MemoryReadAddress( -1 )	/* end of table */
	};
	...
	static MemoryWriteAddress tmnt_s_writemem[] =
	{
		...
		new MemoryWriteAddress( 0xc000, 0xc000, YM2151_register_port_0_w ),
		new MemoryWriteAddress( 0xc001, 0xc001, YM2151_data_port_0_w ),
		new MemoryWriteAddress( 0xd000, 0xd000, UPD7759_0_message_w ),
		new MemoryWriteAddress( 0xe000, 0xe000, UPD7759_0_start_w ),
		new MemoryWriteAddress( -1 )	/* end of table */
	};
	...
	static MemoryReadAddress lgtnfght_s_readmem[] =
	{
		...
		new MemoryReadAddress( 0xc000, 0xc02f, K053260_r ),
		new MemoryReadAddress( -1 )	/* end of table */
	};
	...
	static MemoryWriteAddress lgtnfght_s_writemem[] =
	{
		...
		new MemoryWriteAddress( 0xc000, 0xc02f, K053260_w ),
		new MemoryWriteAddress( -1 )	/* end of table */
	};
	
	static MemoryReadAddress glfgreat_s_readmem[] =
	{
		new MemoryReadAddress( 0x0000, 0x7fff, MRA_ROM ),
		new MemoryReadAddress( 0xf000, 0xf7ff, MRA_RAM ),
		new MemoryReadAddress( 0xf800, 0xf82f, K053260_r ),
		new MemoryReadAddress( -1 )	/* end of table */
	};
	
	static MemoryWriteAddress glfgreat_s_writemem[] =
	{
		new MemoryWriteAddress( 0x0000, 0x7fff, MWA_ROM ),
		new MemoryWriteAddress( 0xf000, 0xf7ff, MWA_RAM ),
		new MemoryWriteAddress( 0xf800, 0xf82f, K053260_w ),
		new MemoryWriteAddress( 0xfa00, 0xfa00, sound_arm_nmi_w ),
		new MemoryWriteAddress( -1 )	/* end of table */
	};
	...
	static MemoryReadAddress ssriders_s_readmem[] =
	{
		...
		new MemoryReadAddress( 0xf000, 0xf7ff, MRA_RAM ),
		new MemoryReadAddress( 0xf801, 0xf801, YM2151_status_port_0_r ),
		new MemoryReadAddress( 0xfa00, 0xfa2f, K053260_r ),
		new MemoryReadAddress( -1 )	/* end of table */
	};
	...
	static MemoryWriteAddress ssriders_s_writemem[] =
	{
		...
		new MemoryWriteAddress( 0xf800, 0xf800, YM2151_register_port_0_w ),
		new MemoryWriteAddress( 0xf801, 0xf801, YM2151_data_port_0_w ),
		new MemoryWriteAddress( 0xfa00, 0xfa2f, K053260_w ),
	...
	static K053260_interface glfgreat_k053260_interface = new K053260_interface
	(
		3579545,
		REGION_SOUND1, /* memory region */
	...
	***************************************************************************/
	...
	public static InitDriverPtr init_gfx = new InitDriverPtr() { public void handler() 
	{
		konami_rom_deinterleave_2(REGION_GFX1);
		konami_rom_deinterleave_2(REGION_GFX2);
	} };
	
	public static InitDriverPtr init_mia = new InitDriverPtr() { public void handler() 
	{
		UBytePtr gfxdata;
		int len;
		int i,j,k,A,B;
	...
	public static InitDriverPtr init_tmnt = new InitDriverPtr() { public void handler() 
	{
		UBytePtr gfxdata;
		int len;
		int i,j,k,A,B,entry;
	...
	public static InitDriverPtr init_glfgreat = new InitDriverPtr() { public void handler() 
	{
	...
	public static GameDriver driver_tmnt2po	   = new GameDriver("1989"	,"tmnt2po"	,"tmnt.java"	,rom_tmnt2po,driver_tmnt	,machine_driver_tmnt	,input_ports_tmnt2p	,init_tmnt	,ROT0	,	"Konami", "Teenage Mutant Ninja Turtles (2 Players Oceania)" );
	...
	public static GameDriver driver_tmnt2	   = new GameDriver("1991"	,"tmnt2"	,"tmnt.java"	,rom_tmnt2,null	,machine_driver_tmnt2	,input_ports_ssridr4p	,init_gfx	,ROT0	,	"Konami", "Teenage Mutant Ninja Turtles - Turtles in Time (4 Players US)", GAME_IMPERFECT_COLORS );
	public static GameDriver driver_tmnt22p	   = new GameDriver("1991"	,"tmnt22p"	,"tmnt.java"	,rom_tmnt22p,driver_tmnt2	,machine_driver_tmnt2	,input_ports_ssriders	,init_gfx	,ROT0	,	"Konami", "Teenage Mutant Ninja Turtles - Turtles in Time (2 Players US)", GAME_IMPERFECT_COLORS );
	public static GameDriver driver_tmnt2a	   = new GameDriver("1991"	,"tmnt2a"	,"tmnt.java"	,rom_tmnt2a,driver_tmnt2	,machine_driver_tmnt2	,input_ports_tmnt2a	,init_gfx	,ROT0	,	"Konami", "Teenage Mutant Ninja Turtles - Turtles in Time (4 Players Asia)", GAME_IMPERFECT_COLORS );

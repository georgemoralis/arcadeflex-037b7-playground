...
import static arcadeflex.WIP.v037b7.vidhrdw.dynduke.*;
...
public class dynduke
{
	...
	static UBytePtr dynduke_shared_ram = new UBytePtr();
	
	/***************************************************************************/
	
	public static ReadHandlerPtr dynduke_shared_r  = new ReadHandlerPtr() { public int handler(int offset) { return dynduke_shared_ram.read(offset); } };
	public static WriteHandlerPtr dynduke_shared_w = new WriteHandlerPtr() {public void handler(int offset, int data) { dynduke_shared_ram.write(offset, data); } };
	...
	public static ReadHandlerPtr dynduke_soundcpu_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
		...
		if (offset==4 && (Machine.sample_rate==0) && (readinputport(4)&1)==1) return 1;
...
/*TODO*///	#if 0
/*TODO*///	SEIBU_SOUND_SYSTEM_YM3812_MEMORY_MAP(input_port_4_r); /* Coin port */
/*TODO*///	#endif
	...
	public static VhEofCallbackPtr dynduke_eof_callback = new VhEofCallbackPtr() { public void handler() 
	{
...
/*TODO*///	#if 0
/*TODO*///			new MachineCPU(
/*TODO*///				SEIBU_SOUND_SYSTEM_CPU(14318180/4)
/*TODO*///			)
/*TODO*///	#endif
		},

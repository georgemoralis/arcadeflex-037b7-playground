...
import static arcadeflex.WIP.v037b7.vidhrdw.mcr68.*;
...
public class mcr68
{
	...
	public static WriteHandlerPtr xenophobe_control_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
	...
	public static WriteHandlerPtr blasted_control_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		int oldword = control_word.READ_WORD(offset);
		int newword = COMBINE_WORD(oldword, data);
		control_word.WRITE_WORD(offset, newword);
	...
	public static ReadHandlerPtr spyhunt2_port_0_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
		int result = input_port_0_r.handler(offset);
		int which = (control_word.READ_WORD() >> 3) & 3;
		int analog = readinputport(3 + which);
		return result | ((soundsgood_status_r.handler(0) & 1) << 5) | (analog << 8);
	} };
	
	
	public static ReadHandlerPtr spyhunt2_port_1_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
		int result = input_port_1_r.handler(offset);
		return result | ((turbocs_status_r.handler(0) & 1) << 7);
	} };
	
	
	public static WriteHandlerPtr spyhunt2_control_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		int oldword = control_word.READ_WORD(offset);
		int newword = COMBINE_WORD(oldword, data);
		control_word.WRITE_WORD(offset, newword);
	...
	static int[] protection_data=new int[5];
	public static WriteHandlerPtr pigskin_protection_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		/* ignore upper-byte only */
		if ((data & 0x00ff0000) != 0) return;
	...
	public static ReadHandlerPtr pigskin_protection_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
	...
	public static ReadHandlerPtr pigskin_port_1_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
		int joystick = input_port_3_r.handler(offset);
		int result = input_port_1_r.handler(offset);
	...
	public static ReadHandlerPtr pigskin_port_2_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
		int joystick = input_port_3_r.handler(offset);
		int result = input_port_2_r.handler(offset);
	...
	public static ReadHandlerPtr trisport_port_1_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
		int xaxis = input_port_3_r.handler(offset);
		int yaxis = input_port_4_r.handler(offset);
		int result = input_port_1_r.handler(offset);
	...
	static MemoryReadAddress pigskin_readmem[] =
	{
		new MemoryReadAddress( 0x000000, 0x03ffff, MRA_ROM ),
		new MemoryReadAddress( 0x080000, 0x08ffff, pigskin_port_1_r ),
		new MemoryReadAddress( 0x0a0000, 0x0affff, pigskin_port_2_r ),
		new MemoryReadAddress( 0x100000, 0x100fff, MRA_BANK2 ),
		new MemoryReadAddress( 0x120000, 0x120001, pigskin_protection_r ),
		new MemoryReadAddress( 0x140000, 0x143fff, MRA_BANK3 ),
		new MemoryReadAddress( 0x160000, 0x1607ff, MRA_BANK4 ),
		new MemoryReadAddress( 0x180000, 0x18000f, mcr68_6840_upper_r ),
		new MemoryReadAddress( 0x1e0000, 0x1effff, input_port_0_r ),
		new MemoryReadAddress( -1 )  /* end of table */
	};
	
	
	static MemoryWriteAddress pigskin_writemem[] =
	{
		new MemoryWriteAddress( 0x000000, 0x03ffff, MWA_ROM ),
		new MemoryWriteAddress( 0x0c0000, 0x0c007f, mcr68_paletteram_w, paletteram ),
		new MemoryWriteAddress( 0x0e0000, 0x0effff, watchdog_reset_w ),
		new MemoryWriteAddress( 0x100000, 0x100fff, mcr68_videoram_w, videoram, videoram_size ),
		new MemoryWriteAddress( 0x120000, 0x120001, pigskin_protection_w ),
		new MemoryWriteAddress( 0x140000, 0x143fff, MWA_BANK3 ),
		new MemoryWriteAddress( 0x160000, 0x1607ff, MWA_BANK4, spriteram, spriteram_size ),
		new MemoryWriteAddress( 0x180000, 0x18000f, mcr68_6840_upper_w ),
		new MemoryWriteAddress( 0x1a0000, 0x1affff, MWA_NOP, control_word ),
		new MemoryWriteAddress( -1 )  /* end of table */
	};
	...
	static MemoryReadAddress trisport_readmem[] =
	{
		new MemoryReadAddress( 0x000000, 0x03ffff, MRA_ROM ),
		new MemoryReadAddress( 0x080000, 0x08ffff, trisport_port_1_r ),
		new MemoryReadAddress( 0x0a0000, 0x0affff, input_port_2_r ),
		new MemoryReadAddress( 0x100000, 0x103fff, MRA_BANK2 ),
		new MemoryReadAddress( 0x140000, 0x1407ff, MRA_BANK3 ),
		new MemoryReadAddress( 0x160000, 0x160fff, MRA_BANK4 ),
		new MemoryReadAddress( 0x180000, 0x18000f, mcr68_6840_upper_r ),
		new MemoryReadAddress( 0x1e0000, 0x1effff, input_port_0_r ),
		new MemoryReadAddress( -1 )  /* end of table */
	};
	...
	static MemoryWriteAddress trisport_writemem[] =
	{
		new MemoryWriteAddress( 0x000000, 0x03ffff, MWA_ROM ),
		new MemoryWriteAddress( 0x100000, 0x103fff, MWA_BANK2 ),
		new MemoryWriteAddress( 0x120000, 0x12007f, mcr68_paletteram_w, paletteram ),
		new MemoryWriteAddress( 0x140000, 0x1407ff, MWA_BANK3, spriteram, spriteram_size ),
		new MemoryWriteAddress( 0x160000, 0x160fff, mcr68_videoram_w, videoram, videoram_size ),
		new MemoryWriteAddress( 0x180000, 0x18000f, mcr68_6840_upper_w ),
		new MemoryWriteAddress( 0x1a0000, 0x1affff, MWA_NOP, control_word ),
		new MemoryWriteAddress( 0x1c0000, 0x1cffff, watchdog_reset_w ),
		new MemoryWriteAddress( -1 )  /* end of table */
	};

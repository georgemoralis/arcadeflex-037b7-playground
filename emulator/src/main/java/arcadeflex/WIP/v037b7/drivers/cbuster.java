...
import static arcadeflex.WIP.v037b7.vidhrdw.cbuster.*;
...
import static gr.codebb.arcadeflex.WIP.v037b7.cpu.h6280.h6280.*;
import static gr.codebb.arcadeflex.WIP.v037b7.cpu.h6280.h6280H.*;
import static gr.codebb.arcadeflex.old.arcadeflex.osdepend.logerror;

public class cbuster
{
	static UBytePtr twocrude_ram = new UBytePtr();
	static int prot;
	
	/******************************************************************************/
	
	public static WriteHandlerPtr twocrude_control_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		switch (offset) {
		case 0: /* DMA flag */
			twocrude_update_sprites_w.handler(0,0);
			return;
	...
	public static ReadHandlerPtr twocrude_control_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
		switch (offset)
		{
	...
	public static ReadHandlerPtr twocrude_pf1_data_r  = new ReadHandlerPtr() { public int handler(int offset) { return twocrude_pf1_data.READ_WORD(offset);} };
	public static ReadHandlerPtr twocrude_pf2_data_r  = new ReadHandlerPtr() { public int handler(int offset) { return twocrude_pf2_data.READ_WORD(offset);} };
	public static ReadHandlerPtr twocrude_pf3_data_r  = new ReadHandlerPtr() { public int handler(int offset) { return twocrude_pf3_data.READ_WORD(offset);} };
	public static ReadHandlerPtr twocrude_pf4_data_r  = new ReadHandlerPtr() { public int handler(int offset) { return twocrude_pf4_data.READ_WORD(offset);} };
	public static ReadHandlerPtr twocrude_pf1_rowscroll_r  = new ReadHandlerPtr() { public int handler(int offset) { return twocrude_pf1_rowscroll.READ_WORD(offset);} };
	public static ReadHandlerPtr twocrude_pf2_rowscroll_r  = new ReadHandlerPtr() { public int handler(int offset) { return twocrude_pf2_rowscroll.READ_WORD(offset);} };
	public static ReadHandlerPtr twocrude_pf3_rowscroll_r  = new ReadHandlerPtr() { public int handler(int offset) { return twocrude_pf3_rowscroll.READ_WORD(offset);} };
	public static ReadHandlerPtr twocrude_pf4_rowscroll_r  = new ReadHandlerPtr() { public int handler(int offset) { return twocrude_pf4_rowscroll.READ_WORD(offset);} };
	
	/******************************************************************************/
	
	static MemoryReadAddress twocrude_readmem[] =
	{
		new MemoryReadAddress( 0x000000, 0x07ffff, MRA_ROM ),
		new MemoryReadAddress( 0x080000, 0x083fff, MRA_BANK1 ),
	
		new MemoryReadAddress( 0x0a0000, 0x0a1fff, twocrude_pf1_data_r ),
		new MemoryReadAddress( 0x0a2000, 0x0a2fff, twocrude_pf4_data_r ),
		new MemoryReadAddress( 0x0a4000, 0x0a47ff, twocrude_pf1_rowscroll_r ),
		new MemoryReadAddress( 0x0a6000, 0x0a67ff, twocrude_pf4_rowscroll_r ),
	
		new MemoryReadAddress( 0x0a8000, 0x0a8fff, twocrude_pf3_data_r ),
		new MemoryReadAddress( 0x0aa000, 0x0aafff, twocrude_pf2_data_r ),
		new MemoryReadAddress( 0x0ac000, 0x0ac7ff, twocrude_pf3_rowscroll_r ),
		new MemoryReadAddress( 0x0ae000, 0x0ae7ff, twocrude_pf2_rowscroll_r ),
	
		new MemoryReadAddress( 0x0b0000, 0x0b07ff, MRA_BANK2 ),
		new MemoryReadAddress( 0x0b8000, 0x0b8fff, twocrude_palette_24bit_rg_r ),
		new MemoryReadAddress( 0x0b9000, 0x0b9fff, twocrude_palette_24bit_b_r ),
		new MemoryReadAddress( 0x0bc000, 0x0bc00f, twocrude_control_r ),
		new MemoryReadAddress( -1 )  /* end of table */
	};
	
	static MemoryWriteAddress twocrude_writemem[] =
	{
		new MemoryWriteAddress( 0x000000, 0x07ffff, MWA_ROM ),
		new MemoryWriteAddress( 0x080000, 0x083fff, MWA_BANK1, twocrude_ram ),
	
		new MemoryWriteAddress( 0x0a0000, 0x0a1fff, twocrude_pf1_data_w, twocrude_pf1_data ),
		new MemoryWriteAddress( 0x0a2000, 0x0a2fff, twocrude_pf4_data_w, twocrude_pf4_data ),
		new MemoryWriteAddress( 0x0a4000, 0x0a47ff, twocrude_pf1_rowscroll_w, twocrude_pf1_rowscroll ),
		new MemoryWriteAddress( 0x0a6000, 0x0a67ff, twocrude_pf4_rowscroll_w, twocrude_pf4_rowscroll ),
	
		new MemoryWriteAddress( 0x0a8000, 0x0a8fff, twocrude_pf3_data_w, twocrude_pf3_data ),
		new MemoryWriteAddress( 0x0aa000, 0x0aafff, twocrude_pf2_data_w, twocrude_pf2_data ),
		new MemoryWriteAddress( 0x0ac000, 0x0ac7ff, twocrude_pf3_rowscroll_w, twocrude_pf3_rowscroll ),
		new MemoryWriteAddress( 0x0ae000, 0x0ae7ff, twocrude_pf2_rowscroll_w, twocrude_pf2_rowscroll ),
	
		new MemoryWriteAddress( 0x0b0000, 0x0b07ff, MWA_BANK2, spriteram ),
		new MemoryWriteAddress( 0x0b4000, 0x0b4001, MWA_NOP ),
		new MemoryWriteAddress( 0x0b5000, 0x0b500f, twocrude_control_1_w ),
		new MemoryWriteAddress( 0x0b6000, 0x0b600f, twocrude_control_0_w ),
		new MemoryWriteAddress( 0x0b8000, 0x0b8fff, twocrude_palette_24bit_rg_w, paletteram ),
		new MemoryWriteAddress( 0x0b9000, 0x0b9fff, twocrude_palette_24bit_b_w, paletteram_2 ),
		new MemoryWriteAddress( 0x0bc000, 0x0bc00f, twocrude_control_w ),
	...
	public static InitDriverPtr init_twocrude = new InitDriverPtr() { public void handler() 
	{
...
/*TODO*///	#ifdef LSB_FIRST
			RAM.write(i+1, (RAM.read(i+1) & 0xcf) | ((RAM.read(i+1) & 0x10) << 1) | ((RAM.read(i+1) & 0x20) >> 1));
			RAM.write(i+1, (RAM.read(i+1) & 0x5f) | ((RAM.read(i+1) & 0x20) << 2) | ((RAM.read(i+1) & 0x80) >> 2));
	
			RAM.write(i, (RAM.read(i) & 0xbd) | ((RAM.read(i) & 0x2) << 5) | ((RAM.read(i) & 0x40) >> 5));
			RAM.write(i, (RAM.read(i) & 0xf5) | ((RAM.read(i) & 0x2) << 2) | ((RAM.read(i) & 0x8) >> 2));
/*TODO*///	#else
/*TODO*///			RAM[i]=(RAM[i] & 0xcf) | ((RAM[i] & 0x10) << 1) | ((RAM[i] & 0x20) >> 1);
/*TODO*///			RAM[i]=(RAM[i] & 0x5f) | ((RAM[i] & 0x20) << 2) | ((RAM[i] & 0x80) >> 2);
/*TODO*///	
/*TODO*///			RAM[i+1]=(RAM[i+1] & 0xbd) | ((RAM[i+1] & 0x2) << 5) | ((RAM[i+1] & 0x40) >> 5);
/*TODO*///			RAM[i+1]=(RAM[i+1] & 0xf5) | ((RAM[i+1] & 0x2) << 2) | ((RAM[i+1] & 0x8) >> 2);
/*TODO*///	#endif
		}
	
		/* Rearrange the 'extra' sprite bank to be in the same format as main sprites */
		RAM = new UBytePtr(memory_region(REGION_GFX4), 0x080000);
		PTR = new UBytePtr(memory_region(REGION_GFX4), 0x140000);
		for (i=0; i<0x20000; i+=64) {
			for (j=0; j<16; j+=1) { /* Copy 16 lines down */
				RAM.write(i+      0+j*2, PTR.read(i/2+      0+j)); /* Pixels 0-7 for each plane */
				RAM.write(i+      1+j*2, PTR.read(i/2+0x10000+j));
				RAM.write(i+0xa0000+j*2, PTR.read(i/2+0x20000+j));
				RAM.write(i+0xa0001+j*2, PTR.read(i/2+0x30000+j));
			}
	
			for (j=0; j<16; j+=1) { /* Copy 16 lines down */
				RAM.write(i+   0x20+j*2, PTR.read(i/2+   0x10+j)); /* Pixels 8-15 for each plane */
				RAM.write(i+   0x21+j*2, PTR.read(i/2+0x10010+j));
				RAM.write(i+0xa0020+j*2, PTR.read(i/2+0x20010+j));
				RAM.write(i+0xa0021+j*2, PTR.read(i/2+0x30010+j));
			}
		}
	} };

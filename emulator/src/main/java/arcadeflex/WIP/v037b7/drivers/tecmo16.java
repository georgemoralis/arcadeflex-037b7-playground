...
import static arcadeflex.WIP.v037b7.vidhrdw.tecmo16.*;
import static gr.codebb.arcadeflex.WIP.v037b7.drivers.dec8.irqhandler;
...
public class tecmo16 {
    ...
    public static WriteHandlerPtr tecmo16_sound_command_w = new WriteHandlerPtr() {
     ...
     * ***************************************************************************
     */
    static InputPortPtr input_ports_fstarfrc = new InputPortPtr() {
        public void handler() {
            PORT_START();
            /* DIP SW 1 */
    ...
    static InputPortPtr input_ports_ginkun = new InputPortPtr() {
        public void handler() {
            PORT_START();
            /* DIP SW 1 */
            PORT_DIPNAME(0x03, 0x03, DEF_STR("Coin_A"));
     ...
     * ***************************************************************************
     */
    static RomLoadPtr rom_fstarfrc = new RomLoadPtr() {
        public void handler() {
    ...
    static RomLoadPtr rom_ginkun = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(0x80000, REGION_CPU1);

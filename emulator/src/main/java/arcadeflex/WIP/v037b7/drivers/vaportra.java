...
import static arcadeflex.WIP.v037b7.vidhrdw.vaportra.*;
...
public class vaportra
{
        ...
        static UBytePtr vaportra_ram = new UBytePtr();
	...
	{
		int pc=cpu_get_pc();
		int ret=vaportra_ram.READ_WORD(0x6);
	...
	public static InitDriverPtr init_vaportra = new InitDriverPtr() { public void handler() 
	{

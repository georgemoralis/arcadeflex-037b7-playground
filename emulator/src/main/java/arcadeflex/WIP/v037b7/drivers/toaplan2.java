...
import static arcadeflex.WIP.v037b7.vidhrdw.toaplan2.*;
...
public class toaplan2
{
	...
	/**************** Machine stuff ******************/
	public static final int HD64x180 = 0;		/* Define if CPU support is available */
	public static final int Zx80     = 0;
	...
	static UBytePtr raizing_shared_ram = new UBytePtr();	/* Added by Yochizo */
	static UBytePtr Zx80_shared_ram = new UBytePtr();
	
	static int mcu_data = 0;
	public static int toaplan2_sub_cpu = 0;
	static int old_p1_paddle_h;
	static int old_p1_paddle_v;
	static int old_p2_paddle_h;
	static int old_p2_paddle_v;
	...
	public static InitMachinePtr init_toaplan2 = new InitMachinePtr() { public void handler() 
	{
		old_p1_paddle_h = 0;
		old_p1_paddle_v = 0;
		old_p2_paddle_h = 0;
	...
	public static InitMachinePtr init_toaplan3 = new InitMachinePtr() { public void handler() 
	{
		toaplan2_sub_cpu = CPU_2_Zx80;
		mcu_data = 0;
	} };
	
	public static InitMachinePtr init_pipibibs = new InitMachinePtr() { public void handler() 
	{
		toaplan2_sub_cpu = CPU_2_Z80;
	} };
	
	public static InitMachinePtr init_pipibibi = new InitMachinePtr() { public void handler() 
	{
		int A;
		int oldword, newword;
		...
		{
			newword = 0;
			oldword = pipibibi_68k_rom.READ_WORD (A);
			...
			pipibibi_68k_rom.WRITE_WORD (A,newword);
	
			newword = 0;
			oldword = pipibibi_68k_rom.READ_WORD (A+2);
			...
			pipibibi_68k_rom.WRITE_WORD (A+2,newword);
	
			newword = 0;
			oldword = pipibibi_68k_rom.READ_WORD (A+4);
			...
			newword |= ((oldword & 0x8000) >> 3);
			pipibibi_68k_rom.WRITE_WORD (A+4,newword);
	
			newword = 0;
			oldword = pipibibi_68k_rom.READ_WORD (A+6);
			newword |= ((oldword & 0x000f) << 4);
			newword |= ((oldword & 0x00f0) >> 4);
			...
			pipibibi_68k_rom.WRITE_WORD (A+6,newword);
		}
	} };
	
	/* Added by Yochizo 2000/08/16 */
	public static InitMachinePtr init_tatsujn2 = new InitMachinePtr() { public void handler() 
	{
		UBytePtr RAM = new UBytePtr(memory_region(REGION_CPU1));
	
		/* Fix checksum from the source of Raine. */
		RAM.WRITE_WORD(0x2EC10,0x4E71);		// NOP
	
		/* Fix 60000 from the source of Raine. */
		RAM.WRITE_WORD(0x1F6E8,0x4E75);		// RTS
	
		RAM.WRITE_WORD(0x009FE,0x4E71);		// NOP
		RAM.WRITE_WORD(0x01276,0x4E71);		// NOP
		RAM.WRITE_WORD(0x012BA,0x4E71);		// NOP
		RAM.WRITE_WORD(0x03150,0x4E71);		// NOP
		RAM.WRITE_WORD(0x031B4,0x4E71);		// NOP
		RAM.WRITE_WORD(0x0F20C,0x4E71);		// NOP
		RAM.WRITE_WORD(0x1EBFA,0x4E71);		// NOP
		RAM.WRITE_WORD(0x1EC7A,0x4E71);		// NOP
		RAM.WRITE_WORD(0x1ECE8,0x4E71);		// NOP
		RAM.WRITE_WORD(0x1ED00,0x4E71);		// NOP
		RAM.WRITE_WORD(0x1ED5E,0x4E71);		// NOP
		RAM.WRITE_WORD(0x1ED9A,0x4E71);		// NOP
		RAM.WRITE_WORD(0x1EDB2,0x4E71);		// NOP
		RAM.WRITE_WORD(0x1EEA2,0x4E71);		// NOP
		RAM.WRITE_WORD(0x1EEBA,0x4E71);		// NOP
		RAM.WRITE_WORD(0x1EEE6,0x4E71);		// NOP
		RAM.WRITE_WORD(0x1EF72,0x4E71);		// NOP
		RAM.WRITE_WORD(0x1EFD0,0x4E71);		// NOP
		RAM.WRITE_WORD(0x1F028,0x4E71);		// NOP
		RAM.WRITE_WORD(0x1F05E,0x4E71);		// NOP
		RAM.WRITE_WORD(0x1F670,0x4E71);		// NOP
		RAM.WRITE_WORD(0x1F6C0,0x4E71);		// NOP
		RAM.WRITE_WORD(0x1FA08,0x4E71);		// NOP
		RAM.WRITE_WORD(0x1FAA4,0x4E71);		// NOP
		RAM.WRITE_WORD(0x1FADA,0x4E71);		// NOP
		RAM.WRITE_WORD(0x1FBA2,0x4E71);		// NOP
		RAM.WRITE_WORD(0x1FBDC,0x4E71);		// NOP
		RAM.WRITE_WORD(0x1FC1C,0x4E71);		// NOP
		RAM.WRITE_WORD(0x1FC8A,0x4E71);		// NOP
		RAM.WRITE_WORD(0x1FD24,0x4E71);		// NOP
		RAM.WRITE_WORD(0x1FD7A,0x4E71);		// NOP
		RAM.WRITE_WORD(0x2775A,0x4E71);		// NOP
		RAM.WRITE_WORD(0x277D8,0x4E71);		// NOP
		RAM.WRITE_WORD(0x2788C,0x4E71);		// NOP
		RAM.WRITE_WORD(0x278BA,0x4E71);		// NOP
		RAM.WRITE_WORD(0x2EC54,0x4E71);		// NOP
		RAM.WRITE_WORD(0x2EC90,0x4E71);		// NOP
		RAM.WRITE_WORD(0x2ECAC,0x4E71);		// NOP
		RAM.WRITE_WORD(0x2ECCA,0x4E71);		// NOP
		RAM.WRITE_WORD(0x2ECE6,0x4E71);		// NOP
		RAM.WRITE_WORD(0x2ED1E,0x4E71);		// NOP
	
		RAM.WRITE_WORD(0x2EC26,0x4E71);		// NOP
	...
	public static WriteHandlerPtr toaplan2_coin_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		...
		/* The following are coin counts after coin-lock active (faulty coin-lock ?) */
			...
			default:	logerror("Writing unknown command (%04x) to coin controln",data);
						break;
		}
		if (data > 0xf)
		{
			logerror("Writing unknown upper bits command (%04x) to coin controln",data);
		}
	} };
	...
	public static WriteHandlerPtr toaplan2_hd647180_cpu_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		...
		{
			mcu_data = data;
			logerror("PC:%08x Writing command (%04x) to secondary CPU shared portn",cpu_getpreviouspc(),mcu_data);
		}
	} };
	...
	{
		return toaplan2_shared_ram.read(0);
	} };
	...
	public static WriteHandlerPtr ghox_mcu_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		...
		{
			logerror("PC:%08x Writing %08x to HD647180 cpu shared ram status portn",cpu_getpreviouspc(),mcu_data);
		}
	...
	*/
	...
	{
		logerror("PC:%08x writing %04x to Zx80 secondary CPU status port %02xn",cpu_getpreviouspc(),mcu_data,offset/2);
	} };
	...
	*/
	...
	public static WriteHandlerPtr shared_ram_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		...
		{
			toaplan2_shared_ram.WRITE_WORD (offset + 2,data);
			logerror("PC:%08x Writing  (%04x) to secondary CPUn",cpu_getpreviouspc(),data);
	 ...
	 *** This is actually a part of the 68000/Zx80 Shared RAM */
		...
		logerror("PC:%08x reading %08x from Zx80 secondary CPU command/status portn",cpu_getpreviouspc(),mcu_data);
	...
	{
		mcu_data = data;
		logerror("PC:%08x Writing command (%04x) to Zx80 secondary CPU command/status portn",cpu_getpreviouspc(),mcu_data);
	} };
	...
	public static ReadHandlerPtr raizing_shared_ram_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
		...
		return raizing_shared_ram.read(offset);
	...
	public static WriteHandlerPtr raizing_shared_ram_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		...
		raizing_shared_ram.write(offset, data & 0xff);
	} };
...
/*TODO*///	#if Zx80
/*TODO*///		new MemoryReadAddress( 0x21e000, 0x21fbff, shared_ram_r ),			/* $21f000 status port */
/*TODO*///		new MemoryReadAddress( 0x21fc00, 0x21ffff, Zx80_sharedram_r ),		/* 16-bit on 68000 side, 8-bit on Zx80 side */
/*TODO*///	#else
...
/*TODO*///	#if Zx80
/*TODO*///		new MemoryWriteAddress( 0x21e000, 0x21fbff, shared_ram_w, toaplan2_shared_ram ),	/* $21F000 */
/*TODO*///		new MemoryWriteAddress( 0x21fc00, 0x21ffff, Zx80_sharedram_w, Zx80_shared_ram ),	/* 16-bit on 68000 side, 8-bit on Zx80 side */
/*TODO*///	#else
...
/*TODO*///	#if Zx80
/*TODO*///		new MemoryReadAddress( 0x28e000, 0x28fbff, shared_ram_r ),			/* $21f000 status port */
/*TODO*///		new MemoryReadAddress( 0x28fc00, 0x28ffff, Zx80_sharedram_r ),		/* 16-bit on 68000 side, 8-bit on Zx80 side */
/*TODO*///	#else
...
/*TODO*///	#if Zx80
/*TODO*///		new MemoryWriteAddress( 0x28e000, 0x28fbff, shared_ram_w, toaplan2_shared_ram ),	/* $21F000 */
/*TODO*///		new MemoryWriteAddress( 0x28fc00, 0x28ffff, Zx80_sharedram_w, Zx80_shared_ram ),	/* 16-bit on 68000 side, 8-bit on Zx80 side */
/*TODO*///	#else
...
/*TODO*///	#if HD64x180
/*TODO*///	static MemoryReadAddress hd647180_readmem[] =
/*TODO*///	{
/*TODO*///		new MemoryReadAddress( 0x0000, 0x7fff, MRA_ROM ),
/*TODO*///		new MemoryReadAddress( 0xfe00, 0xffff, MRA_RAM ),			/* Internal 512 bytes of RAM */
/*TODO*///		new MemoryReadAddress( -1 )  /* end of table */
/*TODO*///	};
/*TODO*///	
/*TODO*///	static MemoryWriteAddress hd647180_writemem[] =
/*TODO*///	{
/*TODO*///		new MemoryWriteAddress( 0x0000, 0x7fff, MWA_ROM ),
/*TODO*///		new MemoryWriteAddress( 0xfe00, 0xffff, MWA_RAM ),			/* Internal 512 bytes of RAM */
...
/*TODO*///	#if Zx80
/*TODO*///	static MemoryReadAddress Zx80_readmem[] =
/*TODO*///	{
/*TODO*///		new MemoryReadAddress( 0x0000, 0x7fff, MRA_RAM ),
/*TODO*///		new MemoryReadAddress( -1 )  /* end of table */
/*TODO*///	};
/*TODO*///	
/*TODO*///	static MemoryWriteAddress Zx80_writemem[] =
/*TODO*///	{
/*TODO*///		new MemoryWriteAddress( 0x0000, 0x07fff, MWA_RAM, Zx80_sharedram ),
/*TODO*///		new MemoryWriteAddress( -1 )  /* end of table */
/*TODO*///	};
/*TODO*///	#endif
	...
	*****************************************************************************/
	...
	static void  TOAPLAN2_PLAYER_INPUT( int player, int button3 ) {
		PORT_START();  																	
	...
	static void  TOAPLAN2_SYSTEM_INPUTS() {
		PORT_START(); 										
...
/*TODO*///	#else
/*TODO*///	static GfxLayout tatsujn2_textlayout = new GfxLayout
/*TODO*///	(
/*TODO*///		8,8,	/* 8x8 characters */
/*TODO*///		1024,	/* 1024 characters */
/*TODO*///		4,		/* 4 bits per pixel */
/*TODO*///		new int[] { 0, 1, 2, 3 },
/*TODO*///		new int[] { 0, 4, 8, 12, 16, 20, 24, 28 },
...
/*TODO*///	#if HD64x180
/*TODO*///			new MachineCPU(
/*TODO*///				CPU_Z80,			/* HD647180 CPU actually */
/*TODO*///				10000000,			/* 10MHz Oscillator */
/*TODO*///				hd647180_readmem,hd647180_writemem,null,null,
...
/*TODO*///	#if Zx80
/*TODO*///			new MachineCPU(
/*TODO*///				CPU_Z80,			/* Z?80 type Toaplan marked CPU ??? */
/*TODO*///				16000000,			/* 16MHz Oscillator */
/*TODO*///				Zx80_readmem,Zx80_writemem,null,null,
/*TODO*///				ignore_interrupt,0
/*TODO*///			)
/*TODO*///	#endif
		},
...
/*TODO*///			new MachineCPU(
/*TODO*///				CPU_Z80,			/* Z?80 type Toaplan marked CPU ??? */
/*TODO*///				32000000/2,			/* 16MHz , 32MHz Oscillator */
/*TODO*///				Zx80_readmem,Zx80_writemem,0,null,
/*TODO*///				ignore_interrupt,0
/*TODO*///			)
/*TODO*///	#endif
		},
...
/*TODO*///	#if HD64x180
/*TODO*///		ROM_REGION( 0x10000, REGION_CPU2 );		/* Sound 647180 code */
/*TODO*///		/* sound CPU is a HD647180 (Z180) with internal ROM - not yet supported */
/*TODO*///		ROM_LOAD( "hd647180.020", 0x00000, 0x08000, 0x00000000 );
/*TODO*///	#endif
...
/*TODO*///		ROM_REGION( 0x10000, REGION_CPU2 );		/* Sound 647180 code */
/*TODO*///		/* sound CPU is a HD647180 (Z180) with internal ROM - not yet supported */
/*TODO*///		ROM_LOAD( "hd647180.021", 0x00000, 0x08000, 0x00000000 );
/*TODO*///	#endif
...
/*TODO*///	#if Zx80
/*TODO*///		ROM_REGION( 0x10000, REGION_CPU2 );		/* Secondary CPU code */
/*TODO*///		/* Secondary CPU is a Toaplan marked chip ??? */
/*TODO*///	//	ROM_LOAD( "tp022.mcu", 0x00000, 0x08000, 0x00000000 );
/*TODO*///	#endif
...
/*TODO*///	#if Zx80
/*TODO*///		ROM_REGION( 0x10000, REGION_CPU2 );		/* Sound Z?80 code */
/*TODO*///	#else
...
/*TODO*///		ROM_REGION( 0x10000, REGION_CPU2 );		/* Secondary CPU code */
/*TODO*///		/* Secondary CPU is a Toaplan marked chip ??? */
/*TODO*///	//	ROM_LOAD( "tp024.mcu", 0x00000, 0x08000, 0x00000000 );
/*TODO*///	#endif
...
/*TODO*///	#if Zx80
/*TODO*///		ROM_REGION( 0x10000, REGION_CPU2 );		/* Secondary CPU code */
/*TODO*///		/* Secondary CPU is a Toaplan marked chip, (TS-001-Turbo  TOA PLAN) */
/*TODO*///		/* Its a Z?80 of some sort - 94 pin chip. */
/*TODO*///	//	ROM_LOAD( "tp-026.mcu", 0x0000, 0x8000, 0x00000000 );
/*TODO*///	#endif
...
/*TODO*///	#if Zx80
/*TODO*///		ROM_REGION( 0x10000, REGION_CPU2 );		/* Sound CPU code */
/*TODO*///		/* Secondary CPU is a Toaplan marked chip, (TS-007-Spy  TOA PLAN) */
/*TODO*///		/* Its a Z?80 of some sort - 94 pin chip. */
/*TODO*///	//	ROM_LOAD( "tp027.mcu", 0x8000, 0x8000, 0x00000000 );
/*TODO*///	#endif
...
/*TODO*///		/* Secondary CPU is a Toaplan marked chip, (TS-007-Spy  TOA PLAN) */
/*TODO*///		/* Its a Z?80 of some sort - 94 pin chip. */
/*TODO*///	//	ROM_LOAD( "tp030.mcu", 0x8000, 0x8000, 0x00000000 );
/*TODO*///	#endif
...
/*TODO*///	#endif
	...
	public static GameDriver driver_tekipaki	   = new GameDriver("1991"	,"tekipaki"	,"toaplan2.java"	,rom_tekipaki,null	,machine_driver_tekipaki	,input_ports_tekipaki	,null/*init_toaplan2*/	,ROT0	,	"Toaplan", "Teki Paki", GAME_NO_SOUND );
	public static GameDriver driver_ghox	   = new GameDriver("1991"	,"ghox"	,"toaplan2.java"	,rom_ghox,null	,machine_driver_ghox	,input_ports_ghox	,null/*init_toaplan2*/	,ROT270	,	"Toaplan", "Ghox", GAME_NO_SOUND );
	public static GameDriver driver_dogyuun	   = new GameDriver("1991"	,"dogyuun"	,"toaplan2.java"	,rom_dogyuun,null	,machine_driver_dogyuun	,input_ports_dogyuun	,null/*init_toaplan3*/	,ROT270	,	"Toaplan", "Dogyuun", GAME_NO_SOUND );
	public static GameDriver driver_kbash	   = new GameDriver("1993"	,"kbash"	,"toaplan2.java"	,rom_kbash,null	,machine_driver_kbash	,input_ports_kbash	,null/*init_toaplan2*/	,ROT0_16BIT	,	"Toaplan", "Knuckle Bash", GAME_NO_SOUND );
	public static GameDriver driver_tatsujn2	   = new GameDriver("1992"	,"tatsujn2"	,"toaplan2.java"	,rom_tatsujn2,null	,machine_driver_tatsujn2	,input_ports_tatsujn2	,null/*init_tatsujn2*/	,ROT270	,	"Toaplan", "Truxton II / Tatsujin II / Tatsujin Oh (Japan)" );
	public static GameDriver driver_pipibibs	   = new GameDriver("1991"	,"pipibibs"	,"toaplan2.java"	,rom_pipibibs,null	,machine_driver_pipibibs	,input_ports_pipibibs	,null/*init_pipibibs*/	,ROT0	,	"Toaplan", "Pipi & Bibis / Whoopee (Japan)" );
	public static GameDriver driver_whoopee	   = new GameDriver("1991"	,"whoopee"	,"toaplan2.java"	,rom_whoopee,driver_pipibibs	,machine_driver_whoopee	,input_ports_whoopee	,null/*init_pipibibs*/	,ROT0	,	"Toaplan", "Whoopee (Japan) / Pipi & Bibis (World)" );
	public static GameDriver driver_pipibibi	   = new GameDriver("1991"	,"pipibibi"	,"toaplan2.java"	,rom_pipibibi,driver_pipibibs	,machine_driver_pipibibi	,input_ports_pipibibi	,null/*init_pipibibi*/	,ROT0	,	"[Toaplan] Ryouta Kikaku", "Pipi & Bibis / Whoopee (Japan) [bootleg ?]" );
	public static GameDriver driver_fixeight	   = new GameDriver("1992"	,"fixeight"	,"toaplan2.java"	,rom_fixeight,null	,machine_driver_fixeight	,input_ports_vfive	,null/*init_toaplan3*/	,ROT270	,	"Toaplan", "FixEight", GAME_NOT_WORKING );
        public static GameDriver driver_vfive	   = new GameDriver("1993"	,"vfive"	,"toaplan2.java"	,rom_vfive,null	,machine_driver_vfive	,input_ports_vfive	,null/*init_toaplan3*/	,ROT270	,	"Toaplan", "V-Five (Japan)", GAME_NO_SOUND );
	public static GameDriver driver_grindstm	   = new GameDriver("1992"	,"grindstm"	,"toaplan2.java"	,rom_grindstm,driver_vfive	,machine_driver_vfive	,input_ports_grindstm	,null/*init_toaplan3*/	,ROT270	,	"Toaplan", "Grind Stormer", GAME_NO_SOUND );
	public static GameDriver driver_batsugun	   = new GameDriver("1993"	,"batsugun"	,"toaplan2.java"	,rom_batsugun,null	,machine_driver_batsugun	,input_ports_batsugun	,null/*init_toaplan3*/	,ROT270_16BIT	,	"Toaplan", "Batsugun", GAME_NO_SOUND );
	public static GameDriver driver_batugnsp	   = new GameDriver("1993"	,"batugnsp"	,"toaplan2.java"	,rom_batugnsp,driver_batsugun	,machine_driver_batsugun	,input_ports_batsugun	,null/*init_toaplan3*/	,ROT270_16BIT	,	"Toaplan", "Batsugun Special Ver.", GAME_NO_SOUND );

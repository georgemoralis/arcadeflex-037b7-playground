...
import static arcadeflex.WIP.v037b7.sndhrdw.seibu.*;
import arcadeflex.common.ptrLib.UBytePtr;
import static arcadeflex.v037b7.generic.funcPtr.*;
import static gr.codebb.arcadeflex.WIP.v037b7.mame.mame.Machine;
import static arcadeflex.WIP.v037b7.vidhrdw.raiden.*;
...
public class raiden
{
	...
	static UBytePtr raiden_shared_ram = new UBytePtr();
	
	/***************************************************************************/
	
	public static ReadHandlerPtr raiden_shared_r  = new ReadHandlerPtr() { public int handler(int offset) { return raiden_shared_ram.read(offset); } };
	public static WriteHandlerPtr raiden_shared_w = new WriteHandlerPtr() {public void handler(int offset, int data) { raiden_shared_ram.write(offset, data); } };
        
        static int latch=0;
	
	public static ReadHandlerPtr raiden_sound_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
		...
		{/* misusing $d006 as a latch...but it works !*/
			case 0x04:{erg=seibu_shared_sound_ram.read(6);seibu_shared_sound_ram.write(6,0);break;} /* just 1 time */
			case 0x06:{erg=0xa0;break;}
			case 0x0a:{erg=0;break;}
			default: erg=seibu_shared_sound_ram.read(offset);
		}
		return erg;
	} };
	...
	//SEIBU_SOUND_SYSTEM_YM3812_MEMORY_MAP(input_port_4_r); /* Coin port */
        ...
        {																	
                ...
                new MemoryReadAddress( 0x4013, 0x4013, input_port_4_r ), 								
	...
	public static VhEofCallbackPtr raiden_eof_callback = new VhEofCallbackPtr() { public void handler() 
	{
	...
	public static ReadHandlerPtr sub_cpu_spin_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
		...
		if (offset==1) return raiden_shared_ram.read(0x9);
	...
	public static InitDriverPtr init_raiden = new InitDriverPtr() { public void handler() 
	{
	...
	public static InitDriverPtr init_raidenk = new InitDriverPtr() { public void handler() 
	{
		memory_patcha();
		common_decrypt();
	} };
	
	public static InitDriverPtr init_raidena = new InitDriverPtr() { public void handler() 
	{
		memory_patcha();
		common_decrypt();
		seibu_sound_decrypt();

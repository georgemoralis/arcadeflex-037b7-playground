...
import static arcadeflex.WIP.v037b7.vidhrdw.gradius3.*;        
...
public class gradius3
{
	...
	public static WriteHandlerPtr K052109_halfword_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		...
		if ((data & 0x00ff0000) == 0x00ff0000)
			K052109_w.handler(offset >> 1,(data >> 8) & 0xff);
	...
	{
		return K051937_r.handler(offset >> 1);
	} };
	...
	{
		return K051960_r.handler(offset >> 1);
	} };
	...
	static InitMachinePtr gradius3_init = new InitMachinePtr() {
            @Override
            public void handler() {
	...
	{
		return sharedram.READ_WORD(offset);
	} };
	...
	public static WriteHandlerPtr cpuA_ctrl_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		if ((data & 0xff000000) == 0)
		{
			...
			/* bit 3 enables cpu B */
			cpu_set_reset_line(1,(data & 0x08)!=0 ? CLEAR_LINE : ASSERT_LINE);
...
/*TODO*///	#if 0
/*TODO*///		new MemoryReadAddress( 0x140000, 0x140007, K051937_word_r ),
/*TODO*///		new MemoryReadAddress( 0x140400, 0x1407ff, K051960_word_r ),
/*TODO*///	#endif
	...
	***************************************************************************/
	...
	public static InitDriverPtr init_gradius3 = new InitDriverPtr() { public void handler() 
	{

...
import static arcadeflex.WIP.v037b7.vidhrdw.toobin.*;
...
public class toobin
{
	...
	static UBytePtr interrupt_scan = new UBytePtr();
	...
	public static WriteHandlerPtr interrupt_scan_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		int oldword = interrupt_scan.READ_WORD(offset);
		int newword = COMBINE_WORD(oldword, data);
	
		/* if something changed, update the word in memory */
		if (oldword != newword)
		{
			interrupt_scan.WRITE_WORD(offset, newword);
	...
	static MemoryReadAddress main_readmem[] =
	{
		...
		new MemoryReadAddress( 0xc00000, 0xc07fff, MRA_BANK1 ),
		new MemoryReadAddress( 0xc08000, 0xc097ff, MRA_BANK2 ),
		new MemoryReadAddress( 0xc09800, 0xc09fff, MRA_BANK3 ),
		new MemoryReadAddress( 0xc10000, 0xc107ff, paletteram_word_r ),
		new MemoryReadAddress( 0xff6000, 0xff6001, MRA_NOP ),		/* who knows? read at controls time */
		new MemoryReadAddress( 0xff8800, 0xff8801, input_port_0_r ),
		new MemoryReadAddress( 0xff9000, 0xff9001, special_port1_r ),
		new MemoryReadAddress( 0xff9800, 0xff9801, atarigen_sound_r ),
		new MemoryReadAddress( 0xffa000, 0xffafff, atarigen_eeprom_r ),
	...
	static MemoryWriteAddress main_writemem[] =
	{
		...
		new MemoryWriteAddress( 0xc00000, 0xc07fff, toobin_playfieldram_w, atarigen_playfieldram, atarigen_playfieldram_size ),
		new MemoryWriteAddress( 0xc08000, 0xc097ff, MWA_BANK2, atarigen_alpharam, atarigen_alpharam_size ),
		new MemoryWriteAddress( 0xc09800, 0xc09fff, MWA_BANK3, atarigen_spriteram, atarigen_spriteram_size ),
		new MemoryWriteAddress( 0xc10000, 0xc107ff, toobin_paletteram_w, paletteram ),
		new MemoryWriteAddress( 0xff8000, 0xff8001, watchdog_reset_w ),
		new MemoryWriteAddress( 0xff8100, 0xff8101, atarigen_sound_w ),
		new MemoryWriteAddress( 0xff8300, 0xff8301, MWA_BANK4, toobin_intensity ),
		new MemoryWriteAddress( 0xff8340, 0xff8341, interrupt_scan_w, interrupt_scan ),
		new MemoryWriteAddress( 0xff8380, 0xff8381, toobin_moslip_w, toobin_moslip ),
		new MemoryWriteAddress( 0xff83c0, 0xff83c1, atarigen_scanline_int_ack_w ),
		new MemoryWriteAddress( 0xff8400, 0xff8401, atarigen_sound_reset_w ),
		new MemoryWriteAddress( 0xff8500, 0xff8501, atarigen_eeprom_enable_w ),
		new MemoryWriteAddress( 0xff8600, 0xff8601, MWA_BANK5, atarigen_hscroll ),
		new MemoryWriteAddress( 0xff8700, 0xff8701, MWA_BANK6, atarigen_vscroll ),
		new MemoryWriteAddress( 0xffa000, 0xffafff, atarigen_eeprom_w, atarigen_eeprom, atarigen_eeprom_size ),
	...
	(
		...
		16384,	/* 16384 of them */
		4,		/* 4 bits per pixel */
		new int[] { 256*1024*8, 256*1024*8+4, 0, 4 },
		new int[] { 0, 1, 2, 3, 8, 9, 10, 11 },
		new int[] { 0*16, 1*16, 2*16, 3*16, 4*16, 5*16, 6*16, 7*16 },
	...
	(
		...
		16384,	/* 16384 of them */
		4,		/* 4 bits per pixel */
		new int[] { 1024*1024*8, 1024*1024*8+4, 0, 4 },
	...
	public static InitDriverPtr init_toobin = new InitDriverPtr() { public void handler() 
	{

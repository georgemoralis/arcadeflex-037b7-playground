...
public class qix {
    ...
    public static ReadHandlerPtr qix_sharedram_r = new ReadHandlerPtr() {
    ...
    public static WriteHandlerPtr zoo_bankswitch_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
    ...
    public static InitMachinePtr withmcu_init_machine = new InitMachinePtr() {
        public void handler() {
            suspended = 0;
    ...
    public static InitMachinePtr zoo_init_machine = new InitMachinePtr() {
        public void handler() {
     ...
     * *************************************************************************
     */
    public static WriteHandlerPtr qix_dac_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            DAC_data_w.handler(0, data);
        }
    };

    public static ReadHandlerPtr qix_sound_r = new ReadHandlerPtr() {
        public int handler(int offset) {
    ...
    public static IrqfuncPtr qix_pia_dint = new IrqfuncPtr() {
        public void handler(int state) {
            /* not used by Qix, but others might use it; depends on a jumper on the PCB */
        }
    };
    public static IrqfuncPtr qix_pia_sint = new IrqfuncPtr() {
        public void handler(int state) {
 ...
 /* sound in Qix */
    ...
    public static ReadHandlerPtr sdungeon_68705_portA_r = new ReadHandlerPtr() {
        public int handler(int offset) {
    ...
    public static WriteHandlerPtr sdungeon_68705_portA_w = new WriteHandlerPtr() {
        public void handler(int offest, int data) {
            //logerror("PC: %x SD COINTOMAIN W: %x\n",cpu_get_pc(),data);
            portA_out = (char) (data & 0xFF);
        }
    };

    public static WriteHandlerPtr sdungeon_68705_ddrA_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            ddrA = (char) (data & 0xFF);
        }
    };

    public static ReadHandlerPtr sdungeon_68705_portB_r = new ReadHandlerPtr() {
        public int handler(int offset) {
    ...
    public static WriteHandlerPtr sdungeon_68705_portB_w = new WriteHandlerPtr() {
        public void handler(int offest, int data) {
    ...
    public static WriteHandlerPtr sdungeon_68705_ddrB_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            ddrB = (char) (data & 0xFF);
        }
    };

    public static ReadHandlerPtr sdungeon_68705_portC_r = new ReadHandlerPtr() {
        public int handler(int offset) {
    ...
    public static WriteHandlerPtr sdungeon_68705_portC_w = new WriteHandlerPtr() {
        public void handler(int offest, int data) {
    ...
    public static WriteHandlerPtr sdungeon_68705_ddrC_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            ddrC = (char) (data & 0xFF);
        }
    };

    public static ReadHandlerPtr sdungeon_coin_r = new ReadHandlerPtr() {
        public int handler(int offset) {
            return portA_out;
        }
    };

    public static WriteHandlerPtr sdungeon_coin_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
 ...
 /* the CPUs - they have already been synchronized by sdungeon_pia_0_w() */
    ...
    public static WriteHandlerPtr sdungeon_coinctrl_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
 ...
 /* the CPUs - they have already been synchronized by sdungeon_pia_0_w() */
    ...
    public static timer_callback pia_0_w_callback = new timer_callback() {
    ...
    public static WriteHandlerPtr sdungeon_pia_0_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
 ...
 /* otherwise the 68705 will miss commands */
     ...
     * <p>
     * PIA 1 = U11: port A = external input (input_port_0) port B = external
     * input (input_port_1) (coin) PIA 2 = U20: port A = external input (???)
     * port B = external input (???) PIA 3 = U30: port A = external input (???)
     * port B = external input (???)
     * <p>
     * <p>
     * From the data/sound processor schematic:
     * <p>
     * PIA 4 = U20: port A = data CPU to sound CPU communication port B = some
     * kind of sound control CA1 = interrupt signal from sound CPU CA2 =
     * interrupt signal to sound CPU PIA 5 = U8: port A = sound CPU to data CPU
     * communication port B = DAC value (port B) CA1 = interrupt signal from
     * data CPU CA2 = interrupt signal to data CPU PIA 6 = U7: (never actually
     * used) port A = unused port B = sound CPU to TMS5220 communication CA1 =
     * interrupt signal from TMS5220 CA2 = write signal to TMS5220 CB1 = ready
     * signal from TMS5220 CB2 = read signal to TMS5220
     * *************************************************************************
     */

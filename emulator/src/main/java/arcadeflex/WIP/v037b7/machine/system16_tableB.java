...
import static arcadeflex.WIP.v037b7.machine.system16.system16_decode;
import static arcadeflex.WIP.v037b7.machine.system16_tableC.*;
import arcadeflex.common.ptrLib;
import arcadeflex.common.ptrLib.UBytePtr;

public class system16_tableB {
    /***********************************************************************************
	      Decryption Tables for Endurob2
	***********************************************************************************/
	public static int enduroracer_decrypt_data[][]=
	{
	...
	public static int enduroracer_decrypt_data2[][]=
	{
	{
	...
	{
		system16_decode(dest,source,size,enduroracer_decrypt_data);
	}
	...
	{
		system16_decode(dest,source,size,enduroracer_decrypt_data2);
	}
	
	
	
	public static void enduror_decode_data(ptrLib.UBytePtr dest,ptrLib.UBytePtr source,int size)
	{
		system16_decode(dest,source,size,enduroracer_decrypt_data3);
	}
	
	public static void enduror_decode_data2(ptrLib.UBytePtr dest,ptrLib.UBytePtr source,int size)
	{
		system16_decode(dest,source,size,enduroracer_decrypt_data4);
	}    
}

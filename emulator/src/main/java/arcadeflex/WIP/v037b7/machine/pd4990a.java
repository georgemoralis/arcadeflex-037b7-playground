...
public class pd4990a
{
	...
	public static int seconds=0x00;		/* BCD */
	public static int minutes=0x00;		/* BCD */
	public static int hours=0x00;		/* BCD */
	public static int days=0x09;		/* BCD */
	public static int month=9;		/* Hexadecimal form */
	public static int year=0x73;		/* BCD */
	public static int weekday=1;		/* BCD */
	
	public static int retraces=0;			/* Assumes 60 retraces a second */
	public static int coinflip=0;			/* Pulses a bit in order to simulate */
						/* test output */
	public static int outputbit=0;
	public static int bitno=0;
	
	public static void addretrace () {
		coinflip ^= 1;
		retraces++;
		if (retraces == 60) {
			retraces = 0;
	...
	public static void	increment_day()
	{
		...
		case	2:
			...
			if ((real_year%4)!=0)	/* There are some rare exceptions, but I don't care ... */
			{
				if (days==0x29)
				{
					days=1;
	...
	public static int read_4990_testbit() {
		return (coinflip);
	}
	
	public static int read_4990_databit()
	{
		return (outputbit);
	}

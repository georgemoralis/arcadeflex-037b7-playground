...
import static arcadeflex.WIP.v037b7.machine.system16_tableA.*;
import arcadeflex.common.ptrLib.UBytePtr;

public class system16
{
	
        public static void system16_decode(UBytePtr dest,UBytePtr source,int size,int[][] decrypt_data)
	{
		int offset,data,decode_offset,mask;
	
		for(offset=0;offset<size;offset+=2)
		{
			data=source.READ_WORD(offset);
			...
			data^= decrypt_data[mask][decode_offset];
	...
	public static int aurail_decrypt_opcode1[][]={
	{
	...
	public static int aurail_decrypt_opcode2[][]={
	{
	...
	public static void aurail_decode_data(UBytePtr dest,UBytePtr source,int size)
	{
		system16_decode(dest,source,size,aurail_decrypt_data);
	}
	
	public static void aurail_decode_opcode1(UBytePtr dest,UBytePtr source,int size)
	{
		system16_decode(dest,source,size,aurail_decrypt_opcode1);
	}
	
	public static void aurail_decode_opcode2(UBytePtr dest,UBytePtr source,int size)
	{
		system16_decode(dest,source,size,aurail_decrypt_opcode2);
	}
}

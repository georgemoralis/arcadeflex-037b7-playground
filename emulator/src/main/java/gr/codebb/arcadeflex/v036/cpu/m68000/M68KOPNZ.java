...
/*TODO*///
    public static opcode m68000_or_er_al_32 = new opcode() {
        public void handler() {
            set_DX(get_DX() | m68ki_read_32(EA_AL()));

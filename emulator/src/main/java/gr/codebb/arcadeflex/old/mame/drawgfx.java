...
import static arcadeflex.v037b7.mame.drawgfx.blockmove_8toN_transmask_pri8;
import static arcadeflex.v037b7.mame.drawgfx.blockmove_8toN_transmask_pri_flipx8;
 ...
 /*          gfx.pen_usage[num] = 0;
    ...
    public static void blockmove_NtoN_transpen_noremap8(
        ...
        while (srcheight != 0) {
            ...
            srcdata=new UBytePtr(sd4.readCA(), sd4.getBase());

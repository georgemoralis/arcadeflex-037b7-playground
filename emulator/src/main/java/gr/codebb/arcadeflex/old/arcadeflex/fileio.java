...
import static gr.codebb.arcadeflex.v037b7.platform.fileio.*;
...
/*TODO*///                    break;
            ...
            case OSD_FILETYPE_HISTORY:
                ...
                f.file = fopen(filename, _write != 0 ? "w" : "r");
                found = f.file != null ? 1 : 0;
                break;
        }
    ...
    public static int osd_fwrite(Object file, char[] buffer, int length) {
    ...
    public static void osd_setScanner(Object file)
    {
        FakeFileHandle f = (FakeFileHandle) file;
    ...
    public static char osd_fgetc(Object file) {
        ...
        if (f.type == kPlainFile && f.file != null) {
            ...
            throw new UnsupportedOperationException("Not supported");//return EOF;
        }
    }

    public static int osd_feof(Object file) {
        FakeFileHandle f = (FakeFileHandle) file;

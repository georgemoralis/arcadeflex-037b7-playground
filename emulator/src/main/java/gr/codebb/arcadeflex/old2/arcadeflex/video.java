...
import gr.codebb.arcadeflex.old.arcadeflex.software_gfx;
...
public class video {
  ...
  //
  /*TODO*/
  // static void (*updaters16_palettized[MAX_X_MULTIPLY][MAX_Y_MULTIPLY][2][2])(struct osd_bitmap
  // *bitmap) =
  /*TODO*/
  // {			/* 1 x 1 */
  /*TODO*/
  //	{	{	{ blitscreen_dirty0_vesa_1x_1x_16bpp_palettized,
  // blitscreen_dirty1_vesa_1x_1x_16bpp_palettized },
  /*TODO*/
  //			{ blitscreen_dirty0_vesa_1x_1x_16bpp_palettized,
  // blitscreen_dirty1_vesa_1x_1x_16bpp_palettized }
  /*TODO*/
  //		},	/* 1 x 2 */
  /*TODO*/
  //		{	{ blitscreen_dirty0_vesa_1x_2x_16bpp_palettized,
  // blitscreen_dirty1_vesa_1x_2x_16bpp_palettized },
  /*TODO*/
  //			{ blitscreen_dirty0_vesa_1x_2xs_16bpp_palettized,
  // blitscreen_dirty1_vesa_1x_2xs_16bpp_palettized }
  /*TODO*/
  //		},	/* 1 x 3 */
  /*TODO*/
  //		{	{ update_screen_dummy, update_screen_dummy },
  ...
  //	},		/* 2 x 1 */
  /*TODO*/
  //	{	{	{ blitscreen_dirty0_vesa_2x_1x_16bpp_palettized,
  // blitscreen_dirty1_vesa_2x_1x_16bpp_palettized },
  /*TODO*/
  //			{ blitscreen_dirty0_vesa_2x_1x_16bpp_palettized,
  // blitscreen_dirty1_vesa_2x_1x_16bpp_palettized }
  /*TODO*/
  //		},	/* 2 x 2 */
  /*TODO*/
  //		{	{ blitscreen_dirty0_vesa_2x_2x_16bpp_palettized,
  // blitscreen_dirty1_vesa_2x_2x_16bpp_palettized },
  /*TODO*/
  //			{ blitscreen_dirty0_vesa_2x_2xs_16bpp_palettized,
  // blitscreen_dirty1_vesa_2x_2xs_16bpp_palettized }
  /*TODO*/
  //		},	/* 2 x 3 */
  /*TODO*/
  //		{	{ blitscreen_dirty0_vesa_2x_3x_16bpp_palettized,
  // blitscreen_dirty1_vesa_2x_3x_16bpp_palettized },
  /*TODO*/
  //			{ blitscreen_dirty0_vesa_2x_3xs_16bpp_palettized,
  // blitscreen_dirty1_vesa_2x_3xs_16bpp_palettized }
  /*TODO*/
  //		}
  /*TODO*/
  //	},		/* 3 x 1 */
  /*TODO*/
  //	{	{	{ blitscreen_dirty0_vesa_3x_1x_16bpp_palettized,
  // blitscreen_dirty1_vesa_3x_1x_16bpp_palettized },
  /*TODO*/
  //			{ update_screen_dummy, update_screen_dummy }
  /*TODO*/
  //		},	/* 3 x 2 */
  /*TODO*/
  //		{	{ blitscreen_dirty0_vesa_3x_2x_16bpp_palettized,
  // blitscreen_dirty1_vesa_3x_2x_16bpp_palettized },
  /*TODO*/
  //			{ blitscreen_dirty0_vesa_3x_2xs_16bpp_palettized,
  // blitscreen_dirty1_vesa_3x_2xs_16bpp_palettized }
  /*TODO*/
  //		},	/* 3 x 3 */
  /*TODO*/
  //		{	{ blitscreen_dirty0_vesa_3x_3x_16bpp_palettized,
  // blitscreen_dirty1_vesa_3x_3x_16bpp_palettized },
  /*TODO*/
  //			{ blitscreen_dirty0_vesa_3x_3xs_16bpp_palettized,
  // blitscreen_dirty1_vesa_3x_3xs_16bpp_palettized }
  /*TODO*/
  //		}
  /*TODO*/
  //	},		/* 4 x 1 */
  ...
  //		},	/* 4 x 2 */
  /*TODO*/
  //		{	{ blitscreen_dirty0_vesa_4x_2x_16bpp_palettized,
  // blitscreen_dirty1_vesa_4x_2x_16bpp_palettized },
  /*TODO*/
  //			{ blitscreen_dirty0_vesa_4x_2xs_16bpp_palettized,
  // blitscreen_dirty1_vesa_4x_2xs_16bpp_palettized }
  /*TODO*/
  //		},	/* 4 x 3 */
  /*TODO*/
  //		{	{ blitscreen_dirty0_vesa_4x_3x_16bpp_palettized,
  // blitscreen_dirty1_vesa_4x_3x_16bpp_palettized },
  /*TODO*/
  //			{ blitscreen_dirty0_vesa_4x_3xs_16bpp_palettized,
  // blitscreen_dirty1_vesa_4x_3xs_16bpp_palettized }
  /*TODO*/
  //		}
  /*TODO*/
  //	}
  ...
  //
  /*TODO*/
  // struct vga_tweak { int x, y; Register *reg; int reglen; int syncvgafreq; int unchained; int
  // vertical_mode; };
  /*TODO*/
  ...
  // };
  /*TODO*/
  // struct mode_adjust  {int x, y; unsigned char *hadjust; unsigned char *vadjust; int
  // vertical_mode; };
  /*TODO*/
  //
  /*TODO*/
  ...
  /*TODO*/
  /// * force 384 games to match to 368 modes - the standard VGA clock speeds mean we can't go as
  // wide as 384 */
  /*TODO*/
  ...
  public static void internal_set_visible_area(
      int min_x, int max_x, int min_y, int max_y, int debugger) {
    int act_width;
      ...
      if (use_vesa != 0 && vector_game == 0) {
        if (stretch != 0) {
          if (((video_orientation & ORIENTATION_SWAP_XY) == 0)
            ...
            while ((xmultiply + 1) * viswidth <= tw && (ymultiply + 1) * visheight <= th) {
              xmultiply++;
              ymultiply++;
            }
          ...
          /* Hack for 320x480 and 400x600 "vmame" video modes */
          if ((gfx_width == 320 && gfx_height == 480) || (gfx_width == 400 && gfx_height == 600)) {
            ymultiply *= 2;
          }
        }
      }
    ...
    set_ui_visarea(
        skipcolumns,
        skiplines,
        skipcolumns + gfx_display_columns - 1,
        skiplines + gfx_display_lines - 1);
  ...
  /*TODO*/
  //					err =
  // set_gfx_mode(mode,gfx_width,gfx_height,SVGA15KHzdriver->getlogicalwidth(gfx_width),0);
  /*TODO*/
  //				else
  /*TODO*/
  ...
  /*TODO*/
  //				update_screen =
  // updaters16_palettized[xmultiply-1][ymultiply-1][scanlines?1:0][use_dirty?1:0];
  /*TODO*/
  ...
  // {
  /*TODO*/
  //	logerror("msdos/video.c: undefined update_screen() function for %d x
  // %d!\n",xmultiply,ymultiply);
  /*TODO*/
  // }
  /*TODO*/
  ...
  //
  /*TODO*/
  //		set_ui_visarea (skipcolumns, skiplines, skipcolumns+gfx_display_columns-1,
  // skiplines+gfx_display_lines-1);
  /*TODO*/
  //	}
  /*TODO*/
  ...
  /// * Update the display. */
  /*TODO*/
  // void osd_update_video_and_audio(struct osd_bitmap *game_bitmap,struct osd_bitmap
  // *debug_bitmap,int leds_status)
  /*TODO*/
  // {
  /*TODO*/
  ...
  /*TODO*/
  //			sprintf(buf,"%s%2d%4d%%%4d/%d
  // fps",autoframeskip?"auto":"fskp",frameskip,speed,fps,(int)(video_fps+0.5));
  /*TODO*/
  ...
  //				{
  /*TODO*/
  //					float rate = brightness * brightness_paused_adjust * pow(i / 255.0, 1 /
  // osd_gamma_correction) / 100;
  /*TODO*/
  ...
  //
  /*TODO*/
  //		/* see if we need to give the card enough time to draw both odd/even fields of the interlaced
  // display
  /*TODO*/
  ...
  /*TODO*/
  //		vrsin = inreg[V_RETRACE_START_INDEX].value | ((overflow & 0x04)<<0x06) | ((overflow &
  // 0x80)<<0x02);
  /*TODO*/
  //		vrsout = vrsin >> 1;
  /*TODO*/
  ...
  public static void tempCreation() {
    ...
    if (onlyone == 0) {
      ...
      screen.run();
      screen.setLocation(
          (int) ((localDimension.getWidth() - screen.getWidth()) / 2.0D),
          (int) ((localDimension.getHeight() - screen.getHeight()) / 2.0D));

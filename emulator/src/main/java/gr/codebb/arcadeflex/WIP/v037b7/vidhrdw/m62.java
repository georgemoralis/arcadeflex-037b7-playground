...
public class m62 {
    ...
    public static VhConvertColorPromPtr irem_vh_convert_color_prom = new VhConvertColorPromPtr() {
        public void handler(char[] palette, char[] colortable, UBytePtr color_prom) {
            ...
            sprite_height_prom = new UBytePtr(color_prom, 0);
    ...
    public static VhStartPtr ldrun_vh_start = new VhStartPtr() {
        public int handler() {
    ...
    public static VhStartPtr kidniki_vh_start = new VhStartPtr() {
        public int handler() {
            return irem_vh_start(512, 256);
        }
    };

    public static VhStartPtr spelunkr_vh_start = new VhStartPtr() {
        public int handler() {
            return irem_vh_start(512, 512);
        }
    };

    public static WriteHandlerPtr irem_flipscreen_w = new WriteHandlerPtr() {
    ...
    public static WriteHandlerPtr irem_background_hscroll_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            switch (offset) {
                case 0:
    ...
    public static WriteHandlerPtr kungfum_scroll_low_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            irem_background_hscroll_w.handler(0, data);
        }
    };
    public static WriteHandlerPtr kungfum_scroll_high_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            irem_background_hscroll_w.handler(1, data);
        }
    };

    public static WriteHandlerPtr irem_background_vscroll_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            switch (offset) {
                case 0:
    ...
    public static WriteHandlerPtr battroad_scroll_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            switch (offset) {
                case 0:
    ...
    public static WriteHandlerPtr ldrun3_vscroll_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            irem_background_vscroll = data;
        }
    };

    public static WriteHandlerPtr ldrun4_hscroll_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            irem_background_hscroll_w.handler(offset ^ 1, data);
        }
    };

    public static WriteHandlerPtr kidniki_text_vscroll_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            switch (offset) {
                case 0:
    ...
    public static WriteHandlerPtr kidniki_background_bank_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
    ...
    public static WriteHandlerPtr spelunkr_palbank_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
    ...
    public static WriteHandlerPtr spelunk2_gfxport_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            switch (offset) {
                case 0:
                    irem_background_vscroll_w.handler(0, data);
    ...
    static void draw_sprites(osd_bitmap bitmap) {
        ...
        for (offs = 0; offs < spriteram_size[0]; offs += 8) {
            ...
            if (flipscreen != 0) {
                sx = 496 - sx;
                sy = 242 - i * 16 - sy;
                /* sprites are slightly misplaced by the hardware */
                flipx = NOT(flipx);
                flipy = NOT(flipy);
            }
    ...
    static void kungfum_draw_background(osd_bitmap bitmap,int prioritylayer)
{
	int offs,i;
 ...
 /* since last time and update it accordingly. */
...

        {
            ...
            if (prioritylayer != 0) {
                copyscrollbitmap(bitmap, tmpbitmap, 0, null, 1, new int[]{scrolly}, Machine.visible_area, TRANSPARENCY_PEN, Machine.pens[0]);
            } else {
 ...
 /* since last time and update it accordingly. */
...

        {
            ...
            copyscrollbitmap(bitmap, tmpbitmap, 1, new int[]{scrollx}, 0, null, Machine.visible_area, TRANSPARENCY_NONE, 0);
        }
    }
 ...
 /* since last time and update it accordingly. */
    ...
    public static VhUpdatePtr kungfum_vh_screenrefresh = new VhUpdatePtr() {
    ...
    public static VhUpdatePtr battroad_vh_screenrefresh = new VhUpdatePtr() {
        public void handler(osd_bitmap bitmap, int full_refresh) {
    ...
    public static VhUpdatePtr ldrun_vh_screenrefresh = new VhUpdatePtr() {
        public void handler(osd_bitmap bitmap, int full_refresh) {
    ...
    public static VhUpdatePtr ldrun4_vh_screenrefresh = new VhUpdatePtr() {
        public void handler(osd_bitmap bitmap, int full_refresh) {
    ...
    public static VhUpdatePtr lotlot_vh_screenrefresh = new VhUpdatePtr() {
        public void handler(osd_bitmap bitmap, int full_refresh) {
    ...
    public static VhUpdatePtr kidniki_vh_screenrefresh = new VhUpdatePtr() {
        public void handler(osd_bitmap bitmap, int full_refresh) {
    ...
    public static VhUpdatePtr spelunkr_vh_screenrefresh = new VhUpdatePtr() {
        public void handler(osd_bitmap bitmap, int full_refresh) {
    ...
    public static VhUpdatePtr spelunk2_vh_screenrefresh = new VhUpdatePtr() {
        public void handler(osd_bitmap bitmap, int full_refresh) {

...
import static gr.codebb.arcadeflex.WIP.v037b7.vidhrdw.popeye.*;
...
public class popeye {
    ...
    static InputPortPtr input_ports_popeye = new InputPortPtr() {
        public void handler() {
	    ...
	    0x01, 0x0b, 0x0d = 1 Coin/2 Credits */
            ...
            PORT_START();
            /* DSW1 (FAKE - appears as bit 7 of DSW0, see code below) */
    ...
    public static WriteHandlerPtr popeye_portB_w = new WriteHandlerPtr() {
 ...
 /* bits 1-3 select DSW1 bit to read */
    ...
    public static ReadHandlerPtr popeye_portA_r = new ReadHandlerPtr() {
     ...
     **************************************************************************
     */
    static RomLoadPtr rom_popeye = new RomLoadPtr() {
        public void handler() {
    ...
    static RomLoadPtr rom_popeye2 = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(0x10000, REGION_CPU1);/* 64k for code */
    ...
    static RomLoadPtr rom_popeyef = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(0x10000, REGION_CPU1);/* 64k for code */
    ...
    static RomLoadPtr rom_popeyebl = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(0x10000, REGION_CPU1);/* 64k for code */
 ...
 /* an opcode for the ALU and the others contain the data. */
    public static GameDriver driver_popeye = new GameDriver("1982?", "popeye", "popeye.java", rom_popeye, null, machine_driver_popeyebl, input_ports_popeye, null, ROT0, "Nintendo", "Popeye (set 1)", GAME_UNEMULATED_PROTECTION | GAME_NO_COCKTAIL);
    public static GameDriver driver_popeye2 = new GameDriver("1982?", "popeye2", "popeye.java", rom_popeye2, driver_popeye, machine_driver_popeyebl, input_ports_popeye, null, ROT0, "Nintendo", "Popeye (set 2)", GAME_UNEMULATED_PROTECTION | GAME_NO_COCKTAIL);
    public static GameDriver driver_popeyef = new GameDriver("1982?", "popeyef", "popeye.java", rom_popeyef, driver_popeye, machine_driver_popeyebl, input_ports_popeye, null, ROT0, "Nintendo", "Popeye (rev. F)", GAME_UNEMULATED_PROTECTION | GAME_NO_COCKTAIL);

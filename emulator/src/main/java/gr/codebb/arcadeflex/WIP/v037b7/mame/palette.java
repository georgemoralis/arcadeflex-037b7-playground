...
import static gr.codebb.arcadeflex.old.mame.memoryH.*;
...
public class palette {
 ...
 /* They will be dynamically modified at run time. */
                    ...
                    System.out.println(String.format("shrinking %d colors palette...\n", Machine.drv.total_colors));
                    ...
                    for (i = 0; i < Machine.drv.total_colors; i++) {
                        ...
                        if (j == used) {
                            ...
                            if (used > total_shrinked_pens) {
                                ...
                                System.out.println(String.format("error: ran out of free pens to shrink the palette.\n"));
                            } else {
                    ...
                    System.out.println(String.format("shrinked palette uses %d colors\n", used));
 ...
 /* use shrinked_pens[] directly */
    ...
    public static /*UINT8*/ char[][][] rgb6_to_pen = new char[64][64][64];
    ...
    public static UBytePtr old_palette_recalc_8() {
        int i, color;
        int did_remap = 0;
        int need_refresh = 0;
        int first_free_pen;

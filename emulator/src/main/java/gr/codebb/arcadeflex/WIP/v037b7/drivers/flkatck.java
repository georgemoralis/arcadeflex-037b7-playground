...
import static arcadeflex.v037b7.mame.memoryH.MWA_BANK1;
...
import static arcadeflex.v037b7.mame.driverH.CPU_HD6309;
...
import static gr.codebb.arcadeflex.WIP.v037b7.vidhrdw.flkatck.*;
...
public class flkatck {
     ...
     * ************************************************************************
     */
    public static InitMachinePtr flkatck_init_machine = new InitMachinePtr() {
        public void handler() {
    ...
    public static InterruptPtr flkatck_interrupt = new InterruptPtr() {
        public int handler() {
    ...
    public static WriteHandlerPtr flkatck_bankswitch_w = new WriteHandlerPtr() {
    ...
    public static ReadHandlerPtr flkatck_ls138_r = new ReadHandlerPtr() {
        public int handler(int offset) {
            int data = 0;

            switch ((offset & 0x1c) >> 2) {
                case 0x00:
                    /* inputs + DIPSW #3 + coinsw */
                    if ((offset & 0x02) != 0) {
    ...
    public static WriteHandlerPtr flkatck_ls138_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            switch ((offset & 0x1c) >> 2) {
                case 0x04:
                    /* bankswitch */
    ...
    static InputPortPtr input_ports_flkatck = new InputPortPtr() {
        public void handler() {
            PORT_START();
            /* DSW #1 */
    ...
    static K007232_interface k007232_interface = new K007232_interface(
            ...
            new portwritehandlerPtr[]{volume_callback0} /* external port callback */
    );
    ...
    static RomLoadPtr rom_flkatck = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(0x18000, REGION_CPU1);
            /* 6309 code */

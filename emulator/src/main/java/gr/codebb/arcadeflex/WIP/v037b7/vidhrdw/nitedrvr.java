...
import static gr.codebb.arcadeflex.WIP.v037b7.machine.nitedrvr.*;
...
public class nitedrvr
{
	...
	static void nitedrvr_draw_block(osd_bitmap bitmap, int bx, int by, int ex, int ey)
	{
		int x,y;
	...
	***************************************************************************/
	public static VhUpdatePtr nitedrvr_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
		int offs,roadway;

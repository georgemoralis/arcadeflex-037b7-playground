...
public class punchout {
     ...
     * monitor chars, three for everything else). The PROMs are connected to the
     * RGB output this way:
     *
     * bit 3 -- 240 ohm resistor -- inverter -- RED/GREEN/BLUE -- 470 ohm
     * resistor -- inverter -- RED/GREEN/BLUE -- 1 kohm resistor -- inverter --
     * RED/GREEN/BLUE bit 0 -- 2 kohm resistor -- inverter -- RED/GREEN/BLUE
     *
     **************************************************************************
     */
 ...
 /* these RGB components) */
    ...
    public static VhConvertColorPromPtr armwrest_vh_convert_color_prom = new VhConvertColorPromPtr() {
        public void handler(char[] palette, char[] colortable, UBytePtr color_prom) {
            ...
            for (i = 0; i < TOTAL_COLORS(2); i++) {
                if (i % 8 == 7) {
                    colortable[Machine.drv.gfxdecodeinfo[2].color_codes_start + i] = (char) (1024);
                    /* transparent */
                } else {
 ...
 /* exist but must be seen as a 0xff fill for colors to come out properly */
    ...
    public static InitDriverPtr init_punchout = new InitDriverPtr() {
        public void handler() {
            gfx_fix();
    ...
    public static InitDriverPtr init_spnchout = new InitDriverPtr() {
        public void handler() {
            gfx_fix();
    ...
    public static InitDriverPtr init_spnchotj = new InitDriverPtr() {
        public void handler() {
            gfx_fix();
    ...
    public static InitDriverPtr init_armwrest = new InitDriverPtr() {
        public void handler() {
            gfx_fix();
 ...
 /* be seen as a 0xff fill for colors to come out properly */
     ...
     **************************************************************************
     */
    public static VhStartPtr punchout_vh_start = new VhStartPtr() {
        public int handler() {
    ...
    public static VhStartPtr armwrest_vh_start = new VhStartPtr() {
        public int handler() {
            if ((dirtybuffer = new char[videoram_size[0]]) == null) {
                return 1;
            }
     ...
     **************************************************************************
     */
    public static VhStopPtr punchout_vh_stop = new VhStopPtr() {
        public void handler() {
            dirtybuffer = null;
            dirtybuffer2 = null;
            bs1dirtybuffer = null;
    ...
    public static WriteHandlerPtr punchout_videoram2_w = new WriteHandlerPtr() {
    ...
    public static WriteHandlerPtr punchout_bigsprite1ram_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
    ...
    public static WriteHandlerPtr punchout_bigsprite2ram_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
    ...
    public static WriteHandlerPtr punchout_palettebank_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
     ...
     **************************************************************************
     */
    public static VhUpdatePtr punchout_vh_screenrefresh = new VhUpdatePtr() {
 ...
 /* since last time and update it accordingly. */
            ...
            /* copy the two big sprites */
            {
                ...
                if (zoom != 0) {
                    ...
                    u32_startx = (-sx * 0x4000) & 0xFFFFFFFFL;
                    u32_starty = (-sy * 0x10000) & 0xFFFFFFFFL;
                    u32_startx = (u32_startx + 3740 * zoom) & 0xFFFFFFFFL;
                    /* adjustment to match the screen shots */
                    u32_starty = (u32_starty - 178 * zoom) & 0xFFFFFFFFL;;
                    /* and make the hall of fame picture nice */

                    if ((punchout_bigsprite1.read(6) & 1) != 0) /* flip x */ {
                        u32_startx = ((bs1tmpbitmap.width << 16) - u32_startx - 1) & 0xFFFFFFFFL;
                        incxx = -incxx;
                    }

                    if ((punchout_bigsprite1.read(7) & 1) != 0) /* display in top monitor */ {
                        copyrozbitmap(bitmap, bs1tmpbitmap,
                                u32_startx, u32_starty + 0x200 * (32 - TOP_MONITOR_ROWS) * zoom,
                    ...
                    if ((punchout_bigsprite1.read(7) & 2) != 0) /* display in bottom monitor */ {
                        copyrozbitmap(bitmap, bs1tmpbitmap,
                                u32_startx, u32_starty - 0x200 * TOP_MONITOR_ROWS * zoom,
                                incxx, 0, 0, incyy, /* zoom, no rotation */
                                0, /* no wraparound */
    ...
    public static VhUpdatePtr armwrest_vh_screenrefresh = new VhUpdatePtr() {
        public void handler(osd_bitmap bitmap, int full_refresh) {
            int offs;

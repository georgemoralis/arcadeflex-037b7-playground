...
public class psychic5 {
        ...
        for (i = 0; i < 256; i++) {
            ...
            if ((ps5_io_ram.read(BG_SCREEN_MODE) & 2) != 0) {
                ...
                if (ix == 2) /* purple background enable */ {
                    palette_change_color((int)(256 + i), (int)(val * 0.6), 0, (int)(val * 0.8));
                } else /* grey bg */ {
    ...
    public static VhStartPtr psychic5_vh_start = new VhStartPtr() {
        public int handler() {
    ...
    public static VhStopPtr psychic5_vh_stop = new VhStopPtr() {
        public void handler() {
            ps5_background_videoram = null;
            ps5_dummy_bg_ram = null;
            ps5_io_ram = null;
    ...
    static void psychic5_draw_background(osd_bitmap bitmap) {
        int x, y, offs;
 ...
 /* since last time and update it accordingly. */
    ...
    static void psychic5_draw_foreground(osd_bitmap bitmap) {
        int x, y, offs;
        int sx, sy, tile, palette, flipx, flipy, lo, hi;
    ...
    static void psychic5_draw_sprites(osd_bitmap bitmap) {
    ...
    static void psychic5_draw_sprites2(osd_bitmap bitmap) {
        int offs, sx, sy, tile, palette, flipx, flipy;
    ...
    static void set_visible_colors(int bg_scrollx, int bg_scrolly) {
    ...
    public static VhUpdatePtr psychic5_vh_screenrefresh = new VhUpdatePtr() {

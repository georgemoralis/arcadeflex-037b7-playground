...
import static gr.codebb.arcadeflex.WIP.v037b7.vidhrdw.cloak.*;
...
public class cloak
{
	...
	static UBytePtr enable_nvRAM=new UBytePtr();
	static UBytePtr cloak_sharedram=new UBytePtr();
	...
	{
/*TODO*///		set_led_status(1 - offset,~data & 0x80);
	} };

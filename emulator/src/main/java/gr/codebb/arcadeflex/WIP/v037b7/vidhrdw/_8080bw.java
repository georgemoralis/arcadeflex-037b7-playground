...
import static gr.codebb.arcadeflex.WIP.v037b7.drivers._8080bw.driver_spcenctr;
...
/*TODO*///	#define CYAN			0x20,0xff,0xff,OVERLAY_DEFAULT_OPACITY
    ...
    static artwork_element invaders_overlay[] = {
        new artwork_element(new rectangle(  16,  71,   0, 255), 0x20,0xff,0x20,OVERLAY_DEFAULT_OPACITY ),
        new artwork_element(new rectangle(   0,  15,  16, 133), 0x20,0xff,0x20,OVERLAY_DEFAULT_OPACITY ),
        new artwork_element(new rectangle( 192, 223,   0, 255), 0xff,0x20,0x20,OVERLAY_DEFAULT_OPACITY   ),
    ...
    //};
    	static artwork_element invrvnge_overlay[] = {
            new artwork_element(new rectangle(   0,  71,   0, 255), 0x20,0xff,0x20,OVERLAY_DEFAULT_OPACITY ),
            new artwork_element(new rectangle( 192, 223,   0, 255), 0xff,0x20,0x20,OVERLAY_DEFAULT_OPACITY   ),
            new artwork_element(new rectangle(-1, -1, -1, -1), 0, 0, 0, 0)
        };
        
    	static artwork_element invad2ct_overlay[] = {
            new artwork_element(new rectangle(	 0,  47,   0, 255), 0xff,0xff,0x20,OVERLAY_DEFAULT_OPACITY ),
            new artwork_element(new rectangle(	25,  70,   0, 255), 0x20,0xff,0x20,OVERLAY_DEFAULT_OPACITY  ),
            new artwork_element(new rectangle(	48, 139,   0, 255), 0x20,0xff,0xff,OVERLAY_DEFAULT_OPACITY   ),
            new artwork_element(new rectangle( 117, 185,   0, 255), 0x20,0xff,0x20,OVERLAY_DEFAULT_OPACITY  ),
            new artwork_element(new rectangle( 163, 231,   0, 255), 0xff,0xff,0x20,OVERLAY_DEFAULT_OPACITY ),
            new artwork_element(new rectangle( 209, 255,   0, 255), 0xff,0x20,0x20,OVERLAY_DEFAULT_OPACITY    ),
            new artwork_element(new rectangle(-1, -1, -1, -1), 0, 0, 0, 0)
        };
    ...
    public static String init_artwork_str = "";
    ...
    public static InitDriverPtr init_spcenctr = new InitDriverPtr() {
        public void handler() {
            ...
            init_8080bw.handler();
            init_artwork_str = driver_spcenctr.name;
    ...
    public static VhStartPtr invaders_vh_start = new VhStartPtr() {
 		...
 		if (artwork_type != NO_ARTWORK)
		{
			...
			case SIMPLE_OVERLAY:
				...
				break;
			case FILE_OVERLAY:
				overlay_load(init_artwork_str, start_pen, max_pens);
				break;
			case SIMPLE_BACKDROP:
				break;
			case FILE_BACKDROP:
				backdrop_load(init_artwork_str, start_pen, max_pens);
				break;
			default:

...
public class astrocde {
    ...
    public static int wowBaseFrequency;
    /* Some games (Qbert) change this */
    public static int wowBaseVolume;
    public static int wowChannel = 0;
    public GameSamples wowSamples;
    ...
    static String wowWordTable[]
            = {
                ...
                "YI3U", "Y1IUU", "YIUUI", "Y1IUU1U1", "YI3U1", "Y1IUUL", "YIUU1L", "Y1IUUD", "YO2O2R", null
            };

    public static final int num_samples = wowWordTable.length;// (sizeof(wowWordTable)/sizeof(char *))

    public static String wow_sample_names[]
            = {
                "*wow",
                ...
                "you.wav", "you.wav", "you.wav", "you.wav", "you.wav", "youl.wav", "youl.wav", "youd.wav", "your.wav", null
            };
 ...
 /*extern char totalword[256], *totalword_ptr;
	...
	extern int plural;*/
    public static ShStartPtr wow_sh_start = new ShStartPtr() {
    ...
    public static ReadHandlerPtr wow_speech_r = new ReadHandlerPtr() {
        public int handler(int offset) {
            ...
            if (totalword == null) {
                ...
                if (plural != 0) {
                    ...
                    if (totalword.equals("S")) {
                        /* Plural check */
                        sample_start(wowChannel, num_samples - 2, 0);
                        /* play the sample at position of word */
                        sample_set_freq(wowChannel, wowBaseFrequency);
            ...
            for (i = 0; wowWordTable[i] != null; i++) {
                if (totalword.equals(wowWordTable[i])) {
                    /* Scan the word (sample) table for the complete word */
 /* WOW has Dungeon */
                    if ((totalword.equals("GDTO1RFYA2N")) || (totalword.equals("RO1U1BAH1T")) || (totalword.equals("KO1UH3I3E1N"))) {
                        /* May be plural */
                        plural = i + 1;
                        oldword = totalword;
    ...
    static int wow_status_r() {
        //	logerror("asked for samples status %d\n",wowChannel);
        return NOT(sample_playing(wowChannel));
    }

    /* Read from port 2 (0x12) returns speech status as 0x80 */
    public static ReadHandlerPtr wow_port_2_r = new ReadHandlerPtr() {
        public int handler(int offset) {
            int Ans;
    ...
    public static ShUpdatePtr wow_sh_update = new ShUpdatePtr() {
        public void handler() {
        }
    };
}
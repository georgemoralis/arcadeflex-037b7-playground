...
import static gr.codebb.arcadeflex.WIP.v037b7.cpu.m6502.n2a03.n2a03_irq;
import static gr.codebb.arcadeflex.WIP.v037b7.mame.mame.Machine;
import static arcadeflex.v037b7.mame.sndintrf.*;
import static gr.codebb.arcadeflex.WIP.v037b7.sound.nes_apuH.*;
...
public class nes_apu extends snd_interface {
 ...
 /*if ((cur.buffer = malloc(buffer_size))==NULL)
    ...
    public static void apu_write(int chip, int address, int value) {
        if (address < 22) {//TODO arcadeflex hack dkong3 appears to write to adddress = 23 which is out of bounds
    ...
    public static void apu_update(int chip) {
        ...
        while (elapsed < endp) {
            ...
            //* (buffer16++) = accum << 8;
            buffer16.writeinc((short) (accum << 8));
        }
        cur.buf_pos = endp;
    }

...
Reactor: earlier version of the boarcadeflex.v037b7.soundn processor (8088 minimum moarcadeflex.v037b7.sound unlike all the others)
2000-2fff sprites
3000-37ff video ram
...
/*
 * ported to v0.37b7
 * using automatic conversion tool v0.01r (8088 minimum moarcadeflex.v037b7.sound unlike all the others)
2000-2fff sprites
3000-37ff video ram
4000-4fff char generator ram
6000-67ff palette ram (palette of 16 colors)
...
/*
 * ported to v0.37b7
 * using automatic conversion tool v0.01(8088 minimum moarcadeflex.v037b7.sound unlike all the others)
2000-2fff sprites
3000-37ff video ram
4000-4fff char generator ram
6000-67ff palette ram (palette of 16 colors)
...
import static gr.codebb.arcadeflex.WIP.v037b7.vidhrdw.gottlieb.*;
...
public class gottlieb
{
	...
	public static InitMachinePtr init_machine = new InitMachinePtr() { public void handler() 
	{
		...
		cpu_setbank(2, new UBytePtr(ram, 0x0000));
	} };
	...
	{
/*TODO*///		set_led_status(0,data & 0x20);
/*TODO*///		set_led_status(1,data & 0x40);
/*TODO*///		set_led_status(2,data & 0x80);
		gottlieb_video_outputs_w.handler(offset,data);
	} };
	...
	static String reactor_sample_names[] =
	{
		"*reactor",
		"fx_53.wav", /* "8 left" */
		"fx_54.wav", /* "16 left" */
	...
	static String qbert_sample_names[] =
	{
		"*qbert",
...
/*TODO*///	#define gottlieb_samples_interface qbert_samples_interface	/* not used */
/*TODO*///	#define krull_samples_interface qbert_samples_interface		/* not used */
	...
	********************************************************************/
	...
	//MACHINE_DRIVER_SOUND_1(reactor,  reactor_readmem, reactor_writemem, charRAM_gfxdecodeinfo,0,            1);
        static MachineDriver machine_driver_reactor = new MachineDriver
	(                                                                   
		...
		new MachineCPU[] {		                                                        
			new MachineCPU(	  	                                                    
				CPU_I86,												
				5000000,        /* 5 MHz */								
				reactor_readmem,reactor_writemem,null,null,									
		...
		new MachineSound[] {                                                           	
			...
			new MachineSound(															
				1 * SOUND_SAMPLES,	/* for Votrax simulation */	
				reactor_samples_interface							
			)                                                   		
		},                                                           	
	...
	//MACHINE_DRIVER_SOUND_1(gottlieb, gottlieb_readmem,gottlieb_writemem,charROM_gfxdecodeinfo,nvram_handler,0);
        static MachineDriver machine_driver_gottlieb = new MachineDriver
	(                                                                   
		/* basic machine hardware */                                	
		new MachineCPU[] {		                                                        
			new MachineCPU(	  	                                                    
				CPU_I86,												
				5000000,        /* 5 MHz */								
				gottlieb_readmem,gottlieb_writemem,null,null,									
				gottlieb_interrupt,1									
			),		                                                    
			new MachineCPU(		                                                    
				CPU_M6502 | CPU_AUDIO_CPU ,								
		...
		new MachineSound[] {                                                           	
			...
			new MachineSound(															
				0 * SOUND_SAMPLES,	/* for Votrax simulation */	
				qbert_samples_interface							
			)                                                   		
		},                                                           	
	...
	//MACHINE_DRIVER_SOUND_1(qbert,    gottlieb_readmem,gottlieb_writemem,charROM_gfxdecodeinfo,nvram_handler,1);
        static MachineDriver machine_driver_qbert = new MachineDriver
	(                                                                   
		/* basic machine hardware */                                	
		new MachineCPU[] {		                                                        
			new MachineCPU(	  	                                                    
	...
	//MACHINE_DRIVER_SOUND_1(krull,    gottlieb_readmem,gottlieb_writemem,charRAM_gfxdecodeinfo,nvram_handler,0);
        static MachineDriver machine_driver_krull = new MachineDriver
	(                                                                   
		/* basic machine hardware */                                	
		new MachineCPU[] {		                                                        
			new MachineCPU(	  	                                                    
	...
	//MACHINE_DRIVER_SOUND_2(mach3,    gottlieb_readmem,usvsthem_writemem,charROM_gfxdecodeinfo,nvram_handler);
        static MachineDriver machine_driver_mach3 = new MachineDriver
	(																	
		/* basic machine hardware */									
		new MachineCPU[] {																
			new MachineCPU(															
				CPU_I86,												
				5000000,        /* 5 MHz */								
				gottlieb_readmem,usvsthem_writemem,null,null,									
				gottlieb_interrupt,1									
			),															
			new MachineCPU(															
				CPU_M6502 | CPU_AUDIO_CPU ,								
	...
	//MACHINE_DRIVER_SOUND_2(usvsthem, gottlieb_readmem,usvsthem_writemem,charROM_gfxdecodeinfo,nvram_handler);
        static MachineDriver machine_driver_usvsthem = new MachineDriver
	(																	
		/* basic machine hardware */									
		new MachineCPU[] {																
			new MachineCPU(															
	...
	//MACHINE_DRIVER_SOUND_2(stooges,  stooges_readmem, stooges_writemem, charRAM_gfxdecodeinfo,nvram_handler);
        static MachineDriver machine_driver_stooges = new MachineDriver
	(																	
		/* basic machine hardware */									
		new MachineCPU[] {																
			new MachineCPU(															
				CPU_I86,												
				5000000,        /* 5 MHz */								
				stooges_readmem,stooges_writemem,null,null,									
				gottlieb_interrupt,1									
			),															
			new MachineCPU(															
				CPU_M6502 | CPU_AUDIO_CPU ,								
	...
	//MACHINE_DRIVER_SOUND_2(gottlieb2,gottlieb_readmem,gottlieb_writemem,charROM_gfxdecodeinfo,nvram_handler);
        static MachineDriver machine_driver_gottlieb2 = new MachineDriver
	(																	
		/* basic machine hardware */									
		new MachineCPU[] {																
			new MachineCPU(															
	...
	***************************************************************************/
	...
	public static InitDriverPtr init_gottlieb = new InitDriverPtr() { public void handler() 
	{
		gottlieb_sound_init();
	} };

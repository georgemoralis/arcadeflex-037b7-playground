...
import static gr.codebb.arcadeflex.WIP.v037b7.vidhrdw.exerion.*;
...
public class exerion
{
	...
	static MemoryReadAddress readmem[] =
	{
		...
		new MemoryReadAddress( 0xa000, 0xa000, exerion_port01_r ),
		new MemoryReadAddress( 0xa800, 0xa800, input_port_2_r ),
		new MemoryReadAddress( 0xb000, 0xb000, exerion_port3_r ),
	...
	static MemoryReadAddress cpu2_readmem[] =
	{
		...
		new MemoryReadAddress( 0xa000, 0xa000, exerion_video_timing_r ),
		new MemoryReadAddress( -1 )  /* end of table */
	};
	...
	static MemoryWriteAddress cpu2_writemem[] =
	{
		...
		new MemoryWriteAddress( 0x8000, 0x800c, exerion_video_latch_w ),
		new MemoryWriteAddress( -1 )  /* end of table */
	};
	...
	{
		int/*UINT32*/ oldaddr, newaddr, length;
		UBytePtr src;
                UBytePtr dst; 
                UBytePtr temp;

...
import static arcadeflex.v037b7.mame.sndintrfH.SOUND_K007232;
import static arcadeflex.v037b7.mame.sndintrfH.SOUND_YM2151;
import static arcadeflex.v037b7.mame.commonH.REGION_CPU3;
import static arcadeflex.v037b7.mame.commonH.REGION_GFX3;
import static arcadeflex.v037b7.mame.commonH.REGION_SOUND2;
...
import static arcadeflex.v037b7.mame.memoryH.MRA_BANK2;
...
import static gr.codebb.arcadeflex.WIP.v037b7.sound.k007232.K007232_read_port_1_r;
...
import static gr.codebb.arcadeflex.WIP.v037b7.sound.k007232.K007232_write_port_1_w;
...
import static gr.codebb.arcadeflex.WIP.v037b7.vidhrdw.ajax.ajax_vh_screenrefresh;
import static gr.codebb.arcadeflex.WIP.v037b7.vidhrdw.ajax.ajax_vh_start;
import static gr.codebb.arcadeflex.WIP.v037b7.vidhrdw.ajax.ajax_vh_stop;
...
import static gr.codebb.arcadeflex.WIP.v037b7.machine.ajax.*;
...
public class ajax {
    ...
    public static WriteHandlerPtr k007232_extvol_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
    ...
    static MemoryWriteAddress ajax_writemem_2[]
            = {
                ...
                new MemoryWriteAddress(0x1800, 0x1800, ajax_bankswitch_2_w), /* bankswitch control */
    ...
    static InputPortPtr input_ports_ajax = new InputPortPtr() {
        public void handler() {
            PORT_START();
            /* DSW #1 */
    ...
    static RomLoadPtr rom_ajax = new RomLoadPtr() {
        public void handler() {
    ...
    static RomLoadPtr rom_ajaxj = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(0x28000, REGION_CPU1);/* 052001 code */
    ...
    public static InitDriverPtr init_ajax = new InitDriverPtr() {
        public void handler() {

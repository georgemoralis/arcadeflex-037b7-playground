...
{		
	...
	static osd_bitmap back_vid;
	static osd_bitmap grey_cars_vid;
	static osd_bitmap black_car_vid;
	static osd_bitmap white_car_vid;
	
	public static final int WHITE_CAR   = 0;
	public static final int BLACK_CAR   = 1;
	public static final int GREY_CAR1   = 2;
	public static final int GREY_CAR2   = 3;
	...
	***************************************************************************/
	...
	static void sprint2_check_collision1(osd_bitmap bitmap)
	{
	...
	static void sprint2_check_collision2(osd_bitmap bitmap)
	{
	...
	***************************************************************************/
	public static VhUpdatePtr sprint_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
		int offs,car;
	...
	static void draw_gear_indicator(int gear, osd_bitmap bitmap, int x, int color)
	{
	...
	public static VhUpdatePtr sprint2_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
	...
	public static VhUpdatePtr sprint1_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
		sprint_vh_screenrefresh.handler(bitmap,full_refresh);

...
public class flkatck {
     ...
     **************************************************************************
     */
    public static GetTileInfoPtr get_tile_info_A = new GetTileInfoPtr() {
        public void handler(int tile_index) {
            ...
            tile_info.u32_flags = (attr & 0x20) != 0 ? TILE_FLIPY : 0;

            SET_TILE_INFO(0, code + 256 * bank, (attr & 0x0f) + 16);
        }
    };

    public static GetTileInfoPtr get_tile_info_B = new GetTileInfoPtr() {
        public void handler(int tile_index) {
     ...
     **************************************************************************
     */
    public static VhStartPtr flkatck_vh_start = new VhStartPtr() {
        public int handler() {
     ...
     **************************************************************************
     */
    public static WriteHandlerPtr flkatck_k007121_w = new WriteHandlerPtr() {
    ...
    public static WriteHandlerPtr flkatck_k007121_regs_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            switch (offset) {
                case 0x04:
                    /* ROM bank select */
     ...
     **************************************************************************
     */
    public static VhUpdatePtr flkatck_vh_screenrefresh = new VhUpdatePtr() {

...
import static gr.codebb.arcadeflex.WIP.v037b7.vidhrdw.turbo.turbo_collision;
...
public class turbo
{
	...
	/* local data */
	static int segment_address, segment_increment;
	static int osel, bsel, accel;
	...
	*/
	...
	public static PortReadHandlerPtr portA_r = new PortReadHandlerPtr() {
            @Override
	...
	public static PortReadHandlerPtr portB_r = new PortReadHandlerPtr() {
            @Override
            public int handler(int chip) {
		if (chip == 3)
	...
	static PortWriteHandlerPtr portA_w = new PortWriteHandlerPtr() {
            @Override
	...
	static PortWriteHandlerPtr portB_w = new PortWriteHandlerPtr() {
            @Override
            public void handler(int chip, int data) {
		switch (chip)
		{
	...
	static PortWriteHandlerPtr portC_w = new PortWriteHandlerPtr() {
            @Override
            public void handler(int chip, int data) {
		switch (chip)
		{

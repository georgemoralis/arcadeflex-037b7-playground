...
import static gr.codebb.arcadeflex.WIP.v037b7.machine.mathbox.*;
...
import static gr.codebb.arcadeflex.WIP.v037b7.sndhrdw.bzone.*;
import static gr.codebb.arcadeflex.WIP.v037b7.sndhrdw.redbaron.*;
...
public class bzone {
    ...
    public static InterruptPtr bzone_interrupt = new InterruptPtr() {
        public int handler() {
    ...
    static InputPortPtr input_ports_bzone = new InputPortPtr() {
        public void handler() {
            PORT_START();
            /* IN0 */
 ...
 /* This fake port is handled via bzone_IN3_r */
    ...
    static MemoryWriteAddress redbaron_writemem[]
            = {
                ...
                new MemoryWriteAddress(0x180c, 0x180c, atari_vg_earom_ctrl_w),
    ...
    static InputPortPtr input_ports_redbaron = new InputPortPtr() {
        public void handler() {
            PORT_START();
            /* IN0 */
            PORT_BIT(0x01, IP_ACTIVE_LOW, IPT_COIN1);
 ...
 /* Red Baron doesn't seem to use the full 0-255 range. */
     ...
     **************************************************************************
     */
    static RomLoadPtr rom_bzone = new RomLoadPtr() {
        public void handler() {
 ...
 /* Mathbox ROMs */
    ...
    static RomLoadPtr rom_bzone2 = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(0x10000, REGION_CPU1);/* 64k for code */
 ...
 /* Mathbox ROMs */
    ...
    static RomLoadPtr rom_redbaron = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(0x10000, REGION_CPU1);/* 64k for code */

...
import static gr.codebb.arcadeflex.WIP.v037b7.vidhrdw.psychic5.*;
...
public class psychic5 {
    ...
    public static ReadHandlerPtr psychic5_bankselect_r = new ReadHandlerPtr() {
        public int handler(int offset) {
            return psychic5_bank_latch;
        }
    };

    public static WriteHandlerPtr psychic5_bankselect_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            ...
            if (data != psychic5_bank_latch) {
                ...
                /* Select 4 banks of 16k */
            }
        }
    };

    public static InterruptPtr psychic5_interrupt = new InterruptPtr() {
        public int handler() {
            if (cpu_getiloops() == 0) {
                return 0xd7;
                /* RST 10h */
    ...
    static InputPortPtr input_ports_psychic5 = new InputPortPtr() {
        public void handler() {
            PORT_START();
     ...
     **************************************************************************
     */
    static RomLoadPtr rom_psychic5 = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(0x20000, REGION_CPU1);
            /* 2*64K for main CPU, Z80 */

...
import static gr.codebb.arcadeflex.WIP.v037b7.vidhrdw.battlera.*;
...
public class battlera {
     ...
     * ***************************************************************************
     */
    public static WriteHandlerPtr battlera_sound_w = new WriteHandlerPtr() {
     ...
     * ***************************************************************************
     */
    public static WriteHandlerPtr control_data_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            control_port_select = data;
        }
    };

    public static ReadHandlerPtr control_data_r = new ReadHandlerPtr() {
    ...
    static int toggle_adpcm;
    public static vclk_interruptPtr battlera_adpcm_int = new vclk_interruptPtr() {
        public void handler(int data) {

            MSM5205_data_w.handler(0, msm5205next >> 4);
            msm5205next <<= 4;

            toggle_adpcm = 1 - toggle_adpcm;
            if (toggle_adpcm != 0) {
    ...
    public static WriteHandlerPtr battlera_adpcm_data_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            msm5205next = data;
        }
    };

    public static WriteHandlerPtr battlera_adpcm_reset_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
     ...
     * ***************************************************************************
     */
    static InputPortPtr input_ports_battlera = new InputPortPtr() {
        public void handler() {
            PORT_START();
            /* Player 1 controls */
     ...
     * ***************************************************************************
     */
    static RomLoadPtr rom_bldwolf = new RomLoadPtr() {
        public void handler() {
    ...
    static RomLoadPtr rom_battlera = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(0x100000, REGION_CPU1);/* Main cpu code */

...
import static gr.codebb.arcadeflex.WIP.v037b7.machine.rp5h01H.*;
...
public class rp5h01 {
    ...
    static RP5H01_interface intf;

    /* these also work as the address masks */
    static int COUNTER_MODE_6_BITS = 0x3f;
    static int COUNTER_MODE_7_BITS = 0x7f;
    ...
    public static class RP5H01 {
        ...
        /* chip enable */
        int old_reset;
        /* reset pin state (level-triggered) */
        int old_clock;
        /* clock pin state (level-triggered) */
        UBytePtr data;
    }
     ...
     * *************************************************************************
     */
    public static WriteHandlerPtr RP5H01_0_enable_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            RP5H01_enable_w(0, data);
        }
    };

    public static WriteHandlerPtr RP5H01_0_reset_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            RP5H01_reset_w(0, data);
        }
    };

    public static WriteHandlerPtr RP5H01_0_clock_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            RP5H01_clock_w(0, data);
        }
    };

    public static WriteHandlerPtr RP5H01_0_test_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            RP5H01_test_w(0, data);
        }
    };

    public static ReadHandlerPtr RP5H01_0_counter_r = new ReadHandlerPtr() {
        public int handler(int offset) {
            return RP5H01_counter_r(0);
        }
    };

    public static ReadHandlerPtr RP5H01_0_data_r = new ReadHandlerPtr() {
        public int handler(int offset) {

...
/*TODO*/// *************************************************************/
 ...
 /* (Note: do we need to do anything else?) */
	...
	public static WriteHandlerPtr UPD7759_0_message_w = new WriteHandlerPtr() {public void handler(int offset, int data)	{ UPD7759_message_w.handler(0,data); } };
	public static WriteHandlerPtr UPD7759_0_start_w = new WriteHandlerPtr() {public void handler(int offset, int data)	{ UPD7759_start_w.handler(0,data); } };
	public static ReadHandlerPtr UPD7759_0_busy_r  = new ReadHandlerPtr() { public int handler(int offset)	{ return UPD7759_busy_r.handler(0); } };

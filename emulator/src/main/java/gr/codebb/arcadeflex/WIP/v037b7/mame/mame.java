...
import static arcadeflex.v037b7.mame.cpuintrf.cpu_init;
import static arcadeflex.v037b7.mame.cpuintrf.cpu_run;
import static gr.codebb.arcadeflex.old.mame.drawgfx.*;
import static gr.codebb.arcadeflex.old.mame.drawgfx.set_pixel_functions;
import static arcadeflex.v037b7.mame.input.code_close;
import static arcadeflex.v037b7.mame.input.code_init;
...
import static arcadeflex.v037b7.mame.gfxobjC.gfxobj_close;
import static arcadeflex.v037b7.mame.gfxobjC.gfxobj_init;
import static arcadeflex.v037b7.mame.inptport.*;
import static arcadeflex.v037b7.mame.memory.memory_init;
import static arcadeflex.v037b7.mame.memory.memory_shutdown;
 ...
 /* Machine.gfx[] data */
        if (drv.gfxdecodeinfo != null) {
            for (i = 0; i < MAX_GFX_ELEMENTS && drv.gfxdecodeinfo[i].memory_region != -1; i++) {
                ...
                glcopy = new GfxLayout(drv.gfxdecodeinfo[i].gfxlayout);//memcpy(&glcopy,drv.gfxdecodeinfo[i].gfxlayout,sizeof(glcopy));

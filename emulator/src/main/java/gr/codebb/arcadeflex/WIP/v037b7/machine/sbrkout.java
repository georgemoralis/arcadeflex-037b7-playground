...
public class sbrkout {
	...
	public static final int SBRKOUT_PROGRESSIVE = 0x00;
	public static final int SBRKOUT_DOUBLE      = 0x01;
	public static final int SBRKOUT_CAVITY      = 0x02;
	...
	***************************************************************************/
	public static InterruptPtr sbrkout_interrupt = new InterruptPtr() { public int handler() 
	{
	    ...
	    game_switch=input_port_7_r.handler(0);
...
/*TODO*///		set_led_status(1,offset & 1);
	...
	{
/*TODO*///		set_led_status(2,~offset & 1);
	} };

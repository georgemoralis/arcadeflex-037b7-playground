...
import static gr.codebb.arcadeflex.WIP.v037b7.vidhrdw.balsente.*;
...
import static arcadeflex.v037b7.sound.cem3394.*;
import static arcadeflex.v037b7.sound.cem3394H.*;

public class balsente {

    /* global data */
    public static char /*UINT8*/ u8_balsente_shooter;
    public static char /*UINT8*/ u8_balsente_shooter_x;
    public static char /*UINT8*/ u8_balsente_shooter_y;
    ...
    public static class counter_state {
        ...
        char/*UINT8*/ u8_out;
        char/*UINT8*/ u8_mode;
        char/*UINT8*/ u8_readbyte;
        char/*UINT8*/ u8_writebyte;
    };

    static counter_state[] counter = new counter_state[3];

    /* manually clocked counter 0 states */
    static char/*UINT8*/ u8_counter_control;
    static char/*UINT8*/ u8_counter_0_ff;
    ...
    /* ADC I/O states */
    static int[] analog_input_data = new int[4];
    static char/*UINT8*/ u8_adc_value;
    static char/*UINT8*/ u8_adc_shift;

    /* CEM3394 DAC control states */
    static char dac_value;
    static char/*UINT8*/ u8_dac_register;
    static char/*UINT8*/ u8_chip_select;

    /* main CPU 6850 states */
    static char/*UINT8*/ u8_m6850_status;
    static char/*UINT8*/ u8_m6850_control;
    static char/*UINT8*/ u8_m6850_input;
    static char/*UINT8*/ u8_m6850_output;
    static char/*UINT8*/ u8_m6850_data_ready;

    /* sound CPU 6850 states */
    static char/*UINT8*/ u8_m6850_sound_status;
    static char/*UINT8*/ u8_m6850_sound_control;
    static char/*UINT8*/ u8_m6850_sound_input;
    static char/*UINT8*/ u8_m6850_sound_output;

    /* noise generator states */
    static /*UINT32*/ int[] noise_position = new int[6];

    /* game-specific states */
    static char/*UINT8*/ u8_nstocker_bits;
    static char/*UINT8*/ u8_spiker_expand_color;
    static char/*UINT8*/ u8_spiker_expand_bgcolor;
    static char/*UINT8*/ u8_spiker_expand_bits;
    ...
    public static timer_callback interrupt_timer = new timer_callback() {
        public void handler(int param) {
            ...
            if (u8_balsente_shooter != 0) {
                char u8_tempx, u8_tempy;

                /* we latch the beam values on the first interrupt after VBLANK */
                if (param == 64 && u8_balsente_shooter != 0) {
                    u8_balsente_shooter_x = (char) ((input_port_8_r.handler(0)) & 0xFF);
                    u8_balsente_shooter_y = (char) ((input_port_9_r.handler(0)) & 0xFF);
                }

                /* which bits get returned depends on which scanline we're at */
                u8_tempx = (char) ((u8_balsente_shooter_x << ((param - 64) / 64)) & 0xFF);
                u8_tempy = (char) ((u8_balsente_shooter_y << ((param - 64) / 64)) & 0xFF);
                u8_nstocker_bits = (char) ((((u8_tempx >> 4) & 0x08) | ((u8_tempx >> 1) & 0x04)
                        | ((u8_tempy >> 6) & 0x02) | ((u8_tempy >> 3) & 0x01)) & 0xFF);
            }
        }
    };
    ...
    public static InitMachinePtr init_machine = new InitMachinePtr() {
        public void handler() {
            ...
            memset(noise_position, 0, noise_position.length);
     ...
     ************************************
     */
    public static final int POLY17_BITS = 17;
    public static final int POLY17_SIZE = ((1 << POLY17_BITS) - 1);
    public static final int POLY17_SHL = 7;
    public static final int POLY17_SHR = 10;
 ...
 /* special case is offset 7, which recalls the NVRAM data */
    ...
    static void m6850_update_io() {
        ...
        if ((u8_m6850_sound_status & 0x02) == 0) {
            ...
            u8_m6850_input = u8_m6850_sound_output;
        ...
        if (u8_m6850_data_ready != 0) {
            ...
            u8_m6850_sound_input = u8_m6850_output;
        ...
        /* apply the change */
        if (u8_new_state != 0 && (u8_m6850_status & 0x80) == 0) {
            cpu_set_irq_line(0, M6809_FIRQ_LINE, ASSERT_LINE);
            u8_m6850_status |= 0x80;
        } else if (u8_new_state == 0 && (u8_m6850_status & 0x80) != 0) {
        ...
        /* apply the change */
        if (u8_new_state != 0 && (u8_m6850_sound_status & 0x80) == 0) {
            cpu_set_nmi_line(1, ASSERT_LINE);
            u8_m6850_sound_status |= 0x80;
        } else if (u8_new_state == 0 && (u8_m6850_sound_status & 0x80) != 0) {
    ...
    public static timer_callback m6850_data_ready_callback = new timer_callback() {
        public void handler(int param) {
            ...
            u8_m6850_output = (char) ((param) & 0xFF);
 ...
 /* (this is very important for several games, esp Snacks'n Jaxson) */
    ...
    public static WriteHandlerPtr m6850_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            ...
            if (offset == 0) {
                u8_m6850_control = (char) ((data) & 0xFF);
    ...
    public static ReadHandlerPtr m6850_sound_r = new ReadHandlerPtr() {
        public int handler(int offset) {
            ...
            /* status register is at offset 0 */
            if (offset == 0) {
                result = u8_m6850_sound_status;
            } /* input register is at offset 1 */ else {
                result = u8_m6850_sound_input;

                /* clear the overrun and receive buffer full bits */
                u8_m6850_sound_status &= ~0x21;
                m6850_update_io();
            }
    ...
    public static WriteHandlerPtr m6850_sound_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            /* control register is at offset 0 */
            if (offset == 0) {
                u8_m6850_sound_control = (char) ((data) & 0xFF);
            } /* output register is at offset 1 */ else {
                u8_m6850_sound_output = (char) ((data) & 0xFF);
                u8_m6850_sound_status &= ~0x02;
            }
 ...
 /* zone in the middle that feels unnatural with the mouse */
            ...
            /* return the sign */
            if ((which & 1) == 0) {
                u8_adc_value = (val < 0) ? (char) 0xff : (char) 0x00;
            } /* return the magnitude */ else {
                u8_adc_value = (val < 0) ? (char) -val : (char) val;
            }
        }
    };
 ...
 /* it's important that we do this for Mini Golf */
    ...
    static void counter_set_gate(int which, int gate) {
        ...
        counter[which].u8_gate = (char) ((gate) & 0xFF);
 ...
 /* and then starts counting down; it's important that we don't count the first one */
    ...
    static void counter_set_out(int which, int out) {
        ...
        if (which == 2) {
            ...
            counter_set_gate(1, out!=0?0:1);
        }

        /* remember the out state */
        counter[which].u8_out = (char) (out & 0xFF);
    }
 ...
 /* mode 0 and 1: when firing, transition OUT to high */
        ...
        public void handler(int offset, int data) {
            ...
            switch (offset & 3) {
                ...
                case 3:
                    ...
                    /* set the mode */
                    counter[which].u8_mode = (char) (((data >> 1) & 7) & 0xFF);
    ...
    static void set_counter_0_ff(int newstate) {
        ...
        u8_counter_0_ff = (char) (newstate & 0xFF);
    }
 ...
 /* this is used to calibrate the timers at startup */
    ...
    public static ReadHandlerPtr counter_state_r = new ReadHandlerPtr() {
        public int handler(int offset) {
            ...
            int result = u8_counter_0_ff!=0?0:1;
    ...
    public static WriteHandlerPtr counter_control_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            /*UINT8*/
            char u8_diff_counter_control = (char) ((u8_counter_control ^ data) & 0xFF);

            /* set the new global value */
            u8_counter_control = (char) (data & 0xFF);
            ...
            if ((u8_diff_counter_control & 0x01) != 0) {
                ...
                for (ch = 0; ch < MIXER_MAX_CHANNELS; ch++) {
                    ...
                    if (name != null && strstr(name, "3394") != null) {
 ...
 /* if we gate on, start a pulsing timer to clock it */
    ...
    public static ReadHandlerPtr nstocker_port2_r = new ReadHandlerPtr() {
        public int handler(int offset) {
            return (input_port_2_r.handler(offset) & 0xf0) | u8_nstocker_bits;
        }
    };
    ...
    public static WriteHandlerPtr spiker_expand_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            ...
            if (offset == 0) {
                u8_spiker_expand_bits = (char) (data & 0xFF);
            } /* offset 1 is the background color (cleared on each read) */ else if (offset == 1) {
                u8_spiker_expand_bgcolor = (char) (data & 0xFF);
            } /* offset 2 is the color */ else if (offset == 2) {
                u8_spiker_expand_color = (char) (data & 0xFF);
            }
        }
    };
    ...
    public static ReadHandlerPtr spiker_expand_r = new ReadHandlerPtr() {
        public int handler(int offset) {
            char/*UINT8*/ u8_left, u8_right;

            /* first rotate each nibble */
            u8_spiker_expand_bits = (char) ((((u8_spiker_expand_bits << 1) & 0xee) | ((u8_spiker_expand_bits >> 3) & 0x11)) & 0xFF);

            /* compute left and right pixels */
            u8_left = (u8_spiker_expand_bits & 0x10) != 0 ? u8_spiker_expand_color : u8_spiker_expand_bgcolor;
            u8_right = (u8_spiker_expand_bits & 0x01) != 0 ? u8_spiker_expand_color : u8_spiker_expand_bgcolor;

            /* reset the background color */
            u8_spiker_expand_bgcolor = 0;

            /* return the combined result */
            return (u8_left & 0xf0) | (u8_right & 0x0f);
        }
    };
            ...
            for (i = 0; i < 6; i++) {
                if ((diffchip & (1 << i)) != 0 && (data & (1 << i)) != 0) {
                    ...
                    if (temp != cem3394_get_parameter(i, reg)) {
                        logerror("s%04X:   CEM#%d:%s=%f\n", cpu_getpreviouspc(), i, names[u8_dac_register], voltage);
                    }
                }
            }
    ...
    public static WriteHandlerPtr dac_data_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            ...
            if ((u8_chip_select & 0x3f) != 0x3f) {
                char/*UINT8*/ temp = u8_chip_select;
                chip_select_w.handler(0, 0x3f);
                chip_select_w.handler(0, temp & 0xFF);
            }
        }
    };
    ...
    public static WriteHandlerPtr register_addr_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            u8_dac_register = (char) ((data & 7) & 0xFF);
        }
    };
    ...
    static MemoryReadAddress readmem_cpu1[]
            = {
                ...
                new MemoryReadAddress(0x9400, 0x9400, adc_data_r),
                new MemoryReadAddress(0x9900, 0x9900, input_port_0_r),
                new MemoryReadAddress(0x9901, 0x9901, input_port_1_r),
                new MemoryReadAddress(0x9902, 0x9902, input_port_2_r),
                new MemoryReadAddress(0x9903, 0x9903, input_port_3_r),
                new MemoryReadAddress(0x9a00, 0x9a03, random_num_r),
                new MemoryReadAddress(0x9a04, 0x9a05, m6850_r),
                new MemoryReadAddress(0x9b00, 0x9bff, MRA_RAM), /* system NOVRAM */
                new MemoryReadAddress(0x9c00, 0x9cff, MRA_RAM), /* cart NOVRAM */
                new MemoryReadAddress(0xa000, 0xbfff, MRA_BANK1),
                new MemoryReadAddress(0xc000, 0xffff, MRA_BANK2),
                new MemoryReadAddress(-1) /* end of table */};

    /* CPU 1 write addresses */
    static MemoryWriteAddress writemem_cpu1[]
            = {
                new MemoryWriteAddress(0x0000, 0x07ff, MWA_RAM, spriteram),
                new MemoryWriteAddress(0x0800, 0x7fff, balsente_videoram_w, videoram, videoram_size),
                new MemoryWriteAddress(0x8000, 0x8fff, balsente_paletteram_w, paletteram),
                new MemoryWriteAddress(0x9000, 0x9007, adc_select_w),
                new MemoryWriteAddress(0x9800, 0x987f, misc_output_w),
                new MemoryWriteAddress(0x9880, 0x989f, random_reset_w),
                new MemoryWriteAddress(0x98a0, 0x98bf, rombank_select_w),
                new MemoryWriteAddress(0x98c0, 0x98df, balsente_palette_select_w),
                new MemoryWriteAddress(0x98e0, 0x98ff, watchdog_reset_w),
                new MemoryWriteAddress(0x9903, 0x9903, MWA_NOP),
                new MemoryWriteAddress(0x9a04, 0x9a05, m6850_w),
                new MemoryWriteAddress(0x9b00, 0x9cff, MWA_RAM, nvram, nvram_size), /* system NOVRAM + cart NOVRAM */
                new MemoryWriteAddress(0x9f00, 0x9f00, rombank2_select_w),
    ...
    static MemoryReadAddress readmem_cpu2[]
            = {
                ...
                new MemoryReadAddress(0xe000, 0xffff, m6850_sound_r),
                new MemoryReadAddress(-1) /* end of table */};
    ...
    static MemoryWriteAddress writemem_cpu2[]
            = {
                ...
                new MemoryWriteAddress(0x6000, 0x7fff, m6850_sound_w),
                new MemoryWriteAddress(-1) /* end of table */};

    static IOReadPort readport_cpu2[]
            = {
                new IOReadPort(0x00, 0x03, counter_8253_r),
                new IOReadPort(0x08, 0x0f, counter_state_r),
                new IOReadPort(-1) /* end of table */};

    static IOWritePort writeport_cpu2[]
            = {
                new IOWritePort(0x00, 0x03, counter_8253_w),
                new IOWritePort(0x08, 0x09, counter_control_w),
                new IOWritePort(0x0a, 0x0b, dac_data_w),
                new IOWritePort(0x0c, 0x0d, register_addr_w),
                new IOWritePort(0x0e, 0x0f, chip_select_w),
 ...
 /* the crosshair controls */
     ...
     ************************************
     */
    public static final int EXPAND_ALL = 0x00;
    public static final int EXPAND_NONE = 0x3f;
    public static final int SWAP_HALVES = 0x80;
 ...
 /* ROM region must be 0x40000 total */
    ...
    static RomLoadPtr rom_nametune = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(0x70000, REGION_CPU1);
            /* 64k for code for the first CPU, plus 128k of banked ROMs */
    ...
    public static GameDriver driver_triviag2 = new GameDriver("1984", "triviag2", "balsente.java", rom_triviag2, null, machine_driver_balsente, input_ports_triviag1, init_triviag2, ROT0, "Bally/Sente", "Trivial Pursuit (Genus II)");
    public static GameDriver driver_triviasp = new GameDriver("1984", "triviasp", "balsente.java", rom_triviasp, null, machine_driver_balsente, input_ports_triviag1, init_triviag2, ROT0, "Bally/Sente", "Trivial Pursuit (All Star Sports Edition)");
    public static GameDriver driver_triviayp = new GameDriver("1984", "triviayp", "balsente.java", rom_triviayp, null, machine_driver_balsente, input_ports_triviag1, init_triviag2, ROT0, "Bally/Sente", "Trivial Pursuit (Young Players Edition)");
    public static GameDriver driver_triviabb = new GameDriver("1984", "triviabb", "balsente.java", rom_triviabb, null, machine_driver_balsente, input_ports_triviag1, init_triviag2, ROT0, "Bally/Sente", "Trivial Pursuit (Baby Boomer Edition)");

...
import static arcadeflex.v037b7.vidhrdw.generic.colorram;
...
public class pandoras {
    ...
    public static UBytePtr pandoras_sharedram = new UBytePtr();
    public static UBytePtr pandoras_sharedram2 = new UBytePtr();

    /* from vidhrdw */
    public static InterruptPtr pandoras_interrupt_a = new InterruptPtr() {
        public int handler() {
            if (irq_enable_a != 0) {
    ...
    public static InterruptPtr pandoras_interrupt_b = new InterruptPtr() {
        public int handler() {
            if (irq_enable_b != 0) {
                return M6809_INT_IRQ;
            }
    ...
    public static ReadHandlerPtr pandoras_sharedram_r = new ReadHandlerPtr() {
        public int handler(int offset) {
            return pandoras_sharedram.read(offset);
        }
    };

    public static WriteHandlerPtr pandoras_sharedram_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            pandoras_sharedram.write(offset, data);
        }
    };

    public static ReadHandlerPtr pandoras_sharedram2_r = new ReadHandlerPtr() {
        public int handler(int offset) {
            return pandoras_sharedram2.read(offset);
        }
    };

    public static WriteHandlerPtr pandoras_sharedram2_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            pandoras_sharedram2.write(offset, data);
        }
    };

    public static WriteHandlerPtr pandoras_int_control_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            ...
            switch (offset) {
                ...
                case 0x03:
                    ...
                    break;
                case 0x05:
                    pandoras_flipscreen_w.handler(0, data);
                    break;
                case 0x06:
                    if (data == 0) {
    ...
    public static WriteHandlerPtr pandoras_cpua_irqtrigger_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            if (firq_old_data_a == 0 && data != 0) {
    ...
    public static WriteHandlerPtr pandoras_cpub_irqtrigger_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            if (firq_old_data_b == 0 && data != 0) {
    ...
    public static WriteHandlerPtr i8039_irqen_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            /* ??? */
    ...
    public static WriteHandlerPtr pandoras_z80_irqtrigger_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            cpu_cause_interrupt(2, 0xff);
        }
    };

    public static WriteHandlerPtr pandoras_i8039_irqtrigger_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
     ...
     **************************************************************************
     */
    static InputPortPtr input_ports_pandoras = new InputPortPtr() {
        public void handler() {
            PORT_START();
            /* DSW #1 */
     ...
     **************************************************************************
     */
    public static InitMachinePtr pandoras_init_machine = new InitMachinePtr() {
        public void handler() {
    ...
    public static ReadHandlerPtr pandoras_portB_r = new ReadHandlerPtr() {
        public int handler(int offset) {
            /* ??? */
    ...
    public static WriteHandlerPtr pandoras_portB_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            /* ??? */
        }
    };
    ...
    static AY8910interface ay8910_interface = new AY8910interface(
            ...
            new WriteHandlerPtr[]{pandoras_portB_w}
    );
     ...
     **************************************************************************
     */
    static RomLoadPtr rom_pandoras = new RomLoadPtr() {
        public void handler() {

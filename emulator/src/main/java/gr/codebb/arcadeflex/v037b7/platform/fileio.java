...
/*TODO*///	if( !f )
/*TODO*///	{
/*TODO*///		logerror("osd_fopen: failed to malloc FakeFileHandle!\n");
/*TODO*///        return 0;
/*TODO*///	}
...
/*TODO*///					{
/*TODO*///						LOG(("Using (osd_fopen) zip file for %s\n", filename));
...
/*TODO*///			char *extension;
/*TODO*///
/*TODO*///			LOG(("Open IMAGE_RW '%s' for %s mode '%s'\n", filename, game, write_modes[_write]));
/*TODO*///			strcpy (file, filename);
/*TODO*///
/*TODO*///			do
/*TODO*///            {
/*TODO*///			/* 29-05-00 Lee Ward: Reversed the search order. */
/*TODO*///            for (indx=rompathc-1; indx>=0; --indx)
/*TODO*///			{
/*TODO*///				const char *dir_name = rompathv[indx];
/*TODO*///
/*TODO*///					/* Exact path support */
/*TODO*///
/*TODO*///					/* 29-05-00 Lee Ward: Changed the search order to prevent new files
/*TODO*///					   being created in the application root as default */
/*TODO*///
/*TODO*///					if( !found )
/*TODO*///					{
/*TODO*///						sprintf (name, "%s/%s", dir_name, gamename);
...
/*TODO*///						/* try with a .zip directory (if ZipMagic is installed) */
/*TODO*///						sprintf (name, "%s/%s.zip", dir_name, gamename);
/*TODO*///						LOG(("Trying %s ZipMagic directory\n", name));
/*TODO*///						if( cache_stat (name, &stat_buffer) == 0 && (stat_buffer.st_mode & S_IFDIR) )
/*TODO*///						{
...
/*TODO*///					}
/*TODO*///					if( found )
/*TODO*///						LOG(("IMAGE_RW %s FOUND in %s!\n", file, name));
/*TODO*///				}
/*TODO*///

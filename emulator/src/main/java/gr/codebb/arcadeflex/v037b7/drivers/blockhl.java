...
import static gr.codebb.arcadeflex.WIP.v037b7.mame.memoryH.MWA_NOP;
...
public class blockhl {
    ...
    public static konami_cpu_setlines_callbackPtr blockhl_banking = new konami_cpu_setlines_callbackPtr() {
 ...
 /* other bits unknown */
    ...
    public static InitMachinePtr blockhl_init_machine = new InitMachinePtr() {
        public void handler() {
            UBytePtr RAM = memory_region(REGION_CPU1);
    ...
    public static InterruptPtr blockhl_interrupt = new InterruptPtr() {
        public int handler() {
    ...
    public static WriteHandlerPtr blockhl_sh_irqtrigger_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
     ...
     **************************************************************************
     */
    static InputPortPtr input_ports_blockhl = new InputPortPtr() {
        public void handler() {
            PORT_START();
            /* PLAYER 1 INPUTS */
...
/*TODO*///	};
     ...
     **************************************************************************
     */
    static RomLoadPtr rom_blockhl = new RomLoadPtr() {
        public void handler() {
    ...
    static RomLoadPtr rom_quarth = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(0x18800, REGION_CPU1);/* code + banked roms + space for banked RAM */
     ...
     **************************************************************************
     */
    public static InitDriverPtr init_blockhl = new InitDriverPtr() {
        public void handler() {

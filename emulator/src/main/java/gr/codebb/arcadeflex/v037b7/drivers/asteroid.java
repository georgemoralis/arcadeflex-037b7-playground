...
import static gr.codebb.arcadeflex.beta.v037b7.vidhrdw.llander.*;
...
public class asteroid {
    ...
    static InputPortPtr input_ports_asteroid = new InputPortPtr() {
        public void handler() {
            PORT_START();
            /* IN0 */
 ...
 /* Bit 2 is the 3 KHz source and Bit 3 the VG_HALT bit    */
    ...
    static InputPortPtr input_ports_asteroib = new InputPortPtr() {
        public void handler() {
            PORT_START();
            /* IN0 */
    ...
    static InputPortPtr input_ports_astdelux = new InputPortPtr() {
        public void handler() {
            PORT_START();
            /* IN0 */
            PORT_BIT(0x01, IP_ACTIVE_HIGH, IPT_UNKNOWN);
 ...
 /* Bit 2 is the 3 KHz source and Bit 3 the VG_HALT bit    */
    ...
    static InputPortPtr input_ports_llander = new InputPortPtr() {
        public void handler() {
            PORT_START();
            /* IN0 */
 /* Bit 0 is VG_HALT, handled in the machine dependant part */
    ...
    static InputPortPtr input_ports_llander1 = new InputPortPtr() {
        public void handler() {
            PORT_START();
            /* IN0 */
 /* Bit 0 is VG_HALT, handled in the machine dependant part */
 ...
 /* Asteroids Deluxe now uses the earom routines
     ...
     **************************************************************************
     */
    static RomLoadPtr rom_asteroid = new RomLoadPtr() {
        public void handler() {
 ...
 /* Vector ROM */
    ...
    static RomLoadPtr rom_asteroi1 = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(0x10000, REGION_CPU1);/* 64k for code */
 ...
 /* Vector ROM */
    ...
    static RomLoadPtr rom_asteroib = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(0x10000, REGION_CPU1);/* 64k for code */
 ...
 /* Vector ROM */
    ...
    static RomLoadPtr rom_astdelux = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(0x10000, REGION_CPU1);/* 64k for code */
 ...
 /* Vector ROM */
    ...
    static RomLoadPtr rom_astdelu1 = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(0x10000, REGION_CPU1);/* 64k for code */
 ...
 /* Vector ROM */
    ...
    static RomLoadPtr rom_llander = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(0x10000, REGION_CPU1);/* 64k for code */
 ...
 /* Unfortunately, is it not currently available. */
    ...
    static RomLoadPtr rom_llander1 = new RomLoadPtr() {
        public void handler() {
            ROM_REGION(0x10000, REGION_CPU1);/* 64k for code */

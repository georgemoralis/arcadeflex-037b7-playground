...
public class asteroid {
    ...
    public static InterruptPtr asteroid_interrupt = new InterruptPtr() {
        public int handler() {
    ...
    public static InterruptPtr llander_interrupt = new InterruptPtr() {
        public int handler() {
            /* Turn off interrupts if self-test is enabled */
    ...
    public static ReadHandlerPtr asteroid_IN0_r = new ReadHandlerPtr() {
    ...
    public static ReadHandlerPtr asteroib_IN0_r = new ReadHandlerPtr() {
        public int handler(int offset) {
            int res;
     ...
     */
    public static ReadHandlerPtr asteroid_IN1_r = new ReadHandlerPtr() {
        public int handler(int offset) {
            int res;
            int bitmask;
    ...
    public static ReadHandlerPtr asteroid_DSW1_r = new ReadHandlerPtr() {
        public int handler(int offset) {
            int res;
            int res1;
    ...
    public static WriteHandlerPtr asteroid_bank_switch_w = new WriteHandlerPtr() {
...
/*TODO*///            set_led_status(1, ~data & 0x01);
    ...
    public static WriteHandlerPtr astdelux_bank_switch_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
    ...
    public static WriteHandlerPtr astdelux_led_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
/*TODO*///            set_led_status(offset, ~data & 0x01);
        }
    };

    public static InitMachinePtr asteroid_init_machine = new InitMachinePtr() {
        public void handler() {
     ...
     */
    public static ReadHandlerPtr llander_IN0_r = new ReadHandlerPtr() {
        public int handler(int offset) {
            int res;

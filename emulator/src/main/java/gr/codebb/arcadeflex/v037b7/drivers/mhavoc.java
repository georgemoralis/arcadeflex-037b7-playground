...
public class mhavoc {
    ...
    public static ReadHandlerPtr mhavoc_gammaram_r = new ReadHandlerPtr() {
        public int handler(int offset) {
            return gammaram.read(offset & 0x7ff);
        }
    };

    public static WriteHandlerPtr mhavoc_gammaram_w = new WriteHandlerPtr() {
    ...
    static InputPortPtr input_ports_mhavoc = new InputPortPtr() {
        public void handler() {
            PORT_START();
            /* IN0 - alpha (player_1 = 0) */
            ...
            PORT_START();
            /* IN5 - dummy for player_1 = 1 on alpha */
    ...
    static InputPortPtr input_ports_mhavocp = new InputPortPtr() {
        public void handler() {
            PORT_START();
            /* IN0 - alpha (player_1 = 0) */
            PORT_BIT(0x0f, IP_ACTIVE_HIGH, IPT_UNKNOWN);
     ...
     */
    static RomLoadPtr rom_mhavoc = new RomLoadPtr() {
        public void handler() {
 ...
 /* Gamma Processor ROM */
    ...
    static RomLoadPtr rom_mhavoc2 = new RomLoadPtr() {
        public void handler() {
            /* Alpha Processor ROMs */
 ...
 /* Gamma Processor ROM */
    ...
    static RomLoadPtr rom_mhavocrv = new RomLoadPtr() {
        public void handler() {
            /* Alpha Processor ROMs */
            ROM_REGION(0x21000, REGION_CPU1);/* 152KB for ROMs */
 /* Vector Generator ROM */
 ...
 /* Gamma Processor ROM */
    ...
    static RomLoadPtr rom_mhavocp = new RomLoadPtr() {
        public void handler() {
            /* Alpha Processor ROMs */
            ROM_REGION(0x21000, REGION_CPU1);
            /* Vector Generator ROM */
